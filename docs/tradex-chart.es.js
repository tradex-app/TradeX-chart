...
const Nt = "TradeX-Chart", Ht = "TX", ca = "tradeXutils", yn = "tradeXmenus", ua = "tradeXmenu", vn = "tradeXdividers", wn = "tradeXwindows", da = "tradeXwindow", xn = "tradeXprogress", ma = 500, pa = "stream_None", $t = "stream_Listening", bn = "stream_Started", ga = "stream_Stopped", fa = "stream_Error", Vt = "stream_candleFirst", $e = "stream_candleUpdate", zt = "stream_candleNew", ya = 250, va = 8, wa = 2, xa = 2, Pi = 100, Dt = /^(\d*\.?\d+)\s?(px|em|ex|%|in|cn|mm|pt|pc+)$/igm;
function M(o) {
...
}, ba = typeof window < "u" && typeof window.document < "u";
typeof process < "u" && process.versions != null && process.versions.node != null;
typeof window < "u" && window.name === "nodejs" || navigator.userAgent.includes("Node.js") || navigator.userAgent.includes("jsdom");
const Ca = ((o) => "onorientationchange" in o || o.matchMedia("(any-pointer:coarse)").matches || !!navigator.maxTouchPoints || !!navigator.msMaxTouchPoints || "ontouchstart" in o || o.DocumentTouch && document instanceof o.DocumentTouch)(typeof window < "u" ? window : {}), Ta = {
  idle: 0,
  dragStart: 1,
  dragging: 2
};
...
`;
    ...
    var Oo = /mobile|tablet|ip(ad|hone|od)|android/i, js = "ontouchstart" in e, No = Jt(e, "PointerEvent") !== n, Io = js && Oo.test(navigator.userAgent), Tt = "touch", Do = "pen", Bi = "mouse", Ro = "kinect", ko = 25, ie = 1, Je = 2, F = 4, ae = 8, Qt = 1, St = 2, Et = 4, Pt = 8, Mt = 16, Ie = St | Et, Qe = Pt | Mt, Zs = Ie | Qe, Js = ["x", "y"], ei = ["clientX", "clientY"];
    function fe(c, u) {
      var p = this;
    ...
    fe.prototype = {
      ...
      init: function() {
        this.evEl && j(this.element, this.evEl, this.domHandler), this.evTarget && j(this.target, this.evTarget, this.domHandler), this.evWin && j(Ks(this.element), this.evWin, this.domHandler);
      },
      destroy: function() {
        this.evEl && oe(this.element, this.evEl, this.domHandler), this.evTarget && oe(this.target, this.evTarget, this.domHandler), this.evWin && oe(Ks(this.element), this.evWin, this.domHandler);
      }
    };
    function _o(c) {
      var u, p = c.options.inputClass;
      return p ? u = p : No ? u = zi : Io ? u = si : js ? u = Wi : u = ii, new u(c, Ho);
    }
    function Ho(c, u, p) {
      var f = p.pointers.length, x = p.changedPointers.length, P = u & ie && f - x === 0, O = u & (F | ae) && f - x === 0;
      p.isFirst = !!P, p.isFinal = !!O, P && (c.session = {}), p.eventType = u, $o(c, p), c.emit("hammer.input", p), c.recognize(p), c.session.prevInput = p;
    }
    function $o(c, u) {
      ...
      var P = p.firstInput, O = p.firstMultiple, K = O ? O.center : P.center, Z = u.center = en(f);
      u.timeStamp = g(), u.deltaTime = u.timeStamp - P.timeStamp, u.angle = Vi(K, Z), u.distance = ti(K, Z), Uo(p, u), u.offsetDirection = sn(u.deltaX, u.deltaY);
      var se = tn(u.deltaTime, u.deltaX, u.deltaY);
      u.overallVelocityX = se.x, u.overallVelocityY = se.y, u.overallVelocity = m(se.x) > m(se.y) ? se.x : se.y, u.scale = O ? zo(O.pointers, f) : 1, u.rotation = O ? Vo(O.pointers, f) : 0, u.maxPointers = p.prevInput ? u.pointers.length > p.prevInput.maxPointers ? u.pointers.length : p.prevInput.maxPointers : u.pointers.length, Bo(p, u);
      var Re = c.element;
    ...
    function Bo(c, u) {
      ...
      if (u.eventType != ae && (f > ko || p.velocity === n)) {
        var Z = u.deltaX - p.deltaX, se = u.deltaY - p.deltaY, Re = tn(f, Z, se);
        P = Re.x, O = Re.y, x = m(Re.x) > m(Re.y) ? Re.x : Re.y, K = sn(Z, se), c.lastInterval = u;
      } else
    ...
    function sn(c, u) {
      return c === u ? Qt : m(c) >= m(u) ? c < 0 ? St : Et : u < 0 ? Pt : Mt;
    }
    function ti(c, u, p) {
      p || (p = Js);
    ...
    var Wo = {
      ...
      mousemove: Je,
      mouseup: F
    }, Fo = "mousedown", Go = "mousemove mouseup";
    function ii() {
      this.evEl = Fo, this.evWin = Go, this.pressed = !1, fe.apply(this, arguments);
    }
    H(ii, fe, {
      handler: function(u) {
        var p = Wo[u.type];
    ...
    var Yo = {
      ...
      4: Bi,
      5: Ro
    }, nn = "pointerdown", rn = "pointermove pointerup pointercancel";
    e.MSPointerEvent && !e.PointerEvent && (nn = "MSPointerDown", rn = "MSPointerMove MSPointerUp MSPointerCancel");
    function zi() {
      this.evEl = nn, this.evWin = rn, fe.apply(this, arguments), this.store = this.manager.session.pointerEvents = [];
    }
    H(zi, fe, {
      handler: function(u) {
        var p = this.store, f = !1, x = u.type.toLowerCase().replace("ms", ""), P = Yo[x], O = qo[u.pointerType] || u.pointerType, K = O == Tt, Z = Ye(p, u.pointerId, "pointerId");
    ...
    var Xo = {
      ...
      touchend: F,
      touchcancel: ae
    }, Ko = "touchstart", jo = "touchstart touchmove touchend touchcancel";
    function on() {
      this.evTarget = Ko, this.evWin = jo, this.started = !1, fe.apply(this, arguments);
    }
    H(on, fe, {
      handler: function(u) {
        var p = Xo[u.type];
        if (p === ie && (this.started = !0), !!this.started) {
          var f = Zo.call(this, u, p);
    ...
    function Zo(c, u) {
      ...
      return u & (F | ae) && (p = Xs(p.concat(f), "identifier", !0)), [p, f];
    }
    var Jo = {
      touchstart: ie,
      touchmove: Je,
      touchend: F,
      touchcancel: ae
    }, Qo = "touchstart touchmove touchend touchcancel";
    function si() {
      this.evTarget = Qo, this.targetIds = {}, fe.apply(this, arguments);
    }
    H(si, fe, {
      handler: function(u) {
        var p = Jo[u.type], f = ea.call(this, u, p);
    ...
    function ia(c, u) {
      c & ie ? (this.primaryTouch = u.changedPointers[0].identifier, ln.call(this, u)) : c & (F | ae) && ln.call(this, u);
    }
    function ln(c) {
    ...
    var hn = Jt(a.style, "touchAction"), cn = hn !== n, un = "compute", dn = "auto", Fi = "manipulation", et = "none", At = "pan-x", Lt = "pan-y", ni = ra();
    function Gi(c, u) {
      this.manager = c, this.set(u);
    }
    Gi.prototype = {
      set: function(c) {
        c == un && (c = this.compute()), cn && this.manager.element.style && ni[c] && (this.manager.element.style[hn] = c), this.actions = c.toLowerCase().trim();
      },
      update: function() {
    ...
    function na(c) {
      ...
      return u && p ? et : u || p ? u ? At : Lt : ge(c, Fi) ? Fi : dn;
    }
    function ra() {
      if (!cn)
        return !1;
    ...
    function ze(c) {
      this.options = R({}, this.defaults, c || {}), this.id = Lo(), this.manager = null, this.options.enable = re(this.options.enable, !0), this.state = ri, this.simultaneous = {}, this.requireFail = [];
    }
    ze.prototype = {
      defaults: {},
      set: function(c) {
      ...
      dropRecognizeWith: function(c) {
        return S(c, "dropRecognizeWith", this) ? this : (c = oi(c, this), delete this.simultaneous[c.id], this);
      },
      ...
      emit: function(c) {
        ...
        p < qe && f(u.options.event + mn(p)), f(u.options.event), c.additionalEvent && f(c.additionalEvent), p >= qe && f(u.options.event + mn(p));
      },
      tryEmit: function(c) {
        if (this.canEmit())
          return this.emit(c);
    ...
    H(ai, Se, {
      ...
      directionTest: function(c) {
        ...
        return x & u.direction || (u.direction & Ie ? (x = P === 0 ? Qt : P < 0 ? St : Et, p = P != this.pX, f = Math.abs(c.deltaX)) : (x = O === 0 ? Qt : O < 0 ? Pt : Mt, p = O != this.pY, f = Math.abs(c.deltaY))), c.direction = x, p && f > u.threshold && x & u.direction;
      },
      attrTest: function(c) {
    ...
    var oa = 1, gn = 2;
    function ji(c, u) {
      this.options = R({}, We.defaults, u || {}), this.options.inputTarget = this.options.inputTarget || c, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = c, this.input = _o(this), this.touchAction = new Gi(this, this.options.touchAction), fn(this, !0), A(this.options.recognizers, function(p) {
    ...
    ji.prototype = {
      ...
      recognize: function(c) {
        ...
        if (!u.stopped) {
          ...
          for (var P = 0; P < f.length; )
            p = f[P], u.stopped !== gn && (!x || p == x || p.canRecognizeWith(x)) ? p.recognize(c) : p.reset(), !x && p.state & (ye | lt | qe) && (x = u.curRecognizer = p), P++;
        }
      },
      get: function(c) {
        if (c instanceof ze)
      ...
      destroy: function() {
        this.element && fn(this, !1), this.handlers = {}, this.session = {}, this.input.destroy(), this.element = null;
      }
    };
    function fn(c, u) {
      var p = c.element;
    ...
    var la = typeof e < "u" ? e : typeof self < "u" ? self : {};
    la.Hammer = We, typeof n == "function" && n.amd ? n(function() {
      return We;
    }) : o.exports ? o.exports = We : e[s] = We;
  })(window, document, "Hammer");
})(dr);
var Kt = dr.exports;
const Ea = Sa(Kt), ke = /* @__PURE__ */ ha({
  __proto__: null,
  default: Ea
}, [Kt]), mr = 1, pr = 2, ls = 4, Pa = {
  mousedown: mr,
  mousemove: pr,
  mouseup: ls
};
...
function Aa(o) {
  ...
  o.prototype.handler = function(s) {
    const n = this.store;
    s.button > 0 && s.type === "pointerdown" && (Ma(n, (r) => r.pointerId === s.pointerId) || n.push(s)), e.call(this, s);
  };
}
function La(o) {
  o.prototype.handler = function(i) {
    let s = Pa[i.type];
    s & mr && i.button >= 0 && (this.pressed = !0), s & pr && i.which === 0 && (s = ls), this.pressed && (s & ls && (this.pressed = !1), this.callback(this.manager, s, {
      pointers: [i],
      changedPointers: [i],
      pointerType: "mouse",
      srcEvent: i
...
}, ka = typeof navigator < "u" && navigator.userAgent ? navigator.userAgent.toLowerCase() : "", ht = typeof window < "u" ? window : global;
let hs = !1;
try {
  const o = {
    get passive() {
...
const _a = ka.indexOf("firefox") !== -1, { WHEEL_EVENTS: Ha } = Ps, En = "wheel", Pn = 4.000244140625, $a = 40, Ua = 0.25;
class Ba extends Ri {
  constructor(e, i, s) {
    super(e, i, s), this.handleEvent = (n) => {
      if (!this.options.enable)
        return;
      let r = n.deltaY;
      ht.WheelEvent && (_a && n.deltaMode === ht.WheelEvent.DOM_DELTA_PIXEL && (r /= ht.devicePixelRatio), n.deltaMode === ht.WheelEvent.DOM_DELTA_LINE && (r *= $a)), r !== 0 && r % Pn === 0 && (r = Math.floor(r / Pn)), n.shiftKey && r && (r = r * Ua), this.callback({
        type: En,
        center: {
          x: n.clientX,
          y: n.clientY
    ...
    }, this.events = (this.options.events || []).concat(Ha), this.events.forEach((n) => e.addEventListener(n, this.handleEvent, hs ? { passive: !1 } : !1));
  }
  destroy() {
    this.events.forEach((e) => this.element.removeEventListener(e, this.handleEvent));
  }
  enableEventType(e, i) {
    e === En && (this.options.enable = i);
  }
}
const { MOUSE_EVENTS: Va } = Ps, Mn = "pointermove", An = "pointerover", Ln = "pointerout", On = "pointerenter", Nn = "pointerleave";
class za extends Ri {
  constructor(e, i, s) {
    ...
    this.enableMoveEvent = n, this.enableLeaveEvent = n, this.enableEnterEvent = n, this.enableOutEvent = n, this.enableOverEvent = n, this.events = (this.options.events || []).concat(Va), this.events.forEach((r) => e.addEventListener(r, this.handleEvent));
  }
  destroy() {
    this.events.forEach((e) => this.element.removeEventListener(e, this.handleEvent));
  }
  enableEventType(e, i) {
    e === Mn && (this.enableMoveEvent = i), e === An && (this.enableOverEvent = i), e === Ln && (this.enableOutEvent = i), e === On && (this.enableEnterEvent = i), e === Nn && (this.enableLeaveEvent = i);
  }
  handleOverEvent(e) {
    this.enableOverEvent && e.type === "mouseover" && this._emit(An, e);
  }
  handleOutEvent(e) {
    this.enableOutEvent && e.type === "mouseout" && this._emit(Ln, e);
  }
  handleEnterEvent(e) {
    this.enableEnterEvent && e.type === "mouseenter" && this._emit(On, e);
  }
  handleLeaveEvent(e) {
    ...
    if (this.enableMoveEvent)
      switch (e.type) {
        case "mousedown":
          ...
          break;
        case "mousemove":
          e.which === 0 && (this.pressed = !1), this.pressed || this._emit(Mn, e);
          break;
        case "mouseup":
          this.pressed = !1;
          break;
...
const { KEY_EVENTS: Wa } = Ps, In = "keydown", Dn = "keyup";
class Fa extends Ri {
  constructor(e, i, s) {
    super(e, i, s), this.handleEvent = (n) => {
    ...
    }, this.enableDownEvent = this.options.enable, this.enableUpEvent = this.options.enable, this.events = (this.options.events || []).concat(Wa), e.tabIndex = this.options.tabIndex || 0, e.style.outline = "none", this.events.forEach((n) => e.addEventListener(n, this.handleEvent));
  }
  destroy() {
    this.events.forEach((e) => this.element.removeEventListener(e, this.handleEvent));
  }
  enableEventType(e, i) {
    e === In && (this.enableDownEvent = i), e === Dn && (this.enableUpEvent = i);
  }
}
const Rn = "contextmenu";
class Ga extends Ri {
  constructor(e, i, s) {
    super(e, i, s), this.handleEvent = (n) => {
  ...
  enableEventType(e, i) {
    e === Rn && (this.options.enable = i);
  }
}
const cs = 1, Mi = 2, us = 4, Ya = {
  pointerdown: cs,
  pointermove: Mi,
  pointerup: us,
  mousedown: cs,
  mousemove: Mi,
  mouseup: us
}, qa = 1, Xa = 2, Ka = 3, ja = 0, Za = 1, Ja = 2, Qa = 1, el = 2, tl = 4;
function il(o) {
  const e = Ya[o.srcEvent.type];
  if (!e)
    return null;
  const { buttons: i, button: s, which: n } = o.srcEvent;
  let r = !1, a = !1, l = !1;
  return e === us || e === Mi && !Number.isFinite(i) ? (r = n === qa, a = n === Xa, l = n === Ka) : e === Mi ? (r = !!(i & Qa), a = !!(i & tl), l = !!(i & el)) : e === cs && (r = s === ja, a = s === Za, l = s === Ja), { leftButton: r, middleButton: a, rightButton: l };
}
function sl(o, e) {
  const i = o.center;
  if (!i)
...
class ol {
  constructor(e = null, i) {
    this._onBasicInput = (n) => {
      const { srcEvent: r } = n, a = Da[r.type];
      a && this.manager.emit(a, n);
    }, this._onOtherEvent = (n) => {
      this.manager.emit(n.type, n);
    }, this.options = { ...rl, ...i }, this.events = /* @__PURE__ */ new Map(), this.setElement(e);
  ...
  setElement(e) {
    ...
    this.manager = new s(e, {
      ...
      recognizers: i.recognizers || Na
    }).on("hammer.input", this._onBasicInput), i.recognizers || Object.keys(Tn).forEach((n) => {
    ...
    this.wheelInput = new Ba(e, this._onOtherEvent, {
      enable: !1
    }), this.moveInput = new za(e, this._onOtherEvent, {
      enable: !1
    }), this.keyInput = new Fa(e, this._onOtherEvent, {
      enable: !1,
      tabIndex: i.tabIndex
    }), this.contextmenuInput = new Ga(e, this._onOtherEvent, {
      enable: !1
    });
  ...
  _addEventHandler(e, i, s, n, r) {
    ...
    const { manager: a, events: l } = this, h = Sn[e] || e;
    let m = l.get(h);
    m || (m = new nl(this), l.set(h, m), m.recognizerName = Ra[h] || h, a && a.on(h, m.handleEvent)), m.add(e, i, s, n, r), m.isEmpty() || this._toggleRecognizer(m.recognizerName, !0);
  }
  _removeEventHandler(e, i) {
    ...
    const { events: s } = this, n = Sn[e] || e, r = s.get(n);
...
class Ne {
  ...
  pad = { left: !1 };
  constructor(e, i) {
    if (this.#e = { ...al, ...i }, this.#o = Ta.idle, this.#l = Ca, this.#t = e, !this.#t && this.#e.elementId && (this.#t = document.getElementById(this.#e.elementId)), !k.isElement(this.#t))
    ...
    this.#n = new ol(this.#t, n), this.pointerInit();
  }
  get agent() {
    return this.#n;
  }
  ...
  get touch() {
    return this.#s instanceof _n ? this.#s : (this.#s = new _n(this), this.#s);
  }
  get key() {
    return this.#i instanceof Hn ? this.#i : (this.#i = new Hn(this), this.#i);
  }
  get status() {
    return this.#o;
  }
...
const ll = ["y", "M", "d", "h", "m", "s", "ms"], hl = ["years", "months", "days", "hours", "minutes", "seconds", "milliseconds"], cl = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334], ul = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335], gr = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], dl = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], fr = 1231006505e3, Ke = 1, G = 1e3, q = G * 60, ee = q * 60, z = ee * 24, gt = z * 7, ue = z * 30;
function yr(o = 3, e = !1) {
  let i = gr[o % 12] * z;
  return e && o > 0 && (i += z), i;
}
...
function xr(o, e = fr, i = Date.now()) {
  return wr(o) ? o > e && o < i : !1;
}
function It(o, e, i) {
...
function gi(o) {
  let e = G;
  return E(o) ? (e = br(o), e ? o = o : (e = G, o = "1s")) : o = "1s", { tf: o, ms: e };
}
function br(o) {
  if (!E(o))
    return !1;
...
function ks(o) {
  let e, i, s, n;
  return e = String(Ns(o)), i = String(Sr(o)).padStart(2, "0"), s = String(Tr(o)).padStart(2, "0"), n = String(Cr(o)).padStart(2, "0"), { d: e, h: i, m: s, s: n };
}
function Pl(o, e) {
...
const Ml = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  TIMESCALESRANK: ds,
  TIMESCALESVALUES: jt,
  TIMESCALESVALUESKEYS: vl,
  TIMEUNITS: ll,
  TIMEUNITSLONG: hl,
  TIMEUNITSVALUES: ml,
  TIMEUNITSVALUESLONG: vr,
  ...
  time_start: fi,
  timestampDiff: Xe,
  timestampDifference: bl,
  timezones: ps,
  unitRange: Sl,
  year_start: Rs
}, Symbol.toStringTag, { value: "Module" })), Al = q, Ll = "1m", Ai = Al, Ol = 6, $n = 0.05, Nl = 100, Un = 100, Ze = ["default", "percent", "log"], Bn = 0.3, Vn = 30, hi = 200, zn = 200, Wn = 20, Fn = 4096, _i = 5, Gn = 50, Yn = 30, Il = 8, ys = 30, Lr = [!0, "top"];
class ve {
  static t = 0;
  static o = 1;
  static h = 2;
...
class ce {
  ...
  static defaultNode() {
    return `
  <div slot="widget" class="${vn}" style="position: absolute;"></div>
  `;
  }
  constructor(e, i) {
    const s = { ...i };
  ...
  dividerNode() {
    let e = this.#t.theme, i = this.#s.pos.top - k.elementDimPos(this.#l).top, s = this.#t.MainPane.rowsW + this.#t.scaleW, n = T(this.config.dividerHeight) ? this.config.dividerHeight : Il, r = e.tools.width;
  ...
  setPos() {
    let e = this.#s.element.getBoundingClientRect().top - this.#t.elWidgetsG.getBoundingClientRect().top - this.height / 2;
...
const Dl = '<svg width="46.08" height="46.08" viewBox="-51.2 -51.2 614.4 614.4" ><path d="M471.993 112h-89.2l-16.242-46.75a32.023 32.023 0 00-30.229-21.5H175.241a31.991 31.991 0 00-30.294 21.691L129.1 112H40a24.027 24.027 0 00-24 24v312a24.027 24.027 0 0024 24h431.993a24.027 24.027 0 0024-24V136a24.027 24.027 0 00-24-24zm-8 328H48.007V144h104.01l23.224-68.25h161.081l23.71 68.25h103.961z" class="ci-primary"></path><path d="M256 168a114 114 0 10114 114 114.13 114.13 0 00-114-114zm0 196a82 82 0 1182-82 82.093 82.093 0 01-82 82z"></path></svg>', Rl = '<svg width="46.08" height="46.08" viewBox="-51.2 -51.2 614.4 614.4"><path d="M376 160v32h65.372L252 381.373l-72-72L76.686 412.686l22.628 22.628L180 354.627l72 72 212-211.999V280h32V160H376z"></path><path d="M48 104H16v392h480v-32H48V104z"></path></svg>', kl = '<svg width="46.08" height="46.08" viewBox="-51.2 -51.2 614.4 614.4"><path d="M271.514 95.5h-32v178.111l115.613 54.948 13.737-28.902-97.35-46.268V95.5z"></path><path d="M256 16C123.452 16 16 123.452 16 256s107.452 240 240 240 240-107.452 240-240S388.548 16 256 16zm0 448c-114.875 0-208-93.125-208-208S141.125 48 256 48s208 93.125 208 208-93.125 208-208 208z"></path></svg>', Or = '<svg width="46.08" height="46.08" viewBox="-51.2 -51.2 614.4 614.4"><path d="M245.151 168a88 88 0 1088 88 88.1 88.1 0 00-88-88zm0 144a56 56 0 1156-56 56.063 56.063 0 01-56 56z"></path><path d="M464.7 322.319l-31.77-26.153a193.081 193.081 0 000-80.332l31.77-26.153a19.941 19.941 0 004.606-25.439l-32.612-56.483a19.936 19.936 0 00-24.337-8.73l-38.561 14.447a192.038 192.038 0 00-69.54-40.192l-6.766-40.571A19.936 19.936 0 00277.762 16H212.54a19.937 19.937 0 00-19.728 16.712l-6.762 40.572a192.03 192.03 0 00-69.54 40.192L77.945 99.027a19.937 19.937 0 00-24.334 8.731L21 164.245a19.94 19.94 0 004.61 25.438l31.767 26.151a193.081 193.081 0 000 80.332l-31.77 26.153A19.942 19.942 0 0021 347.758l32.612 56.483a19.937 19.937 0 0024.337 8.73l38.562-14.447a192.03 192.03 0 0069.54 40.192l6.762 40.571A19.937 19.937 0 00212.54 496h65.222a19.936 19.936 0 0019.728-16.712l6.763-40.572a192.038 192.038 0 0069.54-40.192l38.564 14.449a19.938 19.938 0 0024.334-8.731l32.609-56.487a19.939 19.939 0 00-4.6-25.436zm-50.636 57.12l-48.109-18.024-7.285 7.334a159.955 159.955 0 01-72.625 41.973l-10 2.636L267.6 464h-44.89l-8.442-50.642-10-2.636a159.955 159.955 0 01-72.625-41.973l-7.285-7.334-48.117 18.024L53.8 340.562l39.629-32.624-2.7-9.973a160.9 160.9 0 010-83.93l2.7-9.972L53.8 171.439l22.446-38.878 48.109 18.024 7.285-7.334a159.955 159.955 0 0172.625-41.973l10-2.636L222.706 48H267.6l8.442 50.642 10 2.636a159.955 159.955 0 0172.625 41.973l7.285 7.334 48.109-18.024 22.447 38.877-39.629 32.625 2.7 9.972a160.9 160.9 0 010 83.93l-2.7 9.973 39.629 32.623z"></path></svg>', _l = '<svg width="46.08" height="46.08" version="1.1" viewBox="-51.2 -51.2 614.4 614.4"><rect x="16" y="240.18" width="188.84" height="31.635"/><g transform="translate(-3.3234e-7 -112.18)"><rect x="307.16" y="352.37" width="188.84" height="31.635"/></g><rect transform="rotate(-90)" x="-496" y="240.18" width="188.84" height="31.635"/><rect transform="rotate(-90)" x="-204.84" y="240.18" width="188.84" height="31.635"/></svg>', Hl = '<svg width="46.08" height="46.08" viewBox="0 0 24 24"><path fill="none" d="M0 0h24v24H0z"></path><path d="M6.535 3H21a1 1 0 011 1v16a1 1 0 01-1 1H6.535a1 1 0 01-.832-.445l-5.333-8a1 1 0 010-1.11l5.333-8A1 1 0 016.535 3zm.535 2l-4.666 7 4.666 7H20V5H7.07zM13 10.586l2.828-2.829 1.415 1.415L14.414 12l2.829 2.828-1.415 1.415L13 13.414l-2.828 2.829-1.415-1.415L11.586 12 8.757 9.172l1.415-1.415L13 10.586z"></path></svg>', $l = '<svg width="46.08" height="46.08" version="1.1" viewBox="-51.2 -51.2 614.4 614.4"><g stroke-width="30.155"><rect x="14.757" y="240.92" width="482.49" height="30.155" rx="15.078"/><rect x="14.757" y="147" width="482.49" height="30.155" rx="15.078"/><rect x="14.757" y="334.84" width="482.49" height="30.155" rx="15.078"/></g ><g transform="translate(5.937 -288.34)"><path d="m23.904 712.34c-8.3532 0-15.078 6.7252-15.078 15.078s6.7249 15.078 15.078 15.078h173.93c-0.65295-3.3651-2.0312-6.4697-2.0312-10.026 0-7.1393 1.5573-13.888 4.0625-20.13zm276.35 0c2.5051 6.2423 4.0365 12.991 4.0365 20.13 0 3.5554-1.3526 6.6618-2.0052 10.026h173.93c8.3532 0 15.078-6.7252 15.078-15.078s-6.7249-15.078-15.078-15.078z"/><path d="m250.06 759.97c17.965 0 32.545-14.58 32.545-32.545 0-17.965-14.58-32.545-32.545-32.545-17.965 0-32.545 14.58-32.545 32.545 0 17.965 14.58 32.545 32.545 32.545zm0 21.697c-29.964 0-54.242-24.279-54.242-54.242 0-29.964 24.279-54.242 54.242-54.242 29.964 0 54.242 24.279 54.242 54.242 0 29.964-24.279 54.242-54.242 54.242z" stroke-width="21.697"/></g ><path d="m144.05 18.672c-24.694 0-45.285 16.595-51.849 39.167h-62.37c-8.3532 0-15.078 6.7252-15.078 15.078s6.7249 15.078 15.078 15.078h62.37c6.5639 22.572 27.155 39.167 51.849 39.167s45.285-16.595 51.849-39.167h120.03c6.5639 22.572 27.155 39.167 51.849 39.167 24.694 0 45.285-16.595 51.849-39.167h62.552c8.3532 0 15.078-6.7252 15.078-15.078s-6.7249-15.078-15.078-15.078h-62.552c-6.5639-22.572-27.155-39.167-51.849-39.167-24.694 0-45.285 16.595-51.849 39.167h-120.03c-6.5639-22.572-27.155-39.167-51.849-39.167zm0 21.693c17.965 0 32.552 14.587 32.552 32.552 0 17.965-14.587 32.552-32.552 32.552-17.965 1e-5 -32.552-14.587-32.552-32.552 0-17.965 14.587-32.552 32.552-32.552zm223.72 0c17.965 0 32.552 14.587 32.552 32.552 0 17.965-14.587 32.552-32.552 32.552-17.965 0-32.552-14.587-32.552-32.552 0-17.965 14.587-32.552 32.552-32.552z" stroke-width="30.155"/></svg>', tt = '<svg width="46.08" height="46.08" version="1.1" viewBox="-51.2 -51.2 614.4 614.4"><g transform="matrix(21.697 0 0 21.697 -47.758 -47.758)"><path d="m7.354 21.354 14-14-0.707-0.707-14 14z"/><path d="m22.5 7c0.828 0 1.5-0.672 1.5-1.5s-0.672-1.5-1.5-1.5-1.5 0.672-1.5 1.5 0.672 1.5 1.5 1.5zm0 1c-1.381 0-2.5-1.119-2.5-2.5s1.119-2.5 2.5-2.5 2.5 1.119 2.5 2.5-1.119 2.5-2.5 2.5zm-17 16c0.828 0 1.5-0.672 1.5-1.5s-0.672-1.5-1.5-1.5-1.5 0.672-1.5 1.5 0.672 1.5 1.5 1.5zm0 1c-1.381 0-2.5-1.119-2.5-2.5s1.119-2.5 2.5-2.5 2.5 1.119 2.5 2.5-1.119 2.5-2.5 2.5z"/></g></svg>', Ul = '<svg width="46.08" height="46.08" viewBox="0 0 32 32"><path d="M 3.2758709,20.241377 11.758622,28.72413 28.72413,11.758622 20.241377,3.2758709 Z m 2.1206881,0 1.5905161,-1.590515 3.7112049,3.711203 1.060342,-1.060345 -3.7112027,-3.711204 1.0603441,-1.060344 2.1206876,2.12069 1.060346,-1.060346 -2.120689,-2.120688 1.060343,-1.060344 3.711203,3.711203 L 16,17.060346 l -3.711203,-3.711208 1.060341,-1.060341 2.12069,2.120687 1.060344,-1.060346 -2.120688,-2.120687 1.060344,-1.060343 3.711204,3.711205 1.060345,-1.060345 -3.711205,-3.7112046 1.060344,-1.0603441 2.120687,2.1206887 1.060346,-1.0603446 -2.120687,-2.1206883 1.590515,-1.5905161 6.362065,6.362063 -14.84482,14.84482 z" style="stroke-width:0.749776" /></svg>', Bl = '<svg width="46.08" height="46.08" viewBox="-51.2 -51.2 614.4 614.4"><g id="g930" transform="matrix(21.128963,0,0,21.128963,-29.235597,-50.369964)"><path clip-rule="evenodd" d="m 4.5,5 a 1.5,1.5 0 1 0 0,3 1.5,1.5 0 0 0 0,-3 z M 2,6.5 A 2.5,2.5 0 0 1 6.95,6 H 24 V 7 H 6.95 A 2.5,2.5 0 0 1 2,6.5 Z M 4.5,15 a 1.5,1.5 0 1 0 0,3 1.5,1.5 0 0 0 0,-3 z M 2,16.5 A 2.5,2.5 0 0 1 6.95,16 h 13.1 a 2.5,2.5 0 1 1 0,1 H 6.95 A 2.5,2.5 0 0 1 2,16.5 Z M 22.5,15 a 1.5,1.5 0 1 0 0,3 1.5,1.5 0 0 0 0,-3 z m -18,6 a 1.5,1.5 0 1 0 0,3 1.5,1.5 0 0 0 0,-3 z M 2,22.5 A 2.5,2.5 0 0 1 6.95,22 H 24 v 1 H 6.95 A 2.5,2.5 0 0 1 2,22.5 Z" id="path908" /><path clip-rule="evenodd" d="M 22.4,8.94 21.01,9.57 20.6,8.66 21.99,8.03 Z m -4,1.8 -1.39,0.63 -0.41,-0.91 1.39,-0.63 z m -4,1.8 -1.4,0.63 -0.4,-0.91 1.39,-0.63 z m -4,1.8 L 9,14.97 8.6,14.06 9.99,13.43 Z" id="path910" /></g></svg>', Vl = '<svg width="46.08" height="46.08" viewBox="-51.2 -51.2 614.4 614.4"><path d="M231.359 147l-80.921 205h45.155l15.593-39.5h89.628l15.593 39.5h45.155l-80.921-205zm-3.594 123.5L256 198.967l28.235 71.533z"></path><path d="M384 56H128V16H16v112h40v256H16v112h112v-40h256v40h112V384h-40V128h40V16H384zM48 96V48h48v48zm48 368H48v-48h48zm288-40H128v-40H88V128h40V88h256v40h40v256h-40zm80-8v48h-48v-48zM416 48h48v48h-48z"></path></svg>', zl = '<svg style="width: 46px; height: 46px" viewBox="-1.6 -1.6 19.2 19.2"><path d="M 15,2 C 15,1.4477153 14.552285,1 14,1 H 2 C 1.4477153,1 1,1.4477153 1,2 v 12 c 0,0.552285 0.4477153,1 1,1 h 12 c 0.552285,0 1,-0.447715 1,-1 z M 0,2 C 0,0.8954305 0.8954305,0 2,0 h 12 c 1.104569,0 2,0.8954305 2,2 v 12 c 0,1.104569 -0.895431,2 -2,2 H 2 C 0.8954305,16 0,15.104569 0,14 Z" id="path2" /><g id="g718" transform="translate(0,1.2499996)"><path d="M 7.5010125,7.9560661 5.355012,10.103066 c -0.472,0.472 -1.18,-0.2360003 -0.708,-0.7080003 L 7.6470125,6.3950659 c 0.195364,-0.195858 0.512636,-0.195858 0.708,0 l 3.0000005,2.9999998 c 0.472,0.472 -0.236,1.1800003 -0.708,0.7080003 L 8.5010125,7.9560661 c -0.431103,-0.417289 -0.523896,-0.423024 -1,0 z" style="" id="path566-5" /><path d="m 7.4989873,5.5439348 -2.1460003,-2.147 c -0.472,-0.472 -1.18,0.236 -0.708,0.708 l 3.0000003,3 c 0.1953639,0.195858 0.5126361,0.195858 0.708,0 l 2.9999997,-3 c 0.472,-0.472 -0.236,-1.18 -0.708,-0.708 l -2.1459997,2.147 c -0.4311027,0.417289 -0.5238956,0.423024 -1,0 z" style="" id="path566-6-3" /></g></svg>', Wl = '<svg style="width: 46px; height: 46px" viewBox="-1.6 -1.6 19.2 19.2"><path d="M 15,2 C 15,1.4477153 14.552285,1 14,1 H 2 C 1.4477153,1 1,1.4477153 1,2 v 12 c 0,0.552285 0.4477153,1 1,1 h 12 c 0.552285,0 1,-0.447715 1,-1 z M 0,2 C 0,0.8954305 0.8954305,0 2,0 h 12 c 1.104569,0 2,0.8954305 2,2 v 12 c 0,1.104569 -0.895431,2 -2,2 H 2 C 0.8954305,16 0,15.104569 0,14 Z" id="path2" /><path d="m 7.4989873,7.7026182 -2.1460003,2.147 c -0.472,0.4719998 -1.18,-0.236 -0.708,-0.708 l 3.0000003,-3 c 0.1953639,-0.1958581 0.5126361,-0.1958581 0.708,0 l 2.9999997,3 c 0.472,0.472 -0.236,1.1799998 -0.708,0.708 l -2.1459997,-2.147 c -0.4311027,-0.417289 -0.5238956,-0.423024 -1,0 z" style="" id="path566-6-3" /></svg>', Fl = '<svg style="width: 46px; height: 46px" viewBox="-1.6 -1.6 19.2 19.2"><path d="M 15,2 C 15,1.4477153 14.552285,1 14,1 H 2 C 1.4477153,1 1,1.4477153 1,2 v 12 c 0,0.552285 0.4477153,1 1,1 h 12 c 0.552285,0 1,-0.447715 1,-1 z M 0,2 C 0,0.8954305 0.8954305,0 2,0 h 12 c 1.104569,0 2,0.8954305 2,2 v 12 c 0,1.104569 -0.895431,2 -2,2 H 2 C 0.8954305,16 0,15.104569 0,14 Z" id="path2" /><path d="m 7.4989873,8.2973819 -2.1460003,-2.147 c -0.472,-0.472 -1.18,0.236 -0.708,0.708 l 3.0000003,3 c 0.1953639,0.1958581 0.5126361,0.1958581 0.708,0 l 2.9999997,-3 c 0.472,-0.472 -0.236,-1.18 -0.708,-0.708 l -2.1459997,2.147 c -0.4311027,0.417289 -0.5238956,0.423024 -1,0 z" style="" id="path566-6-3" /></svg>', Gl = '<svg width="46.08" height="46.08" version="1.1" viewBox="-1.6 -1.6 19.2 19.2" xmlns="http://www.w3.org/2000/svg"> <path d="m1 14a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-12a1 1 0 0 0-1-1h-12a1 1 0 0 0-1 1zm15 0a2 2 0 0 1-2 2h-12a2 2 0 0 1-2-2v-12a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2zm-8.5-2.5a0.5 0.5 0 0 0 1 0v-5.793l2.146 2.147a0.50063 0.50063 0 1 0 0.708-0.708l-3-3a0.5 0.5 0 0 0-0.708 0l-3 3a0.50063 0.50063 0 0 0 0.708 0.708l2.146-2.147z" fill-rule="evenodd"/></svg>', Yl = '<svg width="46.08" height="46.08" viewBox="-1.6 -1.6 19.2 19.2" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M 15,2 A 1,-1 0 0 0 14,1 H 2 A 1,-1 0 0 0 1,2 v 12 a 1,-1 0 0 0 1,1 h 12 a 1,-1 0 0 0 1,-1 z M 0,2 A 2,-2 0 0 1 2,0 h 12 a 2,-2 0 0 1 2,2 v 12 a 2,-2 0 0 1 -2,2 H 2 A 2,-2 0 0 1 0,14 Z m 8.5,2.5 a 0.5,-0.5 0 0 0 -1,0 v 5.793 L 5.354,8.146 A 0.5006316,-0.5006316 0 1 0 4.646,8.854 l 3,3 a 0.5,-0.5 0 0 0 0.708,0 l 3,-3 A 0.5006316,-0.5006316 0 0 0 10.646,8.146 L 8.5,10.293 Z" id="path2" /></svg>', ql = '<svg style="width: 46px; height: 46px" viewBox="-1.6 -1.6 19.2 19.2"><path d="M 15,2 C 15,1.4477153 14.552285,1 14,1 H 2 C 1.4477153,1 1,1.4477153 1,2 v 12 c 0,0.552285 0.4477153,1 1,1 h 12 c 0.552285,0 1,-0.447715 1,-1 z M 0,2 C 0,0.8954305 0.8954305,0 2,0 h 12 c 1.104569,0 2,0.8954305 2,2 v 12 c 0,1.104569 -0.895431,2 -2,2 H 2 C 0.8954305,16 0,15.104569 0,14 Z" id="path2" /><g id="g687" transform="translate(15.647255,-0.0288128)"><path d="m -8.1462425,10.484879 -2.1460005,2.146999 c -0.472,0.472 -1.18,-0.236 -0.708,-0.708 l 3.0000005,-2.9999994 c 0.195364,-0.195858 0.512636,-0.195858 0.708,0 l 3.0000005,2.9999994 c 0.472,0.472 -0.236,1.18 -0.708,0.708 l -2.1460005,-2.146999 c -0.431103,-0.417289 -0.523896,-0.423024 -1,0 z" style="" id="path566-5" /><path d="m -8.1482677,5.5727476 -2.1460003,-2.147 c -0.472,-0.472 -1.18,0.236 -0.708,0.708 l 3.0000003,3 c 0.1953639,0.195858 0.5126361,0.195858 0.708,0 l 2.9999997,-3 c 0.472,-0.472 -0.236,-1.18 -0.708,-0.708 l -2.1459997,2.147 c -0.4311027,0.417289 -0.5238956,0.423024 -1,0 z" style="" id="path566-6-3" /></g></svg>', Xl = '<svg style="width: 46px; height: 46px" viewBox="-1.6 -1.6 19.2 19.2"><path d="M 15,2 C 15,1.4477153 14.552285,1 14,1 H 2 C 1.4477153,1 1,1.4477153 1,2 v 12 c 0,0.552285 0.4477153,1 1,1 h 12 c 0.552285,0 1,-0.447715 1,-1 z M 0,2 C 0,0.8954305 0.8954305,0 2,0 h 12 c 1.104569,0 2,0.8954305 2,2 v 12 c 0,1.104569 -0.895431,2 -2,2 H 2 C 0.8954305,16 0,15.104569 0,14 Z" id="path2" /><g id="g611" transform="translate(0.2050748,-0.8829888)"><path d="m 7.2959375,11.933818 -2.146,-2.1469999 c -0.472,-0.4719998 -1.18,0.2359999 -0.708,0.7079999 l 3,3 c 0.195364,0.195858 0.512636,0.195858 0.708,0 l 3.0000005,-3 c 0.472,-0.472 -0.236,-1.1799997 -0.708,-0.7079999 L 8.2959375,11.933818 c -0.431103,0.417289 -0.523896,0.423024 -1,0 z" style="" id="path566" /><path d="m 7.2939123,5.8321596 -2.146,2.147 c -0.4719998,0.472 -1.1799998,-0.236 -0.708,-0.708 l 3,-3 c 0.1953639,-0.195858 0.5126361,-0.195858 0.708,0 l 2.9999997,3 c 0.472,0.472 -0.236,1.18 -0.708,0.708 l -2.1459997,-2.147 c -0.4311027,-0.417289 -0.5238956,-0.423024 -1,0 z" style="" id="path566-6" /></g></svg>', Kl = '<svg style="width: 46px; height: 46px" viewBox="-1.6 -1.6 19.2 19.2"><path d="M 15,2 C 15,1.4477153 14.552285,1 14,1 H 2 C 1.4477153,1 1,1.4477153 1,2 v 12 c 0,0.552285 0.4477153,1 1,1 h 12 c 0.552285,0 1,-0.447715 1,-1 z M 0,2 C 0,0.8954305 0.8954305,0 2,0 h 12 c 1.104569,0 2,0.8954305 2,2 v 12 c 0,1.104569 -0.895431,2 -2,2 H 2 C 0.8954305,16 0,15.104569 0,14 Z" id="path2" /><path d="m 11.500447,8.5 c 0.666666,0 0.666666,-1 0,-1 H 4.444275 c -0.1571231,0 -0.224029,0.07336 -0.2978281,0.1459999 -0.1958579,0.195364 -0.1958579,0.5126361 0,0.7080001 0,0 0.113806,0.146 0.320186,0.146 z" style="" id="path887" /></svg>', jl = '<svg style="height:46px;width:46px" version="1.1" viewBox="-1.6 -1.6 19.2 19.2" xmlns="http://www.w3.org/2000/svg"> <g fill-rule="evenodd">  <path d="m15 2c0-0.55228-0.44772-1-1-1h-12c-0.55228 0-1 0.44772-1 1v12c0 0.55228 0.44772 1 1 1h12c0.55228 0 1-0.44772 1-1zm-15 0c0-1.1046 0.89543-2 2-2h12c1.1046 0 2 0.89543 2 2v12c0 1.1046-0.89543 2-2 2h-12c-1.1046 0-2-0.89543-2-2z"/>  <path d="m4.4449 4.097c-0.01964 0-0.037678 0.0018-0.054687 0.0039-0.017011 0.0022-0.034068 0.0058-0.048828 0.0098-0.014761 4e-3 -0.028126 0.0081-0.041016 0.01367-0.012889 0.0056-0.025711 0.01268-0.037109 0.01953-0.022796 0.01371-0.041442 0.02783-0.060547 0.04492s-0.038191 0.03653-0.056641 0.05469c-0.024482 0.02442-0.046092 0.05037-0.064453 0.07813-0.018362 0.02775-0.032681 0.05776-0.044922 0.08789s-0.021223 0.06023-0.027344 0.0918c-0.00612 0.03156-0.00977 0.06366-0.00977 0.0957 0 8e-3 -4.378e-4 0.01543 0 0.02344v1.2988c0 0.02083 6.41e-5 0.04102 0.00195 0.06055 0.00189 0.01953 0.0061 0.03841 0.00977 0.05664 0.00366 0.01823 0.00836 0.03581 0.013672 0.05273 0.00531 0.01693 0.010742 0.0332 0.017578 0.04883 0.013672 0.03125 0.029785 0.0599 0.048828 0.08594s0.041016 0.04948 0.064453 0.07031 0.049316 0.03906 0.076172 0.05469c0.026855 0.01563 0.054687 0.02865 0.083984 0.03906 0.029297 0.01042 0.059082 0.01823 0.089844 0.02344 0.030762 0.0052 0.0625 0.0078 0.09375 0.0078s0.062988-0.0026 0.09375-0.0078 0.060547-0.01302 0.089844-0.02344 0.057129-0.02344 0.083984-0.03906c0.026855-0.01563 0.052734-0.03385 0.076172-0.05469 0.023437-0.02083 0.04541-0.04427 0.064453-0.07031s0.035156-0.05469 0.048828-0.08594c0.00684-0.01563 0.012268-0.0319 0.017578-0.04883s0.01001-0.0345 0.013672-0.05273c0.00366-0.01823 0.00787-0.03711 0.00977-0.05664 0.00189-0.01953 0.00195-0.03971 0.00195-0.06055v-0.82227h6v0.98633c0 0.02083 2e-3 0.04102 0.0039 0.06055s0.0042 0.03841 0.0078 0.05664c0.0037 0.01823 0.0084 0.03581 0.01367 0.05273 0.0053 0.01693 0.01074 0.0332 0.01758 0.04883 0.01367 0.03125 0.03174 0.0599 0.05078 0.08594s0.03906 0.04948 0.0625 0.07031 0.04932 0.03906 0.07617 0.05469c0.02686 0.01563 0.05469 0.02865 0.08399 0.03906 0.0293 0.01042 0.06104 0.01823 0.0918 0.02344 0.03076 0.0052 0.06055 0.0078 0.0918 0.0078s0.06299-0.0026 0.09375-0.0078 0.06055-0.01302 0.08984-0.02344c0.0293-0.01042 0.05908-0.02344 0.08594-0.03906 0.02686-0.01563 0.05078-0.03385 0.07422-0.05469 0.02344-0.02083 0.04541-0.04427 0.06445-0.07031s0.03516-0.05469 0.04883-0.08594c0.0068-0.01563 0.01422-0.0319 0.01953-0.04883 0.0053-0.01693 0.01001-0.0345 0.01367-0.05273 0.0037-0.01823 0.0059-0.03711 0.0078-0.05664s2e-3 -0.03971 2e-3 -0.06055v-1.4629c3.25e-4 -0.0078 0-0.01563 0-0.02344 0-0.03125-0.0026-0.06299-0.0078-0.09375s-0.01302-0.06055-0.02344-0.08984c-0.01042-0.0293-0.02344-0.05713-0.03906-0.08398-0.01563-0.02685-0.03385-0.05273-0.05469-0.07617-0.02083-0.02344-0.04427-0.04541-0.07031-0.06445s-0.05469-0.03516-0.08594-0.04883c-0.01563-0.0068-0.0319-0.01227-0.04883-0.01758-0.01693-0.0053-0.0345-0.01001-0.05273-0.01367-0.01823-0.0037-0.03711-0.0059-0.05664-0.0078s-0.03971-0.0039-0.06055-0.0039h-6.5z"/>  <path d="m11.555 11.903c0.01964 0 0.03768-0.0018 0.05469-0.0039 0.01701-0.0022 0.03407-0.0058 0.04883-0.0098s0.02813-0.0081 0.04102-0.01367c0.01289-0.0056 0.02571-0.01268 0.03711-0.01953 0.0228-0.01371 0.04144-0.02783 0.06055-0.04492 0.0191-0.01709 0.03819-0.03653 0.05664-0.05469 0.02448-0.02442 0.04609-0.05037 0.06445-0.07813 0.01836-0.02775 0.03268-0.05776 0.04492-0.08789s0.02122-0.06023 0.02734-0.0918c0.0061-0.03156 0.0098-0.06366 0.0098-0.0957 0-8e-3 4.38e-4 -0.01543 0-0.02344v-1.2988c0-0.02083-6.4e-5 -0.04102-2e-3 -0.06055-0.0019-0.01953-0.0061-0.03841-0.0098-0.05664s-0.0084-0.03581-0.01367-0.05273c-0.0053-0.01693-0.01074-0.0332-0.01758-0.04883-0.01367-0.03125-0.02979-0.0599-0.04883-0.08594s-0.04102-0.04948-0.06445-0.07031c-0.02344-0.02083-0.04932-0.03906-0.07617-0.05469s-0.05469-0.02865-0.08398-0.03906c-0.0293-0.01042-0.05908-0.01823-0.08984-0.02344-0.03076-0.0052-0.0625-0.0078-0.09375-0.0078s-0.06299 0.0026-0.09375 0.0078-0.06055 0.01302-0.08984 0.02344c-0.0293 0.01042-0.05713 0.02344-0.08398 0.03906-0.02685 0.01563-0.05273 0.03385-0.07617 0.05469-0.02344 0.02083-0.04541 0.04427-0.06445 0.07031s-0.03516 0.05469-0.04883 0.08594c-0.0068 0.01563-0.01227 0.0319-0.01758 0.04883-0.0053 0.01693-0.01001 0.0345-0.01367 0.05273-0.0037 0.01823-0.0079 0.03711-0.0098 0.05664s-0.0019 0.03971-0.0019 0.06055v0.82227h-6v-0.98633c0-0.02083-2e-3 -0.04102-0.0039-0.06055s-0.0042-0.03841-0.0078-0.05664c-0.0037-0.01823-0.0084-0.03581-0.01367-0.05273-0.0053-0.01693-0.01074-0.0332-0.01758-0.04883-0.01367-0.03125-0.03174-0.0599-0.05078-0.08594s-0.03906-0.04948-0.0625-0.07031-0.04932-0.03906-0.07617-0.05469c-0.02686-0.01563-0.05469-0.02865-0.08399-0.03906-0.0293-0.01042-0.06104-0.01823-0.0918-0.02344-0.03076-0.0052-0.06055-0.0078-0.0918-0.0078s-0.06299 0.0026-0.09375 0.0078-0.06055 0.01302-0.08984 0.02344c-0.0293 0.01042-0.05908 0.02344-0.08594 0.03906-0.02686 0.01563-0.05078 0.03385-0.07422 0.05469-0.02344 0.02083-0.04541 0.04427-0.06445 0.07031s-0.03516 0.05469-0.04883 0.08594c-0.0068 0.01563-0.01422 0.0319-0.01953 0.04883-0.0053 0.01693-0.01001 0.03451-0.01367 0.05273-0.0037 0.01823-0.0059 0.03711-0.0078 0.05664s-2e-3 0.03971-2e-3 0.06055v1.4629c-3.25e-4 0.0078 0 0.01563 0 0.02344 0 0.03125 0.0026 0.06299 0.0078 0.09375s0.01302 0.06055 0.02344 0.08984c0.01042 0.0293 0.02344 0.05713 0.03906 0.08398 0.01563 0.02685 0.03385 0.05273 0.05469 0.07617 0.02083 0.02344 0.04427 0.04541 0.07031 0.06445s0.05469 0.03516 0.08594 0.04883c0.01563 0.0068 0.0319 0.01227 0.04883 0.01758 0.01693 0.0053 0.0345 0.01001 0.05273 0.01367 0.01823 0.0037 0.03711 0.0059 0.05664 0.0078s0.03971 0.0039 0.06055 0.0039h6.5z"/></g></svg>', Zl = '<svg style="height:46px;width:46px" version="1.1" viewBox="-1.6 -1.6 19.2 19.2" xmlns="http://www.w3.org/2000/svg"> <path d="m15 2c0-0.55228-0.44772-1-1-1h-12c-0.55228 0-1 0.44772-1 1v12c0 0.55228 0.44772 1 1 1h12c0.55228 0 1-0.44772 1-1zm-15 0c0-1.1046 0.89543-2 2-2h12c1.1046 0 2 0.89543 2 2v12c0 1.1046-0.89543 2-2 2h-12c-1.1046 0-2-0.89543-2-2z" fill-rule="evenodd"/> <path d="m13.291 7.7876c-1.0729-2.491-3.0911-4.0365-5.2687-4.0365-2.1776 0-4.1958 1.5456-5.2687 4.0365a0.53112 0.53112 0 0 0 0 0.4249c1.0729 2.491 3.0911 4.0365 5.2687 4.0365 2.1776 0 4.1959-1.5456 5.2687-4.0365a0.53112 0.53112 0 0 0 0-0.4249zm-5.2687 3.3992c-1.6836 0-3.277-1.2163-4.1958-3.1867 0.91884-1.9705 2.5122-3.1867 4.1958-3.1867 1.6837 0 3.277 1.2163 4.1959 3.1867-0.91884 1.9705-2.5122 3.1867-4.1959 3.1867zm0-5.3112a2.1245 2.1245 0 1 0 2.1245 2.1245 2.1245 2.1245 0 0 0-2.1245-2.1245zm0 3.1867a1.0622 1.0622 0 1 1 1.0622-1.0622 1.0622 1.0622 0 0 1-1.0622 1.0622z" stroke-width=".53112"/></svg>', Jl = '<svg style="height:46px;width:46px" version="1.1" viewBox="-1.6 -1.6 19.2 19.2" xmlns="http://www.w3.org/2000/svg"> <path d="m15 2c0-0.55228-0.44772-1-1-1h-12c-0.55228 0-1 0.44772-1 1v12c0 0.55228 0.44772 1 1 1h12c0.55228 0 1-0.44772 1-1zm-15 0c0-1.1046 0.89543-2 2-2h12c1.1046 0 2 0.89543 2 2v12c0 1.1046-0.89543 2-2 2h-12c-1.1046 0-2-0.89543-2-2z" fill-rule="evenodd"/> <path d="m13.291 7.7876c-1.0729-2.491-3.0911-4.0365-5.2687-4.0365-2.1776 0-4.1958 1.5456-5.2687 4.0365a0.53112 0.53112 0 0 0 0 0.4249c1.0729 2.491 3.0911 4.0365 5.2687 4.0365 2.1776 0 4.1959-1.5456 5.2687-4.0365a0.53112 0.53112 0 0 0 0-0.4249zm-5.2687 3.3992c-1.6836 0-3.277-1.2163-4.1958-3.1867 0.91884-1.9705 2.5122-3.1867 4.1958-3.1867 1.6837 0 3.277 1.2163 4.1959 3.1867-0.91884 1.9705-2.5122 3.1867-4.1959 3.1867zm0-5.3112a2.1245 2.1245 0 1 0 2.1245 2.1245 2.1245 2.1245 0 0 0-2.1245-2.1245zm0 3.1867a1.0622 1.0622 0 1 1 1.0622-1.0622 1.0622 1.0622 0 0 1-1.0622 1.0622z" stroke-width=".53112"/> <path d="m12.757 3.0055c-0.11087 0.0051358-0.22696 0.051177-0.33008 0.1543l-4.9883 4.9902c-0.061946 0.061947-0.086644 0.12038-0.097656 0.17773l-4.8184 4.8164c-0.1111 0.1111-0.1066 0.2109-0.10742 0.31445-3.5e-4 0.27663 0.22337 0.50035 0.5 0.5 0 0 0.18415 0.022881 0.33008-0.12305l4.9746-4.9727c0.06758-0.06758 0.10951-0.13979 0.13281-0.21289l4.7832-4.7832c0.36828-0.36828 0.017071-0.87967-0.37891-0.86133z" fill-rule="evenodd"/></svg>', Ql = '<svg class="ov-icon" width="46.08" height="46.08" version="1.1" viewBox="-1.6 -1.6 19.2 19.2"><path d="m14 15c0.55228 0 1-0.44772 1-1v-12c0-0.55228-0.44772-1-1-1h-12c-0.55228 0-1 0.44772-1 1v12c0 0.55228 0.44772 1 1 1zm0-15c1.1046 0 2 0.89543 2 2v12c0 1.1046-0.89543 2-2 2h-12c-1.1046 0-2-0.89543-2-2v-12c0-1.1046 0.89543-2 2-2z" fill-rule="evenodd"/><g transform="translate(-1.1585)" fill-rule="evenodd">  <path d="m8.2964 7.5-2.147-2.146c-0.472-0.472 0.236-1.18 0.708-0.708l3 3c0.19586 0.19536 0.19586 0.51264 0 0.708l-3 3c-0.472 0.472-1.18-0.236-0.708-0.708l2.147-2.146c0.41729-0.4311 0.42302-0.5239 0-1z"/>  <path d="m12.323 4.4996c0-0.66667-1-0.66667-1 0v7.0562c0 0.15712 0.07336 0.22403 0.146 0.29783 0.19536 0.19586 0.51264 0.19586 0.708 0 0 0 0.146-0.11381 0.146-0.32019z"/></g></svg>', eh = '<svg class="ov-icon" width="46.08" height="46.08" version="1.1" viewBox="-1.6 -1.6 19.2 19.2"><path d="m2 15c-0.55228 0-1-0.44772-1-1v-12c0-0.55228 0.44772-1 1-1h12c0.55228 0 1 0.44772 1 1v12c0 0.55228-0.44772 1-1 1zm0-15c-1.1046 0-2 0.89543-2 2v12c0 1.1046 0.89543 2 2 2h12c1.1046 0 2-0.89543 2-2v-12c0-1.1046-0.89543-2-2-2z" fill-rule="evenodd"/><g transform="matrix(-1 0 0 1 17.159 0)" fill-rule="evenodd">  <path d="m8.2964 7.5-2.147-2.146c-0.472-0.472 0.236-1.18 0.708-0.708l3 3c0.19586 0.19536 0.19586 0.51264 0 0.708l-3 3c-0.472 0.472-1.18-0.236-0.708-0.708l2.147-2.146c0.41729-0.4311 0.42302-0.5239 0-1z"/>  <path d="m12.323 4.4996c0-0.66667-1-0.66667-1 0v7.0562c0 0.15712 0.07336 0.22403 0.146 0.29783 0.19536 0.19586 0.51264 0.19586 0.708 0 0 0 0.146-0.11381 0.146-0.32019z"/></g></svg>', th = '<svg clip-rule="evenodd" fill-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" version="1.1" viewBox="0 0 336.96 336.36" xmlns="http://www.w3.org/2000/svg"><path d="m0 0 168.48 336.36 168.48-336.36z"/></svg>', ih = '<svg clip-rule="evenodd" fill-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" version="1.1" viewBox="0 0 336.96 336.36" xmlns="http://www.w3.org/2000/svg"><path d="m0 336.36 168.48-336.36 168.48 336.36z"/></svg>', sh = '<svg clip-rule="evenodd" fill-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" version="1.1" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m512 256c0 70.67-28.66 134.68-74.99 181.01s-110.34 74.99-181.01 74.99c-70.68 0-134.69-28.66-181.01-74.99-46.33-46.33-74.99-110.34-74.99-181.01 0-70.68 28.66-134.69 74.99-181.01 46.32-46.33 110.33-74.99 181.01-74.99 70.67 0 134.68 28.66 181.01 74.99 46.33 46.32 74.99 110.33 74.99 181.01zm-204.29-21.97v-67.04c0-7.53-6.19-13.72-13.73-13.72h-75.96c-7.53 0-13.72 6.17-13.72 13.72v67.03h-42.84c-16.5 0-24.78 19.64-13.86 31.54l94.74 110.57c7.44 9 21.03 9.01 28.66 0.37l93.71-111.31c10.69-12.27 1.64-31.14-14.19-31.16h-42.81zm105.52 179.2c40.22-40.24 65.11-95.84 65.11-157.23 0-61.4-24.89-117-65.11-157.23-40.24-40.23-95.84-65.11-157.23-65.11-61.4 0-117 24.88-157.23 65.11s-65.11 95.83-65.11 157.23c0 61.39 24.88 116.99 65.11 157.23 40.23 40.22 95.83 65.11 157.23 65.11 61.39 0 116.99-24.89 157.23-65.11z" fill-rule="nonzero"/></svg>', nh = '<svg clip-rule="evenodd" fill-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" version="1.1" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m512 256c0-70.67-28.66-134.68-74.99-181.01s-110.34-74.99-181.01-74.99c-70.68 0-134.69 28.66-181.01 74.99-46.33 46.33-74.99 110.34-74.99 181.01 0 70.68 28.66 134.69 74.99 181.01 46.32 46.33 110.33 74.99 181.01 74.99 70.67 0 134.68-28.66 181.01-74.99 46.33-46.32 74.99-110.33 74.99-181.01zm-204.29 21.97v67.04c0 7.53-6.19 13.72-13.73 13.72h-75.96c-7.53 0-13.72-6.17-13.72-13.72v-67.03h-42.84c-16.5 0-24.78-19.64-13.86-31.54l94.74-110.57c7.44-9 21.03-9.01 28.66-0.37l93.71 111.31c10.69 12.27 1.64 31.14-14.19 31.16zm105.52-179.2c40.22 40.24 65.11 95.84 65.11 157.23 0 61.4-24.89 117-65.11 157.23-40.24 40.23-95.84 65.11-157.23 65.11-61.4 0-117-24.88-157.23-65.11s-65.11-95.83-65.11-157.23c0-61.39 24.88-116.99 65.11-157.23 40.23-40.22 95.83-65.11 157.23-65.11 61.39 0 116.99 24.89 157.23 65.11z" fill-rule="nonzero"/></svg>', rh = '<svg clip-rule="evenodd" fill-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" version="1.1" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M512 256c0-70.67-28.66-134.68-74.98-181.02C390.69 28.66 326.68 0 256 0S121.31 28.66 74.98 74.98C28.66 121.32 0 185.33 0 256c0 70.68 28.66 134.69 74.98 181.02C121.31 483.34 185.32 512 256 512c70.67 0 134.69-28.66 181.02-74.98C483.34 390.69 512 326.68 512 256zm-160.23-21.5h-43.38v-67.93c0-7.63-6.27-13.9-13.91-13.9H217.5c-7.62 0-13.9 6.25-13.9 13.9v67.92h-43.41c-16.71 0-25.11 19.9-14.05 31.96l96.01 112.05c7.54 9.12 21.31 9.12 29.04.37l94.96-112.8c10.83-12.43 1.66-31.55-14.38-31.57z"/></svg>', oh = '<svg clip-rule="evenodd" fill-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" version="1.1" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m512 256c0 70.67-28.66 134.68-74.98 181.02-46.33 46.32-110.34 74.98-181.02 74.98s-134.69-28.66-181.02-74.98c-46.32-46.34-74.98-110.35-74.98-181.02 0-70.68 28.66-134.69 74.98-181.02 46.33-46.32 110.34-74.98 181.02-74.98 70.67 0 134.69 28.66 181.02 74.98 46.32 46.33 74.98 110.34 74.98 181.02zm-160.23 21.5h-43.38v67.93c0 7.63-6.27 13.9-13.91 13.9h-76.98c-7.62 0-13.9-6.25-13.9-13.9v-67.92h-43.41c-16.71 0-25.11-19.9-14.05-31.96l96.01-112.05c7.54-9.12 21.31-9.12 29.04-0.37l94.96 112.8c10.83 12.43 1.66 31.55-14.38 31.57z"/></svg>', ah = '<svg width="800px" height="800px" version="1.1" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">  <defs>   <clipPath id="clipPath1">    <path d="m6.1885 15.281v-9.0209h3.1721q1.0764 0 1.6765 0.65299 0.63822 0.71345 0.63822 1.7171 0 0.58043-0.22862 1.0158-0.21909 0.42323-0.743 0.84646 1.1812 0.87065 1.1812 2.1887 0 0.53206-0.19051 1.0762-0.19051 0.53206-0.51439 0.87065-0.60964 0.65299-1.7908 0.65299zm1.467-7.4731v2.0315h1.5813q1.0383 0 1.0383-1.0158 0-1.0158-1.0383-1.0158zm0 3.5793v2.3459h1.7432q1.0859 0 1.0859-1.1609 0-1.185-1.0859-1.185zm9.6876-5.1271h1.467v6.1066q0 1.4874-0.69538 2.2854-0.80016 0.91902-2.1242 0.91902t-2.1242-0.91902q-0.69538-0.79809-0.69538-2.2854v-6.1066h1.4574v6.1066q0 1.6083 1.3622 1.6083 1.3526 0 1.3526-1.6083zm6.2108 5.6834v3.3375h-1.467v-3.3375l-2.3528-5.6834h1.6289l1.4479 3.9784 1.3622-3.9784h1.6384z" display="none" stroke-width=".041213" style="white-space:pre" aria-label="BUY"/>    <path class="powerclip" d="m-5-5h42v42.001h-42zm11.189 20.281h3.2006q1.1812 0 1.7908-0.65299 0.32387-0.33859 0.51439-0.87065 0.19051-0.54416 0.19051-1.0762 0-1.3181-1.1812-2.1887 0.52391-0.42323 0.743-0.84646 0.22862-0.43532 0.22862-1.0158 0-1.0037-0.63822-1.7171-0.60012-0.65299-1.6765-0.65299h-3.1721zm1.467-7.4731v2.0315h1.5813q1.0383 0 1.0383-1.0158 0-1.0158-1.0383-1.0158zm0 3.5793v2.3459h1.7432q1.0859 0 1.0859-1.1609 0-1.185-1.0859-1.185zm9.6876-5.1271v6.1066q0 1.6083-1.3526 1.6083-1.3622 0-1.3622-1.6083v-6.1066h-1.4574v6.1066q0 1.4874 0.69538 2.2854 0.80016 0.91902 2.1242 0.91902t2.1242-0.91902q0.69538-0.79809 0.69538-2.2854v-6.1066zm6.2108 5.6834 2.2576-5.6834h-1.6384l-1.3622 3.9784-1.4479-3.9784h-1.6289l2.3528 5.6834v3.3375h1.467z" stroke-width=".041213" style="white-space:pre"/>   </clipPath>  </defs>  <g clip-path="url(#clipPath1)" fill="none" fill-rule="evenodd">   <g id="Icon-Set" transform="translate(-360 -255)" fill="#000">    <path d="m386.67 255h-21.334c-2.945 0-5.333 2.371-5.333 5.297v12.33c0 2.924 2.055 4.813 5 4.813h6.639l4.361 9.561 4.361-9.561h6.639c2.945 0 5-1.889 5-4.813v-12.33c0-2.926-2.388-5.297-5.333-5.297z"/>   </g>  </g> </svg>', lh = '<svg width="800px" height="800px" version="1.1" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">  <defs>   <clipPath id="clipPath4">    <path d="m10.026 8.6238h-1.2531q-0.06962-1.4148-1.3576-1.4148-0.51344 0-0.81803 0.30231-0.30458 0.30231-0.30458 0.81019 0 0.49579 0.25237 0.74972 0.26107 0.24185 0.97467 0.43532l1.0182 0.26603q0.90505 0.24185 1.3054 0.83437 0.40901 0.59252 0.40901 1.6566 0 1.3785-0.7049 2.1524-0.69619 0.77391-1.958 0.77391-1.2444 0-1.9406-0.76182-0.68749-0.77391-0.74841-2.225h1.2967q0.03481 0.72554 0.40901 1.1125t1.053 0.38696q0.60917 0 0.95727-0.32649 0.3568-0.32649 0.3568-0.89483 0-0.54416-0.27848-0.83437-0.27848-0.30231-0.94856-0.4716l-0.90505-0.25394q-0.99208-0.26603-1.4098-0.81019-0.41772-0.55625-0.41772-1.6083 0-1.3181 0.64398-2.0436 0.65268-0.73763 1.8188-0.73763 1.4185 0 2.0886 1.0278 0.46123 0.71345 0.46123 1.8743zm2.5672 2.3822v2.3459h3.5245v1.5478h-4.8559v-9.0209h4.6993v1.5478h-3.3678v2.0315h3.1155v1.5478zm5.9612-5.1271v7.4731h3.1068v1.5478h-4.4469v-9.0209zm5.439 0v7.4731h3.1068v1.5478h-4.4469v-9.0209z" display="none" stroke-width=".039392" style="white-space:pre" aria-label="SELL"/>    <path class="powerclip" d="m-5-5h42v42.001h-42zm15.026 13.624q0-1.1609-0.46123-1.8743-0.67009-1.0278-2.0886-1.0278-1.1661 0-1.8188 0.73763-0.64398 0.72554-0.64398 2.0436 0 1.052 0.41772 1.6083 0.41772 0.54416 1.4098 0.81019l0.90505 0.25394q0.67009 0.16929 0.94856 0.4716 0.27848 0.29022 0.27848 0.83437 0 0.56834-0.3568 0.89483-0.3481 0.32649-0.95727 0.32649-0.67879 0-1.053-0.38696-0.3742-0.38695-0.40901-1.1125h-1.2967q0.060917 1.4511 0.74841 2.225 0.69619 0.76182 1.9406 0.76182 1.2619 0 1.958-0.77391 0.7049-0.77391 0.7049-2.1524 0-1.0641-0.40901-1.6566-0.40031-0.59252-1.3054-0.83437l-1.0182-0.26603q-0.7136-0.19348-0.97467-0.43532-0.25237-0.25394-0.25237-0.74972 0-0.50788 0.30458-0.81019t0.81803-0.30231q1.288 0 1.3576 1.4148zm2.5672 2.3822h3.1155v-1.5478h-3.1155v-2.0315h3.3678v-1.5478h-4.6993v9.0209h4.8559v-1.5478h-3.5245zm5.9612-5.1271h-1.3402v9.0209h4.4469v-1.5478h-3.1068zm5.439 0h-1.3402v9.0209h4.4469v-1.5478h-3.1068z" stroke-width=".039392" style="white-space:pre"/>   </clipPath>  </defs>  <path d="m26.667 0h-21.334c-2.945 0-5.333 2.371-5.333 5.297v12.33c0 2.924 2.055 4.813 5 4.813h6.639l4.361 9.561 4.361-9.561h6.639c2.945 0 5-1.889 5-4.813v-12.33c0-2.926-2.388-5.297-5.333-5.297z" clip-path="url(#clipPath4)" fill-rule="evenodd"/> </svg>', hh = '<svg width="493px" height="512px" clip-rule="evenodd" fill-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" version="1.1" viewBox="0 0 493 511.77" xmlns="http://www.w3.org/2000/svg"><path d="m33.11 458.2 104.5-79.1c3.09-3 7.08-4.47 11.08-4.45l302.6-0.08c2.67 0 5.09-1.08 6.78-2.77 1.74-1.81 2.84-4.24 2.84-6.87v-323.2c0-2.59-1.12-5-2.86-6.74-1.78-1.78-4.2-2.9-6.76-2.9h-409.56c-2.54 0-4.94 1.14-6.72 2.92s-2.92 4.18-2.92 6.72c0 793.72 1.02 39.329 1.02 416.47zm90.6-229.77c10.9 0 19.74 8.85 19.74 19.74s-8.84 19.73-19.74 19.73c-10.89 0-19.73-8.84-19.73-19.73s8.84-19.74 19.73-19.74zm0-101.14c10.9 0 19.74 8.85 19.74 19.74s-8.84 19.74-19.74 19.74c-10.89 0-19.73-8.85-19.73-19.74s8.84-19.74 19.73-19.74zm61.72 138.89c-9.95 0-18.02-8.07-18.02-18.01 0-9.95 8.07-18.02 18.02-18.02h185.56c9.95 0 18.01 8.07 18.01 18.02 0 9.94-8.06 18.01-18.01 18.01zm0-101.13c-9.95 0-18.02-8.07-18.02-18.02 0-9.94 8.07-18.01 18.02-18.01h185.56c9.95 0 18.01 8.07 18.01 18.01 0 9.95-8.06 18.02-18.01 18.02zm-30.38 241.61-125.97 99.69c-2.96 3.32-7.24 5.42-12.01 5.42-8.85 0-17.07-7.1228-17.07-15.963v-454.08c0-11.4 4.77-21.88 12.31-29.42s18.02-12.31 29.42-12.31h409.56c11.4 0 21.9 4.74 29.45 12.29 7.5 7.51 12.26 17.96 12.26 29.44v323.2c0 11.48-4.7 21.95-12.24 29.49-7.61 7.54-18.05 12.24-29.47 12.24z" fill-rule="nonzero"/></svg>', ch = '<svg width="800px" height="800px" fill="none" version="1.1" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="m15.746 2.7281c-5.1207-2.0689-10.949 0.40512-13.018 5.5258-2.0689 5.1207 0.40512 10.949 5.5258 13.018 5.1207 2.0689 10.949-0.40508 13.018-5.5258 2.0689-5.1207-0.40508-10.949-5.5258-13.018zm-1.3378 8.3035-1.2703-0.51325c-0.21854-0.08829-0.32785-0.13246-0.3683-0.22775-0.04045-0.09529 0.0037-0.20461 0.09201-0.42314l1.6595-4.1073c0.33362-0.82575 0.50047-1.2387 0.33474-1.3523-0.16582-0.11359-0.49058 0.19103-1.1403 0.8003l-4.7426 4.4469c-1.0274 0.96338-1.541 1.445-1.4405 1.9835 0.10054 0.53837 0.75347 0.80216 2.0594 1.3298l1.2703 0.51325c0.21854 0.08829 0.32785 0.13246 0.3683 0.22775 0.04045 0.09529-0.0037 0.20461-0.09201 0.42314l-1.6595 4.1073c-0.33365 0.82582-0.50047 1.2387-0.33475 1.3523 0.16582 0.1136 0.49059-0.19104 1.1403-0.80025l4.7425-4.4469c1.0275-0.96346 1.5411-1.4451 1.4406-1.9836-0.10057-0.53838-0.75352-0.80218-2.0594-1.3298z" clip-rule="evenodd" fill-rule="evenodd"/></svg>', uh = '<svg enable-background="new 0 0 100 100" version="1.1" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">  <g>   <rect transform="scale(-1)" x="-15" y="-100" width="15" height="100">    <animate attributeName="height" attributeType="XML" dur="1s" repeatCount="indefinite" values="30; 100; 30"/>   </rect>   <rect transform="scale(-1)" x="-36.25" y="-100" width="15" height="100">    <animate attributeName="height" attributeType="XML" begin="0.1s" dur="1s" repeatCount="indefinite" values="30; 100; 30"/>   </rect>   <rect transform="scale(-1)" x="-57.5" y="-100" width="15" height="100">    <animate attributeName="height" attributeType="XML" begin="0.3s" dur="1s" repeatCount="indefinite" values="30; 100; 30"/>   </rect>   <rect transform="scale(-1)" x="-78.75" y="-100" width="15" height="100">    <animate attributeName="height" attributeType="XML" begin="0.5s" dur="1s" repeatCount="indefinite" values="30; 100; 30"/>   </rect>   <rect transform="scale(-1)" x="-100" y="-100" width="15" height="100">    <animate attributeName="height" attributeType="XML" begin="0.1s" dur="1s" repeatCount="indefinite" values="30; 100; 30"/>   </rect>  </g> </svg>', dh = '<svg version="1.1" id="L7" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"  viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">   <path fill="#fff" d="M42.3,39.6c5.7-4.3,13.9-3.1,18.1,2.7c4.3,5.7,3.1,13.9-2.7,18.1l4.1,5.5c8.8-6.5,10.6-19,4.1-27.7  c-6.5-8.8-19-10.6-27.7-4.1L42.3,39.6z">      <animateTransform         attributeName="transform"         attributeType="XML"         type="rotate"         dur="3s"         from="0 50 50"         to="360 50 50"         repeatCount="indefinite" />  </path> <path fill="#fff" d="M82,35.7C74.1,18,53.4,10.1,35.7,18S10.1,46.6,18,64.3l7.6-3.4c-6-13.5,0-29.3,13.5-35.3s29.3,0,35.3,13.5  L82,35.7z">      <animateTransform         attributeName="transform"         attributeType="XML"         type="rotate"         dur="2s"         from="0 50 50"         to="360 50 50"         repeatCount="indefinite" />  </path>   <path fill="#fff" d="M31.6,3.5C5.9,13.6-6.6,42.7,3.5,68.4c10.1,25.7,39.2,38.3,64.9,28.1l-3.1-7.9c-21.3,8.4-45.4-2-53.8-23.3  c-8.4-21.3,2-45.4,23.3-53.8L31.6,3.5z">      <animateTransform         attributeName="transform"         attributeType="XML"         type="rotate"         dur="1s"         from="0 50 50"         to="360 50 50"         repeatCount="indefinite" />  </path></svg>', Fe = 300, Bt = 400, mh = `${Bt}px`, Nr = `${Fe}px`, ph = "100%", gh = "100%", _e = 30, nt = 35, _s = 25, Ir = 25, Dr = _s + Ir, Gt = 60, ct = "normal", ut = 12, Ji = "normal", dt = "Avenir, Helvetica, Arial, sans-serif", Hs = "#141414", $s = "#333", Us = "#cccccc", Yt = "#888888", ft = "#cccccc", Rr = "25px", fh = "position: relative;", B = {
  ...
  IMGWIDTH: "200",
  IMGHEIGHT: "200"
}, is = { arrowDown: th, arrowUp: ih, arrowDownRound: sh, arrowUpRound: nh, arrowDownRoundSolid: rh, arrowUpRoundSolid: oh, buySolid: ah, sellSolid: lh }, Zn = { noteSolid: hh, lightning: ch }, _r = {
  candle: {
    Type: J.CANDLE_SOLID,
...
<style>
  tradex-chart {
    ...
    max-height: var(--txc-max-height, ${gh});
    overflow: hidden;
...
function vs(o) {
  const e = {};
  return e.value = o, e.sign = !!o, e.integers = Hr(o), e.decimals = $r(o), e.total = e.integers + e.decimals, e;
}
function Hr(o) {
...
class bi extends Ur {
  ...
  calcXAxisGrads(e = this.range.snapshot()) {
    ...
    for (; h < l; ) {
      let g = fi(h, "years"), v = fi(h, "months"), S = fi(h, "days");
  ...
  xStep(e) {
    let i = Nl, s = this.#n ? e.interval : 1, n = Rt[0], r = be(this.width / e.Length), a = ds[0], l = Rt.indexOf(s);
    for (; l-- >= 0 && !(r * (Rt[l] / s) >= i); )
      ;
...
class Ci extends Ur {
  ...
  gradations(e, i, s = !0) {
    ...
    this.#d = A;
    for (var R = m; R <= g; R += h)
      n = this.countDigits(R), L = ws(n), v = this.yPos(L), l.push([L, v, n]);
    return l;
  }
...
function Hi(o, e, i) {
  ...
  const s = Bs(o, e), n = i?.paddingLeft || 0, r = i?.paddingRight || 0, a = i?.borderWidth || 0;
  return n + r + s + a * 2;
}
function $i(o) {
...
function Vr(o, e, i, s, n, r) {
  o.lineWidth = r?.width || Ce.borderWidth, o.strokeStyle = r?.border || Ce.stroke, o.beginPath(), o.rect(e, i, s, n), o.stroke();
}
function Vs(o, e, i, s, n, r) {
  o.fillStyle = r?.fill || Ce.fill, o.fillRect(e, i, s, n);
}
function Ph(o, e, i, s, n, r) {
  E(r.fill) && Vs(o, e, i, s, n, r), T(r.width) && r.width > 0 && Vr(o, e, i, s, n, r);
}
function zr(o, e, i, s, n, r, a) {
  o.lineWidth = a?.width || Ce.borderWidth, o.strokeStyle = a?.border || Ce.stroke, Fr(o, e, i, s, n, r), o.stroke();
}
function Wr(o, e, i, s, n, r, a) {
  o.fillStyle = a?.fill || Ce.fill, Fr(o, e, i, s, n, r), o.fill();
}
...
function Mh(o, e, i, s, n, r, a) {
  E(a.fill) && Wr(o, e, i, s, n, r, a?.fill), T(a.width) && a.width > 0 && zr(o, e, i, s, n, r, a?.border, a?.width);
}
...
function Lh(o, e, i, s, n) {
  Gr(o, e, i, s, 3, n?.rotate || 0, n), Ct(o, n?.fill, n?.stroke, n?.width);
}
function Oh(o, e, i, s, n, r) {
...
function Ct(o, e, i, s) {
  E(e) && (o.fillStyle = e, o.fill()), T(s) && s > 0 && (o.lineWidth = s, o.strokeStyle = i || Ce.stroke, o.stroke());
}
function Yr(o, e, i, s, n, r, a, l, h, m) {
  o.drawImage(e, i, s, n, r, a, l, h, m);
}
function $h(o, e) {
  let i = o.naturalWidth || o.width, s = o.naturalHeight || o.height;
  return e === void 0 && (e = qr(i, s)), e.ctx.drawImage(o, 0, 0), e;
}
const Uh = {
  red: "#FF0000FF",
  green: "#00FF00FF",
...
function kt(o, e) {
  ...
  return s.fillStyle = Uh[o], s.globalCompositeOperation = "multiply", s.fillRect(0, 0, s.canvas.width, s.canvas.height), s.globalCompositeOperation = "destination-in", s.drawImage(e, 0, 0), s.globalCompositeOperation = "source-over", i;
}
function Bh(o) {
  return {
    red: kt("red", o),
...
const W = {
  ...
  renderPolygonRegular: Gr,
  renderPolygonIrregular: Ah,
  renderDiamond: Oh,
  renderTriangle: Lh
};
class Y {
...
class xs {
  ...
  constructor(e, i, s = {}) {
    ...
    if (this.data.length == 0) {
      ...
      this.data.length < 2 ? (this.#e = n, this.#t = Ut(this.interval)) : (this.#e = bs(this.data), this.#t = Ut(this.interval));
  ...
  setConfig(e) {
    if (!b(e))
      return !1;
    this.initialCnt = T(e?.initialCnt) ? e.initialCnt : Vn, this.limitFuture = T(e?.limitFuture) ? e.limitFuture : hi, this.limitPast = T(e?.limitPast) ? e.limitPast : zn, this.minCandles = T(e?.minCandles) ? e.minCandles : Wn, this.maxCandles = T(e?.maxCandles) ? e.maxCandles : Fn, this.yAxisBounds = T(e?.yAxisBounds) ? e.yAxisBounds : Bn;
  }
  setMaxMin(e) {
    for (let i in e)
  ...
  maxMinPriceVol(e) {
    ...
    let l = i.length - 1, h = re(s, 0, l), m = re(n, 0, l), g = i[h][3], v = i[h][2], S = i[h][5], A = i[h][5], L = h, R = h, ne = h, me = h;
    for (; h++ < m; )
      i[h][3] < g && (g = i[h][3], L = h), i[h][2] > v && (v = i[h][2], R = h), i[h][5] < S && (S = i[h][5], ne = h), i[h][5] > A && (A = i[h][5], me = h);
    let H = v - g, I = g, D = v;
...
function te(o = "ID") {
  T(o) ? o = o.toString() : E(o) || (o = "ID"), o = Be(o);
...
const Wh = (o) => o.entries().next().value, Fh = (o) => o.entries().next().value[0], Gh = (o) => o.entries().next().value[1], Yh = (o) => [...o].pop(), qh = (o) => [...o.keys()].pop(), Xh = (o) => [...o.values()].pop();
class Te extends Map {
  ...
  swapIndices(e, i) {
    if (!T(e) || !T(i))
      return !1;
    const s = [...this];
    return zh(s, e, i), this.populate(s), !0;
  }
  swapKeys(e, i) {
...
class Ue extends Y {
  ...
  set value(e) {
    ...
    e[ve.t] = s, this.#f[ve.t] !== e[ve.t] ? (this.#f[ve.t] = e[ve.t], this.#x(e)) : this.#w(e);
  }
  get value() {
    return this.#f;
  }
  destroy() {
    if (this.#g !== "destroyed") {
      ...
      super.destroy(), this.off($e, this.onStreamUpdate), this.chartPane.graph.removeOverlay(this.id), this.chart.legend.remove(this.#C), this.core.state.removeIndicator(this.id), this.#g = "destroyed";
    }
  }
  remove() {
  ...
  calcIndicatorStream(e, i, s = this.range) {
    if (!this.core.TALibReady || !E(e) || !(e in this.TALib) || !(s instanceof xs) || s.dataLength < this.definition.input.timePeriod)
      return !1;
...
const jh = {
  ...
  CDL3OUTSIDE: yc,
  CDL3STARSINSOUTH: vc,
  CDL3WHITESOLDIERS: wc,
  CDLABANDONEDBABY: xc,
  CDLADVANCEBLOCK: bc,
  CDLBELTHOLD: Cc,
  CDLBREAKAWAY: Tc,
  CDLCLOSINGMARUBOZU: Sc,
  CDLCONCEALBABYSWALL: Ec,
  CDLCOUNTERATTACK: Pc,
  CDLDARKCLOUDCOVER: Mc,
  CDLDOJI: Ac,
  CDLDOJISTAR: Lc,
  CDLDRAGONFLYDOJI: Oc,
  CDLENGULFING: Nc,
  CDLEVENINGDOJISTAR: Ic,
  CDLEVENINGSTAR: Dc,
  CDLGAPSIDESIDEWHITE: Rc,
  CDLGRAVESTONEDOJI: kc,
  CDLHAMMER: _c,
  CDLHANGINGMAN: Hc,
  CDLHARAMI: $c,
  CDLHARAMICROSS: Uc,
  ...
  CDLHIKKAKEMOD: zc,
  CDLHOMINGPIGEON: Wc,
  CDLIDENTICAL3CROWS: Fc,
  CDLINNECK: Gc,
  CDLINVERTEDHAMMER: Yc,
  CDLKICKING: qc,
  CDLKICKINGBYLENGTH: Xc,
  CDLLADDERBOTTOM: Kc,
  ...
  CDLMATCHINGLOW: Qc,
  CDLMATHOLD: eu,
  CDLMORNINGDOJISTAR: tu,
  CDLMORNINGSTAR: iu,
  CDLONNECK: su,
  CDLPIERCING: nu,
  CDLRICKSHAWMAN: ru,
  CDLRISEFALL3METHODS: ou,
  CDLSEPARATINGLINES: au,
  CDLSHOOTINGSTAR: lu,
  CDLSHORTLINE: hu,
  CDLSPINNINGTOP: cu,
  CDLSTALLEDPATTERN: uu,
  CDLSTICKSANDWICH: du,
  CDLTAKURI: mu,
  CDLTASUKIGAP: pu,
  CDLTHRUSTING: gu,
...
const io = {
  AROON: { id: "AROON", name: "Aroon", event: "addIndicator", ind: zs },
  BB: { id: "BB", name: "Bollinger Bands", event: "addIndicator", ind: Ws },
  EMA: { id: "EMA", name: "Exponential Moving Average", event: "addIndicator", ind: Oi },
  RSI: { id: "RSI", name: "Relative Strength Index", event: "addIndicator", ind: Fs },
  SMA: { id: "SMA", name: "Simple Moving Average", event: "addIndicator", ind: Ni },
  STOCH: { id: "STOCH", name: "Stochastic Oscillator", event: "addIndicator", ind: Gs }
}, Ys = "0.141.1";
class Fd {
  #e;
  #t;
  ...
  #r = [];
  constructor(e, i) {
    this.#e = e, this.#t = E(i.id) ? i.id : te, this.#n = E(i.type) ? i.type : "default", this.#r = M(i.data) ? i.data : [];
  }
}
function Gd(o, e = !1) {
  if (!M(o))
...
function Si(o, e = !1) {
  return !(!M(o) || o.length !== 6 || e && !xr(o[0]) || !T(o[1]) || !T(o[2]) || !T(o[3]) || !T(o[4]) || !T(o[5]));
}
function Xd(o) {
  for (let e of o)
    for (let i = 0; i < 6; i++)
...
class $ {
  ...
  static validate(e, i = !1, s = !1) {
    ...
    if (b(e) || (e = {}), b(e.chart) || (e.chart = n.chart, e.chart.isEmpty = !0, e.chart.data = M(e.ohlcv) ? e.ohlcv : [], delete e.ohlcv), e = vt(n, e), i ? e.chart.data = Yd(e.chart.data, s) ? e.chart.data : [] : e.chart.data = Gd(e.chart.data, s) ? e.chart.data : [], e.chart.isEmpty = e.chart.data.length == 0, !T(e.chart?.tf) || i) {
      let h = bs(e.chart.data);
      h < G && (h = Ai), e.chart.tfms = h;
    }
    if ((!E(e.chart?.tfms) || i) && (e.chart.tf = Ut(e.chart.tfms)), M(e.views) || (e.views = n.views), M(e.primary) || (e.primary = n.primary), M(e.secondary) || (e.secondary = n.secondary), b(e.chart.settings) || (e.chart.settings = n.chart.settings), M(e.datasets) || (e.datasets = []), e.views.length == 0) {
    ...
    for (var l of e.datasets)
      this.#t || (this.#t = {}), this.dss[l.id] = new Fd(this, l);
    return e;
  }
  static delete(e) {
    if (!E(e) || !$.has(e))
  ...
  static export(e, i = {}) {
    ...
    let l;
    switch (a.length > 0 && a[a.length - 1].length > 6 && (a.length = a.length - 1), r.views.get("primary").pop(), r.views = Array.from(r.views), r.version = Ys, n) {
      case "json":
      default:
  ...
  use(e) {
    ...
    if (i.getRange(null, null, n), this.range.Length > 1) {
      const r = Cs(i.time, void 0), a = r ? r + this.range.initialCnt : s.data.length - 1, l = r || a - this.range.initialCnt;
  ...
  mergeData(e, i = !1, s = !1) {
    ...
    if (n > 1 && this.time.timeFrameMS !== bs(e?.ohlcv))
    ...
    if (M(l) && l.length > 0) {
      if (r = l.length - 1, h.length - 1, ne.mData = this.range.inRange(l[0][0]) && this.range.inRange(l[0][r]), !Q(l[r][7]) && l[r].length !== 8 && l[r][6] !== null && l[r][7] !== !0 ? l = Xd(l) : i.end >= this.range.timeFinish && i.start <= this.range.timeFinish && (i.start += this.range.interval, i.end += this.range.interval), h.length == 0)
        this.allData.data.push(...l);
      else {
        let I = this.time.timeFrameMS, D = l[0][0], re = l[l.length - 1][0], j = (l.length - 1) * I;
        re > D + j && (l = qd(l, I)), this.data.chart.data = this.merge(h, l);
      }
      if (s)
  ...
  addTrade(e) {
    const i = Object.keys(e), s = Object.keys(er);
    if (!b(e) || !Li(i, s))
      return !1;
    for (let a of s)
      if (typeof e[a] !== er[a])
...
class Ge {
  ...
  static validateConfig(e) {
    ...
    let s = Object.keys(e);
    if (!Kr(i, s) || !(e.initial in e.states))
      return !1;
...
class Jd {
  ...
  add(e, i, s) {
    if (isNaN(e) || !_(s))
      return !1;
    const n = te(Zd), r = { price: e, condition: i };
    if (this.list.has(r)) {
...
const Qd = 0, e0 = 1, t0 = 2, i0 = 3, s0 = 4, n0 = 5, di = [null, null, null, null, null], mi = {
  tfCountDown: !0,
  alerts: []
};
class pt {
  ...
  constructor(e) {
    this.#e = e, this.#r = e.time, this.status = { status: pa }, this.#t = pt.validateConfig(e.config?.stream), this.#i = T(e.config?.maxCandleUpdate) ? e.config.maxCandleUpdate : ya, this.#l = T(e.config?.streamPrecision) ? e.config.streamPrecision : va;
  }
  get config() {
    return this.#t;
  }
  ...
  set candle(e) {
    const i = [...this.#o];
    e.t = this.roundTime(new Date(e.t)), e.o = e.o * 1, e.h = e.h * 1, e.l = e.l * 1, e.c = e.c * 1, e.v = e.v * 1, this.#o[Qd] !== e.t ? this.newCandle(e) : this.updateCandle(e), this.status = { status: $t, data: this.#o }, this.lastTick = i;
  }
  get candle() {
    return this.#o !== di ? this.#o : null;
  }
  start() {
    this.#f = new Jd(this.#t.alerts), this.status = { status: bn }, this.#s = setInterval(this.onUpdate.bind(this), this.#i);
  }
  stop() {
    this.#f.destroy(), this.status = { status: ga };
  }
  emit(e, i) {
    this.#e.emit(e, i);
  }
  ...
  onTick(e) {
    (this.#n == bn || this.#n == $t) && b(e) && (this.candle = e);
  }
  onUpdate() {
  ...
  updateCandle(e) {
    let i = this.#o;
    i[e0] = e.o, i[t0] = e.h, i[i0] = e.l, i[s0] = e.c, i[n0] = e.v, this.#o = i;
...
const ir = ["constructor", "list", "setCurrent", "setTheme", "setValue"];
class Me {
  static #e = new Te();
  static get list() {
    return Me.#e;
  ...
  static create(e, i) {
    if (!b(e))
      return !1;
    e.id = E(e.name) ? te(e.name) : `${i.id}.theme`;
    const s = new Me(e, i);
  ...
  setCurrent(e = {}) {
    e = b(e) ? e : {};
    const i = de(_r), s = de(e), n = vt(i, s);
    for (let r in n)
      ir.includes(r) || (this[r] = n[r]);
    this.#t.refresh();
  }
  setTheme(e) {
    if (E(e) && Me.list.has(e)) {
  ...
  setProperty(e, i) {
    if (!E(e))
      return;
    const s = Qn(this, e), n = e.split(".");
    if (n.length == 1)
      this[n[0]] = i;
    else {
      let r = n.shift();
      this[r] = Xr(this[r], n.join("."), i);
    }
  ...
  deleteTheme(e) {
    return E(e) && Me.list.has(e) ? (Me.list.delete(e), !0) : !1;
  }
  exportTheme(e = {}) {
    b || (e = {});
    const i = e?.type, s = {};
...
class Le {
  ...
  static create(e, i = "worker", s) {
    ...
    if (_(e))
      ...
      return !1;
    return i = E(i) ? te(i) : te("worker"), Le.#e.set(i, new Le.Thread(i, e, s)), Le.#e.get(i);
  }
  static destroy(e) {
    if (!E(e))
      return !1;
...
class he extends HTMLElement {
  ...
  constructor(e, i = "open") {
    super(), this.template = e, this.shadowRoot = this.attachShadow({ mode: i }), this.#e = new a0();
  }
  destroy() {
  }
  connectedCallback(e) {
  ...
  setDim(e, i) {
    !["width", "height"].includes(i) || !E(e) || (T(e) ? (this.DOM[i] = e, e += "px") : E(e) ? e.match(Dt) || (V = "100%") : (this.DOM[i] = this.parentElement.getBoundingClientRect()[i], e = this.DOM[i] + "px"), this.style[i] = e);
  }
  getDims() {
...
const ss = {
  ...
  guards: {}
}, sr = /^#?([0-9a-f]{3}|[0-9a-f]{6}|[0-9a-f]{8})$/i, nr = /^hsla?((\d{1,3}?),\s*(\d{1,3}%),\s*(\d{1,3}%)(,\s*[01]?\.?\d*)?)$/, rr = /^hsla[(]\s*0*(?:[12]?\d{1,2}|3(?:[0-5]\d|60))\s*(?:\s*,\s*0*(?:\d\d?(?:\.\d+)?\s*%|\.\d+\s*%|100(?:\.0*)?\s*%)){2}\s*,\s*0*(?:\.\d+|1(?:\.0*)?)\s*[)]$/, or = /^rgba?((\d{1,3}%?),\s*(\d{1,3}%?),\s*(\d{1,3}%?)(,\s*[01]?\.?\d*)?)$/, ar = /^^rgba[(](?:\s*0*(?:\d\d?(?:\.\d+)?(?:\s*%)?|\.\d+\s*%|100(?:\.0*)?\s*%|(?:1\d\d|2[0-4]\d|25[0-5])(?:\.\d+)?)\s*,){3}\s*0*(?:\.\d+|1(?:\.0*)?)\s*[)]$/;
class so {
  #e = {
    r: null,
    g: null,
  ...
  constructor(e) {
    this.#t(e), sr.test(e) && this.#n(e), nr.test(e) && this.#r(e), rr.test(e) && this.#i(e), or.test(e) && this.#s(e), ar.test(e) && this.#l(e);
  }
  get value() {
    return this.#e;
  }
  ...
  #t(e) {
    if (ba) {
      ...
      this.#e.isValid = !!(sr.test(e) || nr.test(e) || rr.test(e) || or.test(e) || ar.test(e));
  }
  setHex(e) {
    let i = this.#e;
    [
...
class qs {
  ...
  #d;
  constructor(e) {
    this.#t = qs.#e++, this.#n = e.core, this.#r = k.isElement(e.elContainer) ? e.elContainer : !1, this.#i = k.isElement(e.elHandle) ? e.elHandle : !1, this.#d = _(e.callback) ? e.callback : !1, k.isElement(this.#r) && k.isElement(this.#i) && (this.mount(), this.eventsListen());
  }
  set cursor(e) {
  ...
  eventsListen() {
    this.#h = new Ne(this.#i, { disableContextMenu: !1 }), this.#h.on("mouseenter", He(this.onMouseEnter, 1, this, !0)), this.#h.on("mouseout", He(this.onMouseOut, 1, this, !0)), this.#h.on("drag", Kh(this.onHandleDrag, 100, this)), this.#h.on("enddrag", this.onHandleDragDone.bind(this)), this.#h.on("mousedown", He(this.onMouseDown, 100, this, !0)), this.#h.on("mouseup", this.onMouseUp.bind(this));
  }
  on(e, i, s) {
    this.#n.on(e, i, s);
  }
  ...
  onMouseEnter() {
    ...
    e && (this.colour = new so(e), this.#i.style.backgroundColor = this.colour.hex);
  }
  onMouseOut() {
...
const no = ["source-over", "source-atop", "source-in", "source-out", "destination-over", "destination-atop", "destination-in", "destination-out", "lighter", "copy", "xor", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], ro = typeof OffscreenCanvas < "u";
let oo = class {
  #e = 0;
  constructor(e = {}) {
  ...
  render(e = !1) {
    ...
    i.clear();
    for (n of s)
      e && n.layers.length > 0 && n.render(e), no.includes(n?.composition) && (i.context.globalCompositeOperation = n.composition), n.visible && n.width > 0 && n.height > 0 && i.context.drawImage(
        n.scene.canvas,
        n.x,
        n.y,
        n.width,
...
class c0 {
  ...
  constructor(e = { offscreen: !1 }) {
    ...
    const i = document.createElement("canvas");
    i.className = "scene-canvas", i.style.display = "block", e.width && e.height && this.setSize(e.width, e.height), ro && e?.offscreen ? (this.canvas = i.transferControlToOffscreen(), this.offscreen = !0) : this.canvas = i, this.context = this.canvas.getContext(this.contextType);
  }
  setSize(e, i) {
    return lo(e, i, this);
  }
...
class wt {
  ...
  createViewport(e = [], i = !1) {
    ...
    this.#i = new r({
      ...
      height: n,
      container: this.#c
    }), this.#o = this.#i.scene.canvas, this.#s = new d0(this, e);
  }
  layerConfig() {
...
const y0 = [
  ["labels", { class: p0, fixed: !1, required: !0 }],
  ["overlay", { class: g0, fixed: !1, required: !0 }],
  ["cursor", { class: f0, fixed: !1, required: !0 }]
];
class v0 {
  #e;
  #t = "Timeline";
  ...
  init() {
    const e = this.#i;
    this.#a = e.viewport, this.#h = e.overview, this.#f = e.overview.icons, this.#x = e.overview.scrollBar, this.#w = e.overview.handle, this.#p = e.overview.rwdStart, this.#b = e.overview.fwdEnd;
    const i = {
      core: this.#s,
      elContainer: this.#x,
      elHandle: this.#w,
    ...
    this.#E = new qs(i), this.#s.theme?.time?.navigation === !1 && this.navigationDisplay(!1);
  }
  setWidth(e) {
  ...
  navigationDisplay(e) {
    if (e)
      this.#b.style["margin-top"] = 0, this.#p.style["margin-top"] = 0;
    else {
      const i = this.core.theme.xAxis?.background ? this.core.theme.xAxis.Background : this.core.theme.chart.Background;
      this.#h.style.visibility = "hidden", this.#b.style["margin-top"] = `${this.#a.clientHeight * -1}px`, this.#p.style["margin-top"] = `${this.#a.clientHeight * -1}px`, this.#b.style.background = this.core.theme.chart.Background, this.#p.style.background = i;
    }
  }
  start() {
  ...
  destroy() {
    this.stateMachine.destroy(), this.#S.destroy(), this.#D.destroy(), this.#A.destroy(), this.off("main_mousemove", this.drawCursorTime), this.off("setRange", this.onSetRange), this.#b.removeEventListener("click", He), this.#p.removeEventListener("click", He), this.#d.destroy(), this.element.remove();
  }
  eventsListen() {
    this.#S = new Ne(this.#a, { disableContextMenu: !1 }), this.#S.on("dblclick", this.onDoubleClick.bind(this)), this.#S.on("pointerover", this.onPointerEnter.bind(this)), this.#S.on("pointerout", this.onPointerLeave.bind(this)), this.#S.on("pointerdrag", this.onPointerDrag.bind(this)), this.#D = new Ne(this.#b, { disableContextMenu: !1 }), this.#D.on("pointerover", () => this.showJump(this.#L.end)), this.#D.on("pointerleave", () => this.hideJump(this.#L.end)), this.#A = new Ne(this.#p, { disableContextMenu: !1 }), this.#A.on("pointerover", () => this.showJump(this.#L.start)), this.#A.on("pointerleave", () => this.hideJump(this.#L.start)), this.on("main_mousemove", this.#y.draw, this.#y), this.on("setRange", this.onSetRange, this), this.#b.addEventListener("click", He(this.onMouseClick, 1e3, this, !0)), this.#p.addEventListener("click", He(this.onMouseClick, 1e3, this, !0));
  }
  on(e, i, s) {
    this.#s.on(e, i, s);
  }
  ...
  createGraph() {
    let e = de(y0);
    this.#d = new wt(this, this.#a, e, !1), this.#y = this.graph.overlays.get("cursor").instance, this.#C = this.graph.overlays.get("labels").instance, this.#g = this.graph.overlays.get("overlay").instance, this.graph.addOverlays(this.#m);
  }
  addOverlays(e) {
    if (!isArray(e))
      return !1;
...
const P0 = [
  ["labels", { class: T0, fixed: !0, required: !0 }],
  ["overlay", { class: S0, fixed: !0, required: !0 }],
  ["price", { class: E0, fixed: !0, required: !0 }],
  ["cursor", { class: ho, fixed: !0, required: !0 }]
];
class M0 {
  #e;
  #t = "Y Scale Axis";
  ...
  destroy() {
    this.stateMachine.destroy(), this.#p.destroy(), this.#C.destroy(), this.off(`${this.#s.id}_mousemove`, this.onMouseMove, this), this.off(`${this.#s.id}_mouseout`, this.#f.erase, this.#f), this.off($e, this.onStreamUpdate, this.#v), this.element.remove();
  }
  eventsListen() {
    let e = this.#p.viewport.scene.canvas;
    this.#C = new Ne(e, { disableContextMenu: !1 }), this.#C.setCursor("ns-resize"), this.#C.on("pointerdrag", this.onDrag.bind(this)), this.#C.on("pointerdragend", this.onDragDone.bind(this)), this.#C.on("wheel", this.onMouseWheel.bind(this)), this.#C.on("dblclick", this.resetScaleRange.bind(this)), this.on(`${this.#s.id}_mousemove`, this.onMouseMove, this), this.on(`${this.#s.id}_mouseout`, this.#f.erase, this.#f), this.on($e, this.#v.draw, this.#v), this.on("setRange", this.draw, this);
  }
  on(e, i, s) {
    this.core.on(e, i, s);
  }
  ...
  onMouseMove(e) {
    this.#y = M(e) ? e : [Math.floor(e.position.x), Math.floor(e.position.y)], this.#f.draw(this.#y);
  }
  onDrag(e) {
    this.#y = [
  ...
  setDimensions(e) {
    ...
    this.setHeight(e.h), this.graph instanceof wt && (this.#p.setSize(i, e.h, i), this.draw()), this.#f instanceof ho && this.calcPriceDigits();
  }
  setScaleRange(e = 0) {
  ...
  createGraph() {
    let e = de(P0);
    this.graph = new wt(this, this.#d, e, !1), this.#f = this.graph.overlays.get("cursor").instance, this.#u = this.graph.overlays.get("labels").instance, this.#m = this.graph.overlays.get("overlay").instance, this.#v = this.graph.overlays.get("price").instance, this.graph.addOverlays(this.#w), this.#v.target.moveTop(), this.#f.target.moveTop(), this.calcPriceDigits();
  }
  calcPriceDigits() {
    let e = 8;
    if (this.#r.range.dataLength > 0) {
      const i = this.#r.range.valueMax, s = vs(i);
      s.precision > 4 && console.log(s), e = `${ws(s)}`.length + 2;
    }
...
class L0 extends Y {
  ...
  #t;
  constructor(e, i = !1, s = !1, n, r, a) {
    super(e, i, s, n, r, a), this.#e = new A0(e.scene, n), this.theme.volume.Height = U(n?.volume?.Height, 0, 100) || 100;
  }
  set position(e) {
    this.target.setPosition(e[0], e[1]);
  }
...
class uo extends Y {
  #e;
  constructor(e, i = !1, s = !1, n, r) {
    super(e, i, s, n, r), this.#e = new co(e.scene, n);
  }
  set position(e) {
    this.target.setPosition(e[0], e[1]);
  }
...
class O0 extends Y {
  #e;
  constructor(e, i = !1, s = !1, n, r, a) {
    super(e, i, s, n, r, a), this.#e = new co(e.scene, n), this.theme.priceLineStyle = this.theme?.priceLineStyle || vh;
  }
  set position(e) {
...
class N0 extends Y {
  constructor(e, i = !1, s = !1, n, r, a) {
    super(e, i, s, n, r, a);
    const l = { class: I0, fixed: !0, required: !1 };
...
class k0 extends Y {
  ...
  #n;
  constructor(e, i = !1, s = !1, n, r, a) {
    super(e, i, s, n, r, a), this.#e = new D0(e, n), this.emit(), this.core.on("primary_pointerdown", this.onPrimaryPointerDown, this), this.#n = this.core.WidgetsG.insert("Dialogue", R0), this.#n.start();
  }
  destroy() {
...
class _0 {
  ...
  draw(e) {
    this.data = e;
    const i = this.cfg, s = e.side === "buy" ? this.buy : this.sell, n = e.side === "buy" ? i.iconBuy : i.iconSell, r = this.hit.getIndexValue(e.key), a = k.svgToImage(n, r, this.dims), l = U(e.w, i.iconMinDim, i.iconHeight), h = U(e.w, i.iconMinDim, i.iconWidth), m = this.data.x, g = this.data.y, v = this.ctx, S = this.ctxH;
...
class $0 extends Y {
  ...
  #r;
  constructor(e, i = !1, s = !1, n, r, a) {
    super(e, i, s, n, r, a), this.settings = a.settings, this.#e = new _0(e, n), this.core.on("primary_pointerdown", this.onPrimaryPointerDown, this), this.#r = this.core.WidgetsG.insert("Dialogue", H0), this.#r.start();
  }
  destroy() {
    this.core.off("primary_pointerdown", this.onPrimaryPointerDown, this);
  }
  ...
  isTradeSelected(e) {
    ...
    let S = Object.keys(this.data)[a] * 1, A = this.xAxis.xPos(m) + g, L = r - h * 1.5 - v.height, R = "";
    for (let me of this.data[S])
    ...
    this.core.emit("trade_selected", S), this.#r.open(ne);
  }
  buildTradeHTML(e) {
    let i = `<style>
...
const mo = {
  primaryPane: [
    ...
    ["candles", { class: uo, fixed: !1, required: !0 }],
    ["hiLo", { class: N0, fixed: !0, required: !1 }],
    ["stream", { class: O0, fixed: !1, required: !0 }],
  ...
  primaryPane: {
    trades: { class: $0, fixed: !1, required: !1 },
    events: { class: k0, fixed: !1, required: !1 }
  },
  secondaryPane: {
    candles: { class: uo, fixed: !1, required: !0 }
  }
...
class rt {
  ...
  constructor(e, i) {
    if (this.#s = e, this.#a = rt.cnt, !b(i))
      return;
    this.#l = { ...i }, this.#n = this.#l.name, this.#r = this.#l.shortName, this.#i = this.#l.title, this.#h = this.#l.type == "primary" ? "primaryPane" : "secondaryPane", this.#S = this.#l.view, this.#v = this.#l.elements.elScale, this.#o = this.#l.parent, this.#m = this.#l.elements.elTarget, this.#m.id = this.id, this.legend = new b0(this.elLegend, this), this.isPrimary ? (Ee.type = "chart", Ee.title = this.title, Ee.parent = this, Ee.source = this.legendInputs.bind(this), this.legend.add(Ee), this.yAxisType = "default") : (Ee.type = "secondary", Ee.title = "", Ee.parent = this, Ee.source = () => ({ inputs: {}, colours: [], labels: [] }), this.legend.add(Ee), this.yAxisType = this.core.indicatorClasses[i.view[0].type].ind.scale);
    const s = { ...i };
    s.parent = this, s.chart = this, s.elScale = this.elScale, s.yAxisType = this.yAxisType, this.scale = new M0(this.core, s), this.#d = "init", this.log(`${this.name} instantiated`);
  }
  log(e) {
    this.core.log(e);
  }
  ...
  start() {
    this.#x = this.#s.Timeline, this.createGraph(), this.#f.start(), this.draw(this.range), this.cursor = "crosshair", ns.id = this.id, ns.context = this, this.stateMachine = ns, this.stateMachine.start();
    let e = { chartPane: this };
    this.#b = this.core.WidgetsG.insert("Divider", e), this.#b.start(), e = { title: "Chart Config", content: "config the chart" }, this.#g = this.core.WidgetsG.insert("ConfigDialogue", e), this.#g.start(), this.eventsListen(), this.#d = "running";
  }
  destroy() {
    if (this.#d !== "destroyed") {
      ...
      this.removeAllIndicators(), this.stateMachine.destroy(), this.Divider.destroy(), this.#f.destroy(), this.#w.destroy(), this.#T.destroy(), this.legend.destroy(), this.off("main_mousemove", this.onMouseMove, this), this.off($t, this.onStreamListening, this), this.off(zt, this.onStreamNewValue, this), this.off($e, this.onStreamUpdate, this), this.off(Vt, this.onStreamNewValue, this), this.off(`${this.id}_removeIndicator`, this.onDeleteIndicator, this), this.isPrimary && this.off("chart_yAxisRedraw", this.onYAxisRedraw), this.element.remove(), this.#d = "destroyed";
    }
  }
  remove() {
  ...
  onMouseMove(e) {
    this.core.MainPane.onPointerActive(this), this.scale.layerCursor.visible = !0, this.graph.overlays.list.get("cursor").layer.visible = !0, this.#E = [Math.round(e.position.x), Math.round(e.position.y)], this.#f.onMouseMove(this.#E), this.emit(`${this.id}_mousemove`, this.#E);
  }
  onMouseEnter(e) {
  ...
  onMouseOut(e) {
    this.#N = !1, this.#E = [Math.round(e.position.x), Math.round(e.position.y)], this.scale.layerCursor.visible = !1, this.emit(`${this.id}_mouseout`, this.#E);
  }
  onMouseDown(e) {
  ...
  setHeight(e) {
    T(e) || (e = this.height || this.#o.height), this.#m.style.height = `${e}px`, this.#v.style.height = `${e}px`, this.elViewport.style.height = `${e}px`, this.#f.setDimensions({ w: null, h: e }), this.Divider?.setPos(), this.Divider?.setWidth();
  }
  setDimensions(e) {
  ...
  setYAxisType(e) {
    return !E(e) || !Ze.includes(e) || this.type == "primaryPane" && e == "percent" ? !1 : (this.#R = e, !0);
  }
  addOverlays(e) {
    if (!M(e) || e.length < 1)
      return !1;
    ...
    for (let s of e) {
      ...
      else if (s.type in Ss[this.type])
        n.cnt = 1, n.id = `${this.id}-${s.type}`, n.class = Ss[this.type][s.type].class;
...
class U0 extends Y {
  ...
  renderImage(e) {
    ...
    a.save(), Yr(a, e, n, r, i, s), a.restore();
  }
}
const rs = {
  id: "main",
  ...
  ["watermark", { class: U0, fixed: !0, required: !0, params: { content: null } }],
  ["grid", { class: Ii, fixed: !1, required: !0, params: { axes: "x" } }]
], V0 = ["candles", "trades", "events"];
class po {
  #e = "MainPane";
  #t = "Main";
  #n;
  ...
  init(e) {
    if (this.#i, this.#I = this.#i.indicatorClasses, this.#a = this.#c.rows, this.#h = this.#c.time, this.#v = this.#c.rows.grid, this.#x = this.#c.viewport, this.#u = this.#i.elBody.scale, e.name = "Chart", e.shortName = "Chart", e.parent = this, e.chartData = this.#i.allData.data, e.primaryPane = this.#i.allData.primaryPane, e.secondaryPane = this.#i.allData.secondaryPane, e.rangeLimit = this.#i.rangeLimit, e.settings = this.#i.settings, e.elements = { ...e.elements, ...this.elements }, this.#i.theme?.time?.navigation === !1) {
      const i = { height: _s };
      this.#i.theme.time = { ...this.#i.theme?.time, ...i }, this.#a.style.height = "1fr";
    }
    this.#S = new v0(this.#i, e), this.registerChartViews(e), this.#P = T(this.config.buffer) ? this.config.buffer : _i, this.#N = T(this.config.rowMinH) ? this.config.rowMinH : Gn, this.#E = T(this.config.secondaryPaneDefaultH) ? this.config.secondaryPaneDefaultH : Yn, this.rowsOldH = this.#a.height, this.log(`${this.#e} instantiated`);
  }
  start() {
    let e = 0;
    const i = this.#M;
    i.instance = null, i.rowsH = this.#a.height, this.#x.style.width = `${this.#a.width}px`, this.#c.start(this.theme), this.#S.start(), this.createGraph();
    const s = this.chart.scale.calcScaleWidth();
    this.core.elBody.scale.style.width = `${s}px`, this.#g.forEach((n, r) => {
      n.start(e++), e === 1 && n.Divider.hide(), i.panes[r] = n.element.clientHeight;
    }), this.rowsOldH = this.#a.height, this.draw(this.range, !0), this.renderLoop.init({
      graphs: [this.#p],
      range: this.range
  ...
  destroy() {
    this.#l = !0, this.stateMachine.destroy(), this.#S.destroy(), this.#g.forEach((e, i) => {
  ...
  onSetRange() {
    this.#H = this.#_, this.#_ = this.chart.scale.calcScaleWidth(), this.#H < this.#_ && this.setScaleWidth(), this.draw();
  }
  onMouseWheel(e) {
    ...
    const s = this.range, n = s.indexStart - Math.floor(i * $n * s.Length), r = s.indexEnd + Math.ceil(i * $n * s.Length);
  ...
  onChartDrag(e) {
    const i = this.#R;
    i.active ? (i.delta = [e.position.x - i.prev[0], e.position.y - i.prev[1]], i.prev = [e.position.x, e.position.y]) : (i.active = !0, i.start = [e.dragstart.x, e.dragstart.y], i.prev = i.start, i.delta = [0, 0]), this.#T = [e.position.x, e.position.y, ...i.start, ...i.delta], this.emit("chart_pan", this.#T);
  }
  onChartDragDone(e) {
    const i = this.#R;
    i.active = !1, i.delta = [0, 0], this.#T = [...i.prev, ...i.start, ...i.delta], this.emit("chart_panDone", this.#T);
  }
  onChartKeyDown(e) {
  ...
  setDimensions() {
    ...
    if (this.#i.scrollPos = -1, this.#S.setDimensions({ w: s }), this.#p.setSize(s, n, r), this.#x.style.width = `${s}px`, this.#g.size == 1 && i != n)
      ...
      }), g < this.rowsH && (h = Math.round((this.rowsH - g) / this.#g.size));
      for (let v of l)
  ...
  setScaleWidth(e) {
    this.core.elBody.scale.style.width = `${this.#_}px`, this.#x.style.width = `${this.#_}px`;
    let i = this.#a.width, s = this.#a.height, n = Math.round(i * ((100 + this.#P) * 0.01));
    this.#S.setDimensions({ w: i }), this.#p.setSize(i, s, n), this.#x.style.width = `${i}px`, this.#g.forEach((r, a) => {
      r.setDimensions({ w: i, h: r.height });
    });
  }
  getBufferPx() {
  ...
  addChartPane(e) {
    ...
    let h;
    return e.type == "primary" ? (h = new rt(this.#i, e), this.#y = h) : (e.name = e.view[0].name || "Secondary", e.shortName = e.view[0].type || "Secondary", h = new rt(this.#i, e)), this.setPaneDividers(), this.#g.set(h.id, h), this.emit("addChartView", h), h;
  }
  removeChartPane(e) {
    if (!E(e) || !this.#g.has(e))
      return !1;
    ...
    if (i.status !== "destroyed" && i.destroy(), this.#g.delete(e), delete this.#A[e], this.#g.size === 1) {
  ...
  validateIndicators() {
    ...
    for (let [i, s] of this.views) {
      ...
      for (const [n, r] of s.entries())
        b(r) && (r.type in this.core.indicatorClasses || V0.includes(r.type)) || (this.#i.log(`indicator ${s.type} not added: not supported.`), s.splice(n, 1));
    }
    return e;
  }
  addIndicator(e, i = e, s = {}) {
    if (!E(e) && !(e in this.#I) && !E(i) && !b(s))
      return !1;
    ...
    if (this.#I[e].ind.primaryPane) {
      ...
      for (let a = 0; a < s.view.length; a++)
        (!b(s.view[a]) || !Kr(["name", "type"], Object.keys(s.view[a]))) && s.view.splice(a, 1);
      if (s.view.length == 0)
        return !1;
  ...
  calcChartPaneHeights() {
    const { collapsed: e, expanded: i } = this.chartPanesState(), s = this.#g.size + 1;
    this.#E * (s - 1);
    const n = this.#a.height, r = {};
    if (s === 1)
      r.new = n;
    else if (s === 2 || i.length === 1) {
      const a = n, l = Math.round(a * this.#E / 100);
      r[i[0].id] = a - l, r.new = l;
    } else if (i.length === 2) {
      const a = i[0].viewport.height, l = i[1].viewport.height, h = a + l, m = Math.round(h * this.#E / 100), g = h / (h + m);
  ...
  createGraph() {
    let e = de(B0);
    this.#p = new wt(this, this.#x, e);
  }
  draw(e = this.range, i = !1) {
    this.time.xAxis.doCalcXAxisGrads(e);
    const s = [this.#p, this.#S];
    this.#g.forEach((n, r) => {
      s.push(n);
  ...
  paneCollapse(e) {
    ...
    if (a = g.indexOf(e), a > -1 && g.splice(a, 1), a = v.indexOf(e), a > -1 && v.splice(a, 1), e.collapsed.state) {
      ...
      for (let S of v)
        h = S.element.height - l, S.setDimensions({ w: void 0, h });
      e.collapse(r);
    } else {
      ...
      for (let S of v)
        h = S.element.height + r, S.setDimensions({ w: void 0, h });
      e.collapse();
    }
...
class Oe extends Y {
  ...
  #b = { TL: [0, 0], BR: [0, 0] };
  constructor(e, i = !1, s = !1, n, r, a) {
    super(e, i, s, n, r, a), this.#o = config, this.#r = config.cnt, this.#n = this.#o.ID || te("TX_Tool_"), this.#i = config.name, this.#c = config.core, this.#d = config.elements.elChart, this.#a = { ...config.parent }, this.#f = config.target, this.#f.addTool(this), this.#m = this.#v.viewport, this.#u = this.#m.scene.canvas, this.#p = config.pos;
  }
  set id(e) {
    this.#n = Be(e);
  }
...
class go {
  ...
  #v = [];
  constructor(e, i) {
    this.#r = e, this.#i = i, this.#l = e.elTools, this.#a = Y0 || e.config.tools, this.#o = e.WidgetsG, this.init();
  }
  log(e) {
    this.#r.log(e);
  }
...
const cr = 20, q0 = 20, X0 = new so(B.COLOUR_BORDER), Es = document.createElement("template");
Es.innerHTML = `
<style>
  .scrollBarWidget {
    display: flex;
  ...
  .handle {
    background-color: var(--txc-time-handle-color, ${X0.hex}44); 
    width: 2px;
    height: 18px;
    margin: 1px;
...
<div class="scrollBarWidget">
  <span id="rwdStart" class="icon rwdStart">${eh}</span>
  ...
  <span id="fwdEnd" class="icon fwdEnd">${Ql}</span>
</div>
`;
class K0 extends he {
  #e;
...
customElements.get("tradex-overview") || window.customElements.define("tradex-overview", K0);
...
customElements.get("tradex-viewport") || window.customElements.define("tradex-viewport", Z0);
...
customElements.get("tradex-grid") || window.customElements.define("tradex-grid", J0);
...
<div class="legends">
  ...
  <div class="controls collapse restored">
    <span id="hideLegends" class="control" data-icon="hide" style="display:none">${Wl}</span>
    <span id="showLegends" class="control" data-icon="show" style="display:none">${Fl}</span>
  </div>
</div>
`;
class Q0 extends he {
  ...
  buildControls(e) {
    let i = "", s = e.id;
    return i += `<span id="${s}_up" class="control up" data-icon="up">${Gl}</span>`, i += `<span id="${s}_down" class="control down" data-icon="down">${Yl}</span>`, e?.type === "indicator" && (i += `<span id="${s}_visible" class="control visible" data-icon="visible">${Zl}</span>`, i += `<span id="${s}_notVisible" class="control notvisible" data-icon="notVisible">${Jl}</span>`), e?.type !== "indicator" && (i += `<span id="${s}_collapse" class="control collapse" data-icon="collapse">${Kl}</span>`, i += `<span id="${s}_expand" class="control expand" data-icon="expand">${jl}</span>`, i += `<span id="${s}_maximize" class="control maximize" data-icon="maximize">${Xl}</span>`, i += `<span id="${s}_restore" class="control restore" data-icon="restore">${ql}</span>`), i += e?.type !== "chart" ? `<span id="${s}_remove" class="control remove" data-icon="remove">${zl}</span>` : "", i += e?.type !== "secondary" ? `<span id="${s}_config" class="control config" data-icon="config">${Or}</span>` : "", i;
  }
}
customElements.get("tradex-legends") || window.customElements.define("tradex-legends", Q0);
...
customElements.get("tradex-chartpane") || window.customElements.define("tradex-chartpane", em);
...
customElements.get("tradex-rows") || window.customElements.define("tradex-rows", tm);
...
customElements.get("tradex-main") || window.customElements.define("tradex-main", im);
...
customElements.get("tradex-tools") || window.customElements.define("tradex-tools", sm);
...
customElements.get("tradex-scale") || window.customElements.define("tradex-scale", nm);
const rm = `
  tradex-main {
    flex-grow: 1;
    order: 2;
...
`, Eo = document.createElement("template"), om = rm, am = `
<style>
  :host {
    display: flex;
...
class dm extends he {
  ...
  connectedCallback() {
    if (this.doInit) {
      this.doInit = !1, this.shadowRoot.appendChild(this.#r.content.cloneNode(!0)), this.style.display = "block", this.style.minHeight = Nr, this.#n = this.shadowRoot.querySelector("tradex-widgets"), this.#t = this.shadowRoot.querySelector("tradex-utils"), this.#e = this.shadowRoot.querySelector("tradex-body"), this.#s = this.parentElement.clientHeight || Fe, this.#i = this.parentElement.clientWidth || Bt;
  ...
  onResized(e) {
    super.onResize(e);
    const i = Lr.includes(this.theme?.utils?.location) ? _e : 0, { width: s, height: n } = e[0].contentRect;
    this.#i = Math.floor(s), this.#s = Math.floor(n), this.#d = e[0], this.elBody.style.height = `calc(100% - ${i}px)`, this.MainPane instanceof po, this.ToolsBar instanceof go && this.ToolsBar.onResized(), this.log(`onResize w: ${this.#i}}, h: ${this.#s}`), this.emit("global_resize", { w: this.#i, h: this.#s });
  }
  setWidth(e) {
    T(e) ? e += "px" : E(e) && e.match(Dt) || (e = "100%"), this.style.width = e, this.#i = Math.round(this.getBoundingClientRect().width);
  }
  setHeight(e) {
    T(e) ? e += "px" : E(e) && e.match(Dt) || (e = "100%"), this.style.height = e, this.#s = Math.round(this.getBoundingClientRect().height);
  }
  setWidthMin(e) {
  ...
  setDimensions(e, i) {
    ...
    if (!e || !i) {
      ...
      (!T(e) || !T(i)) && ((!E(e) || !e.match(Dt)) && (e = "100%"), (!E(i) || !i.match(Dt)) && (i = "100%"));
...
class pm {
  ...
  #u = {};
  constructor(e, i) {
    this.#n = e, this.#r = i, this.#i = e.elUtils, this.#s = e.config?.utilsBar || mm, this.#o = e.WidgetsG, this.#c = e.indicatorClasses || io, this.#l = e.config.theme?.utils?.location || "none", (this.#l || this.#l == "none" || !Lr.includes(this.#l)) && (this.#i.style.height = 0, this.core.elBody.style.height = "100%"), this.#i.innerHTML = this.#i.defaultNode(this.#s), this.log(`${this.#e} instantiated`);
  }
  log(e) {
    this.#n.log(e);
  }
  ...
  destroy() {
    const e = this.#n, i = k.findBySelectorAll(`#${e.id} .${ca} .icon-wrapper`);
    for (let s of i) {
...
class le {
  ...
  windowNode() {
    ...
    return `
      <div id="${e.id}" class="${da} ${this.#r.class}" style="${i}">
          ${n}
          ${r}
          ${l}
          ${a}
...
class Pe {
  ...
  mount(e) {
    ...
    e.lastElementChild == null ? e.innerHTML = this.progressNode(s) : e.lastElementChild.insertAdjacentHTML("afterend", this.progressNode(s)), this.#l = this.#s.querySelector(`#${this.#r.id}`), this.#o = this.#l.querySelector("svg"), this.#o.style.fill = `${yh.COLOUR_ICONHOVER};`;
  }
}
const as = {
  id: "widgets",
...
class ym {
  ...
  #s;
  #l;
  #o = { Divider: ce, Progress: Pe, Menu: we, Window: le, Dialogue: Ui, ConfigDialogue: fm };
  #c = {};
  #a = {};
  #h;
  #d;
...
function ur(o, e, i, s, n, r) {
  const a = o.theme, l = document.createElement("template"), h = o.Timeline.graph.viewport.scene, m = o.MainPane, g = m.graph.viewport.scene, v = m.width, S = m.height, A = new Xt.Viewport({
    width: v,
    height: S,
    container: l
  }), L = A.scene.context;
  ...
  let H;
  L.save(), Vs(L, 0, 0, v, S, { fill: a.chart.Background }), L.drawImage(g.canvas, ne, 0, g.width, g.height);
  ...
  const I = (D) => {
    if (D) {
      const j = r?.x || 0, oe = r?.y || 0, pe = r?.width || v * 0.25, ge = r?.height || S * 0.25;
...
class N extends dm {
  ...
  constructor() {
    super(), this.#b = N.cnt(), console.warn(`!WARNING!: ${Nt} changes to config format, for details please refer to https://github.com/tradex-app/TradeX-chart/blob/master/docs/notices.md`), this.log(`${Ht} instance count: ${this.inCnt}`), this.oncontextmenu = window.oncontextmenu, this.#z = Le;
    const e = this.#D;
    e.primaryPane = { ...e.primaryPane, ...mo.primaryPane }, this.#A = { ...Ss };
  }
  log(...e) {
  ...
  get rangeLimit() {
    return T(this.#y.initialCnt) ? this.#y.initialCnt : ma;
  }
  get range() {
    return this.#y;
  }
  ...
  start(e) {
    ...
    const i = { ...e };
    this.logs = i?.logs ? i.logs : !1, this.infos = i?.infos ? i.infos : !1, this.warnings = i?.warnings ? i.warnings : !1, this.errors = i?.errors ? i.errors : !1, this.timer = i?.timer ? i.timer : !1, this.#f = i, this.#b = i.cnt || this.#b, this.#E = i.talib, this.#w = this, this.#v = this, "theme" in i || (i.theme = _r);
    ...
    this.#g = this.#C.create(n, r, a), delete i.state, this.log(`${this.name} id: ${this.id} : created with a ${this.state.status} state`);
    let l = "1s", h = G;
    if (!b(i?.stream) && this.state.data.chart.data.length < 2 ? (this.warn(`${Nt} has no chart data or streaming provided.`), { tf: l, ms: h } = gi(i?.timeFrame)) : b(i?.stream) && this.state.data.chart.data.length < 2 ? ({ tf: l, ms: h } = gi(i?.timeFrame), this.#U = !0) : (l = this.state.data.chart.tf, h = this.state.data.chart.tfms), this.log(`tf: ${l} ms: ${h}`), this.#f.callbacks = this.#f.callbacks || {}, b(i))
      for (const g in i)
    ...
    if (m.interval = h, m.core = this, this.getRange(null, null, m), this.#y.Length > 1) {
      const g = Cs(this.#k, this.#f?.range?.startTS), v = T(g) ? g + this.#y.initialCnt : this.allData.data.length, S = T(g) ? g : v - this.#y.initialCnt;
      this.#y.initialCnt = v - S, this.setRange(S, v), i.range?.center && this.jumpToIndex(S, !0, !0);
    }
    this.insertAdjacentHTML("beforebegin", `<style title="${this.id}_style"></style>`), this.#I = new ym(this, { widgets: i?.widgets }), this.#T = new pm(this, i), this.#R = new go(this, i), this.#P = new po(this, i), this.setTheme(this.#L.id), this.log(`${this.#u} V${N.version} configured and running...`), this.#O = this.bufferPx * -1, this.eventsListen(), this.elStart(this.theme), this.elBody.start(this.theme), this.UtilsBar.start(), this.ToolsBar.start(), this.MainPane.start(), this.WidgetsG.start(), this.#V = this.WidgetsG.insert("Progress", {}), this.stream = this.#f.stream, this.#U && this.on($e, this.delayedSetRange, this), this.#p = !0, this.refresh();
  }
  destroy() {
    if (this?.destuction !== !0)
      return N.destroy(this), !0;
    this.log("...cleanup the mess"), this.removeEventListener("mousemove", this.onMouseMove), this.UtilsBar.destroy(), this.ToolsBar.destroy(), this.MainPane.destroy(), this.WidgetsG.destroy(), this.#z.end(), this.#C = null;
  }
  eventsListen() {
    this.addEventListener("mousemove", this.onMouseMove.bind(this)), this.on($e, this.onStreamUpdate, this), this.on("state_mergeComplete", () => this.#V.stop());
  }
  onMouseMove(e) {
  ...
  setID(e) {
    E(e) ? this.id = e : this.id = `${te(Ht)}_${this.#b}`;
  }
  setTitle(e) {
  ...
  setPricePrecision(e) {
    (!T(e) || e < 0) && (e = wa), this.#F = e;
  }
  setVolumePrecision(e) {
    (!T(e) || e < 0) && (e = xa), this.#G = e;
  }
  addTheme(e) {
  ...
  setState(e) {
    ...
    if (e === this.key)
      return !0;
    this.stream.stop(), this.MainPane.reset(), this.#g = $.get(e);
    const i = {
      interval: this.#g.data.chart.tfms,
      core: this
    };
    if (this.getRange(null, null, i), this.range.Length > 1) {
      const s = Cs(this.time, void 0), n = s ? s + this.range.initialCnt : this.#g.data.chart.data.length - 1, r = s || n - this.range.initialCnt;
  ...
  setStream(e) {
    ...
    if (b(e))
      return this.allData.data.length == 0 && E(e.timeFrame) && ({ tf, ms } = gi(e?.timeFrame), this.range.interval = ms, this.range.intervalStr = tf, this.#k.timeFrameMS = ms, this.#k.timeFrame = tf), this.#$ = new pt(this), this.#f.stream = this.#$.config, this.#$;
  }
  stopStream() {
  ...
  delayedSetRange() {
    for (; this.#U; ) {
      ...
      this.setRange(e * -1, e), this.off($e, this.delayedSetRange), this.#U = !1;
    }
  }
  updateRange(e) {
    if (!M(e) || !T(e[4]) || e[4] == 0)
  ...
  getRange(e = 0, i = 0, s = {}) {
    this.#y = new xs(e, i, s), this.#k.range = this.#y, this.#k.timeFrameMS = this.#y.interval, this.#k.timeFrame = this.#y.intervalStr;
  }
  ...
  isOverlay(e) {
    return Cn(e) && _(e.prototype?.draw) && !this.isIndicator(e) && Object.getPrototypeOf(e.prototype).constructor.isOverlay;
  }
  hasOverlay(e) {
  ...
  isIndicator(e) {
    return Cn(e) && _(e.prototype?.draw) && "primaryPane" in e.prototype && Object.getPrototypeOf(e.prototype).constructor.name === "Indicator";
  }
  setIndicators(e, i = !1) {
    if (!b(e))
      return !1;
    i && (console.warn("Expunging all default indicators!"), this.#S = {});
    const s = {};
    for (const [n, r] of Object.entries(e))
      E(r?.id) && E(r?.name) && E(r?.event) && this.isIndicator(r?.ind) ? (this.#S[n] = r, s[n] = !0, this.log(`Custom Indicator: ${n} - Registered`)) : (s[n] = !1, this.warn(`Custom Indicator: ${n} - Rejected: Not a valid indicator`));
    return s;
  }
  addIndicator(e, i = e, s = {}) {
...
window.customElements.get("tradex-chart") || (document.head.insertAdjacentHTML("beforeend", xh), document.head.insertAdjacentHTML("beforeend", bh), customElements.get("tradex-chart") || customElements.define("tradex-chart", N));
export {
  N as Chart,
  k as DOM,
  a0 as EventHub,
