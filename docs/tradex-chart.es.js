...
function ws(o) {
  ...
  return e = e ? 0 : 1, e > 0 && (a += "-", l++), i == 0 ? (a += "0", l++) : (a += r.slice(l, i), l += i), s != 0 && (a += `${r.slice(l)}`, i <= 2 ? h = s : i > 3 ? h = 2 : i > 2 && (h = 4)), a = Number.parseFloat(a).toFixed(h), a;
}
function Sh(o) {
