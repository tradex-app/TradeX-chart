...
var __INIT__ = (function () {
  ...
  return function (__INIT__) {
    ...
    function getBinaryPromise() {
      return Promise.resolve(base64ToUint8Array(wasmBase64));
    }
    function createWasm() {
      var info = {
        env: asmLibraryArg,
  ...
  return WebAssembly.instantiate(wasmBinary, {})
    ...
    .catch((e) => {
      ...
      if (e && e.message) {
        ...
        message += 'Unknown reason. Could not initialize the Wasm binary.';
      }
