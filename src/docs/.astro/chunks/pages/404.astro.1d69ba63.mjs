...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/docs/api/core-old.md": () => import('../core-old.afc74921.mjs'),"/src/content/docs/api/core.md": () => import('../core.01a17d1c.mjs'),"/src/content/docs/api/core2.md": () => import('../core2.3ef7123e.mjs'),"/src/content/docs/documentation.mdx": () => import('../documentation.eef1ee9a.mjs'),"/src/content/docs/examples/01_static_chart.mdx": () => import('../01_static_chart.17305947.mjs'),"/src/content/docs/examples/02_live_history_chart.mdx": () => import('../02_live_history_chart.53aecbf3.mjs'),"/src/content/docs/examples/custom_indicator.mdx": () => import('../custom_indicator.b7590cf8.mjs'),"/src/content/docs/examples/static_chart.mdx": () => import('../static_chart.ea791fd1.mjs'),"/src/content/docs/guides/custom_indicator.mdx": () => import('../custom_indicator.4fba9709.mjs'),"/src/content/docs/guides/howto.md": () => import('../howto.9b087913.mjs'),"/src/content/docs/guides/test.md": () => import('../test.094dd409.mjs'),"/src/content/docs/index.mdx": () => import('../index.714428f7.mjs'),"/src/content/docs/reference/01_getting_started.md": () => import('../01_getting_started.31d843f1.mjs'),"/src/content/docs/reference/02_configuration.md": () => import('../02_configuration.8777c64c.mjs'),"/src/content/docs/reference/annotations.md": () => import('../annotations.7f2ad58c.mjs'),"/src/content/docs/reference/api-examples.md": () => import('../api-examples.9c9a385e.mjs'),"/src/content/docs/reference/architecture.md": () => import('../architecture.3ca0fe9c.mjs'),"/src/content/docs/reference/canvas_extension_layers.md": () => import('../canvas_extension_layers.cb30ff93.mjs'),"/src/content/docs/reference/canvas_methods.md": () => import('../canvas_methods.0ac78eaa.mjs'),"/src/content/docs/reference/events.md": () => import('../events.d41926db.mjs'),"/src/content/docs/reference/example.md": () => import('../example.198b71eb.mjs'),"/src/content/docs/reference/hit_detection.md": () => import('../hit_detection.fc2f4b45.mjs'),"/src/content/docs/reference/index.md": () => import('../index.5bb1feee.mjs'),"/src/content/docs/reference/indicators.md": () => import('../indicators.fd68bb6f.mjs'),"/src/content/docs/reference/indicators_custom.md": () => import('../indicators_custom.3d6da7e6.mjs'),"/src/content/docs/reference/indicators_default.md": () => import('../indicators_default.f379c2e3.mjs'),"/src/content/docs/reference/indicators_talib.md": () => import('../indicators_talib.46cbb55f.mjs'),"/src/content/docs/reference/legends.md": () => import('../legends.30a4ffe1.mjs'),"/src/content/docs/reference/overlays.md": () => import('../overlays.2cd7e87a.mjs'),"/src/content/docs/reference/overlays_news_events.md": () => import('../overlays_news_events.713a929d.mjs'),"/src/content/docs/reference/overlays_trades.md": () => import('../overlays_trades.89828ecf.mjs'),"/src/content/docs/reference/range.md": () => import('../range.bf8ff8b5.mjs'),"/src/content/docs/reference/state.md": () => import('../state.a64fac87.mjs'),"/src/content/docs/reference/state_machine.md": () => import('../state_machine.a05833e9.mjs'),"/src/content/docs/reference/streaming_price_data.md": () => import('../streaming_price_data.9549edea.mjs'),"/src/content/docs/reference/themes.md": () => import('../themes.e0def88e.mjs'),"/src/content/docs/reference/web_workers.md": () => import('../web_workers.6cb28e35.mjs'),"/src/content/docs/reference/widgets.md": () => import('../widgets.a737891b.mjs')
...
const $$Astro$w = createAstro("https://tradex-app.github.io/");
...
const base = stripTrailingSlash("/TradeX-chart/");
...
const $$Astro$v = createAstro("https://tradex-app.github.io/");
...
const $$Astro$u = createAstro("https://tradex-app.github.io/");
...
const $$Astro$t = createAstro("https://tradex-app.github.io/");
...
const $$Astro$s = createAstro("https://tradex-app.github.io/");
...
const $$Astro$r = createAstro("https://tradex-app.github.io/");
...
const $$Astro$q = createAstro("https://tradex-app.github.io/");
...
const $$Astro$p = createAstro("https://tradex-app.github.io/");
...
function localizedUrl(url, locale) {
  ...
  if (locale === "root")
    locale = "";
  const base = "/TradeX-chart/".replace(/\/$/, "");
...
const $$Astro$o = createAstro("https://tradex-app.github.io/");
...
const $$Astro$n = createAstro("https://tradex-app.github.io/");
...
const $$Astro$m = createAstro("https://tradex-app.github.io/");
...
const $$Astro$l = createAstro("https://tradex-app.github.io/");
...
const src = {"src":"/TradeX-chart/_astro/tx.82979636.svg","width":48,"height":48,"format":"svg"};

const logos = { dark: src, light: src };

const $$Astro$k = createAstro("https://tradex-app.github.io/");
...
const $$Astro$j = createAstro("https://tradex-app.github.io/");
...
var _a$1;
const $$Astro$i = createAstro("https://tradex-app.github.io/");
...
const $$Astro$h = createAstro("https://tradex-app.github.io/");
...
const $$Astro$g = createAstro("https://tradex-app.github.io/");
...
const $$Astro$f = createAstro("https://tradex-app.github.io/");
...
const $$Astro$e = createAstro("https://tradex-app.github.io/");
...
const $$Astro$d = createAstro("https://tradex-app.github.io/");
...
const $$Astro$c = createAstro("https://tradex-app.github.io/");
...
const $$Astro$b = createAstro("https://tradex-app.github.io/");
...
const $$Astro$a = createAstro("https://tradex-app.github.io/");
...
const $$Astro$9 = createAstro("https://tradex-app.github.io/");
...
const $$Astro$8 = createAstro("https://tradex-app.github.io/");
...
const $$Astro$7 = createAstro("https://tradex-app.github.io/");
...
const $$Astro$6 = createAstro("https://tradex-app.github.io/");
...
var _a;
const $$Astro$5 = createAstro("https://tradex-app.github.io/");
...
const $$Astro$4 = createAstro("https://tradex-app.github.io/");
