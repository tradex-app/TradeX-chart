...
const images = {
					'../../../assets/notes-01.png': await getImageSafely((await import('./notes-01.58167416.mjs')).default, "../../../assets/notes-01.png", "/src/assets/notes-01.png"),'../../../assets/notes-02.png': await getImageSafely((await import('./notes-02.ff22b86a.mjs')).default, "../../../assets/notes-02.png", "/src/assets/notes-02.png")
				};
