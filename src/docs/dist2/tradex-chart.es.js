...
const qt = "TradeX-Chart", Jt = "TX", Jl = "tradeXutils", hr = "tradeXmenus", eh = "tradeXmenu", cr = "tradeXdividers", ur = "tradeXwindows", th = "tradeXwindow", dr = "tradeXprogress", ih = 500, sh = "stream_None", Ii = "stream_Listening", mr = "stream_Started", nh = "stream_Stopped", rh = "stream_Error", an = "stream_candleFirst", st = "stream_candleUpdate", on = "stream_candleNew", ah = 250, oh = 8, lh = 2, hh = 2, oa = 18, ni = 100, Kt = /^(\d*\.?\d+)\s?(px|em|ex|%|in|cn|mm|pt|pc+)$/igm;
function A(a) {
...
function ve(a) {
  ...
  let r = n.right - n.left, o = n.bottom - n.top, l = ft(a), c = ln(a);
  return {
    top: i,
    bottom: i + o,
    left: e,
...
function xh(a) {
  if (!z(a)) return !1;
  const e = (s) => {
    !a.contains(s.target) && ft(a) && (a.style.display = "none", i());
  }, i = () => {
...
function dn(a, e) {
  return !z(a) || !T(e) ? null : a.classList.contains(e) ? a : dn(a.parentElement, e);
}
function xa(a, e) {
...
`;
      return function() {
        ...
        return $ && $.call(e.console, b, L), u.apply(this, arguments);
      };
    }
    var k;
    ...
    var Z = D(function(m, g, b) {
      for (var E = Object.keys(g), L = 0; L < E.length; )
        (!b || b && m[E[L]] === n) && (m[E[L]] = g[E[L]]), L++;
      return m;
    }, "extend", "Use `assign`."), he = D(function(m, g) {
      return Z(m, g, !0);
    }, "merge", "Use `assign`.");
    function F(u, m, g) {
      var b = m.prototype, E;
      E = u.prototype = Object.create(b), E.constructor = u, E._super = b, g && k(E, g);
    }
    function ne(u, m) {
      return function() {
    ...
    function Un(u, m, g) {
      for (var b = [], E = [], L = 0; L < u.length; ) {
        var $ = u[L][m];
        Xe(E, $) < 0 && b.push(u[L]), E[L] = $, L++;
      }
      return b = b.sort(function(le, ge) {
        return le[m] > ge[m];
      }), b;
    }
    function gi(u, m) {
    ...
    var bl = /mobile|tablet|ip(ad|hone|od)|android/i, zn = "ontouchstart" in e, wl = gi(e, "PointerEvent") !== n, xl = zn && bl.test(navigator.userAgent), Ht = "touch", Cl = "pen", us = "mouse", Tl = "kinect", El = 25, fe = 1, rt = 2, Q = 4, we = 8, yi = 1, Bt = 2, Ft = 4, Ut = 8, Vt = 16, He = Bt | Ft, at = Ut | Vt, Wn = He | at, Gn = ["x", "y"], vi = ["clientX", "clientY"];
    function Me(u, m) {
      var g = this;
      this.manager = u, this.callback = m, this.element = u.element, this.target = u.options.inputTarget, this.domHandler = function(b) {
        O(u.options.enable, [u]) && g.handler(b);
      }, this.init();
    }
    Me.prototype = {
      handler: function() {
      ...
      init: function() {
        this.evEl && oe(this.element, this.evEl, this.domHandler), this.evTarget && oe(this.target, this.evTarget, this.domHandler), this.evWin && oe(Vn(this.element), this.evWin, this.domHandler);
      },
      destroy: function() {
    ...
    function Pl(u, m, g) {
      var b = g.pointers.length, E = g.changedPointers.length, L = m & fe && b - E === 0, $ = m & (Q | we) && b - E === 0;
    ...
    function Ml(u, m) {
      ...
      var L = g.firstInput, $ = g.firstMultiple, re = $ ? $.center : L.center, le = m.center = Xn(b);
      m.timeStamp = f(), m.deltaTime = m.timeStamp - L.timeStamp, m.angle = ds(re, le), m.distance = bi(re, le), Al(g, m), m.offsetDirection = jn(m.deltaX, m.deltaY);
      var ge = Yn(m.deltaTime, m.deltaX, m.deltaY);
      m.overallVelocityX = ge.x, m.overallVelocityY = ge.y, m.overallVelocity = p(ge.x) > p(ge.y) ? ge.x : ge.y, m.scale = $ ? Dl($.pointers, b) : 1, m.rotation = $ ? Ol($.pointers, b) : 0, m.maxPointers = g.prevInput ? m.pointers.length > g.prevInput.maxPointers ? m.pointers.length : g.prevInput.maxPointers : m.pointers.length, Ll(g, m);
      var Fe = u.element;
    ...
    function Ll(u, m) {
      var g = u.lastInterval || m, b = m.timeStamp - g.timeStamp, E, L, $, re;
      if (m.eventType != we && (b > El || g.velocity === n)) {
        var le = m.deltaX - g.deltaX, ge = m.deltaY - g.deltaY, Fe = Yn(b, le, ge);
        L = Fe.x, $ = Fe.y, E = p(Fe.x) > p(Fe.y) ? Fe.x : Fe.y, re = jn(le, ge), u.lastInterval = m;
      } else
    ...
    function wi() {
      this.evEl = Il, this.evWin = Rl, this.pressed = !1, Me.apply(this, arguments);
    }
    F(wi, Me, {
      handler: function(m) {
        var g = Nl[m.type];
    ...
    function ms() {
      this.evEl = Kn, this.evWin = Zn, Me.apply(this, arguments), this.store = this.manager.session.pointerEvents = [];
    }
    F(ms, Me, {
      handler: function(m) {
        var g = this.store, b = !1, E = m.type.toLowerCase().replace("ms", ""), L = kl[E], $ = $l[m.pointerType] || m.pointerType, re = $ == Ht, le = Xe(g, m.pointerId, "pointerId");
        L & fe && (m.button === 0 || re) ? le < 0 && (g.push(m), le = g.length - 1) : L & (Q | we) && (b = !0), !(le < 0) && (g[le] = m, this.callback(this.manager, L, {
          pointers: g,
          changedPointers: [m],
          pointerType: $,
          srcEvent: m
    ...
    function Qn() {
      this.evTarget = Hl, this.evWin = Bl, this.started = !1, Me.apply(this, arguments);
    }
    F(Qn, Me, {
      handler: function(m) {
        var g = _l[m.type];
    ...
    function xi() {
      this.evTarget = Vl, this.targetIds = {}, Me.apply(this, arguments);
    }
    F(xi, Me, {
      handler: function(m) {
    ...
    function zl(u, m) {
      ...
      for (E = 0; E < $.length; )
        b[$[E].identifier] && re.push($[E]), m & (Q | we) && delete b[$[E].identifier], E++;
      if (re.length)
        return [
          Un(L.concat(re), "identifier"),
          re
        ];
    }
    var Wl = 2500, Jn = 25;
    ...
    function ql(u) {
      for (var m = u.srcEvent.clientX, g = u.srcEvent.clientY, b = 0; b < this.lastTouches.length; b++) {
        var E = this.lastTouches[b], L = Math.abs(m - E.x), $ = Math.abs(g - E.y);
        if (L <= Jn && $ <= Jn)
          return !0;
      }
      return !1;
    }
    var tr = gi(o.style, "touchAction"), ir = tr !== n, sr = "compute", nr = "auto", fs = "manipulation", ot = "none", zt = "pan-x", Wt = "pan-y", Ci = Yl();
    function gs(u, m) {
    ...
    gs.prototype = {
      ...
      compute: function() {
        ...
        return P(this.manager.recognizers, function(m) {
          O(m.options.enable, [m]) && (u = u.concat(m.getTouchAction()));
        }), Xl(u.join(" "));
      },
      preventDefaults: function(u) {
        ...
        var b = this.actions, E = Pe(b, ot) && !Ci[ot], L = Pe(b, Wt) && !Ci[Wt], $ = Pe(b, zt) && !Ci[zt];
        if (E) {
    ...
    function Xl(u) {
      ...
      return m && g ? ot : m || g ? m ? zt : Wt : Pe(u, fs) ? fs : nr;
    }
    function Yl() {
      if (!ir)
        return !1;
    ...
    var Ti = 1, Ae = 2, bt = 4, Ye = 8, We = Ye, Gt = 16, Be = 32;
    function Ge(u) {
      this.options = k({}, this.defaults, u || {}), this.id = vl(), this.manager = null, this.options.enable = _(this.options.enable, !0), this.state = Ti, this.simultaneous = {}, this.requireFail = [];
    }
    Ge.prototype = {
      defaults: {},
      set: function(u) {
      ...
      recognize: function(u) {
        var m = k({}, u);
        if (!O(this.options.enable, [this, m])) {
          this.reset(), this.state = Be;
          return;
        }
        this.state & (We | Gt | Be) && (this.state = Ti), this.state = this.process(m), this.state & (Ae | bt | Ye | Gt) && this.tryEmit(m);
      },
      process: function(u) {
      },
    ...
    function rr(u) {
      return u & Gt ? "cancel" : u & Ye ? "end" : u & bt ? "move" : u & Ae ? "start" : "";
    }
    function ar(u) {
    ...
    F(Ie, Ge, {
      ...
      process: function(u) {
        var m = this.state, g = u.eventType, b = m & (Ae | bt), E = this.attrTest(u);
        return b && (g & we || !E) ? m | Gt : b || E ? g & Q ? m | Ye : m & Ae ? m | bt : Ae : Be;
      }
    });
    function Si() {
    ...
    F(Si, Ie, {
      ...
      getTouchAction: function() {
        ...
        return u & He && m.push(Wt), u & at && m.push(zt), m;
      },
      directionTest: function(u) {
        var m = this.options, g = !0, b = u.distance, E = u.direction, L = u.deltaX, $ = u.deltaY;
        return E & m.direction || (m.direction & He ? (E = L === 0 ? yi : L < 0 ? Bt : Ft, g = L != this.pX, b = Math.abs(u.deltaX)) : (E = $ === 0 ? yi : $ < 0 ? Ut : Vt, g = $ != this.pY, b = Math.abs(u.deltaY))), u.direction = E, g && b > m.threshold && E & m.direction;
      },
      attrTest: function(u) {
    ...
    F(ws, Ie, {
      ...
      attrTest: function(u) {
        ...
        return m & (He | at) ? g = u.overallVelocity : m & He ? g = u.overallVelocityX : m & at && (g = u.overallVelocityY), this._super.attrTest.call(this, u) && m & u.offsetDirection && u.distance > this.options.threshold && u.maxPointers == this.options.pointers && p(g) > this.options.velocity && u.eventType & Q;
      },
      emit: function(u) {
    ...
    function je(u, m) {
      return m = m || {}, m.recognizers = _(m.recognizers, je.defaults.preset), new xs(u, m);
    }
    je.VERSION = "2.0.7", je.defaults = {
      domEvents: !1,
      touchAction: sr,
      enable: !0,
      inputTarget: null,
    ...
    var jl = 1, or = 2;
    function xs(u, m) {
      this.options = k({}, je.defaults, m || {}), this.options.inputTarget = this.options.inputTarget || u, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = u, this.input = Sl(this), this.touchAction = new gs(this, this.options.touchAction), lr(this, !0), P(this.options.recognizers, function(g) {
      ...
      recognize: function(u) {
        ...
        if (!m.stopped) {
          ...
          for (var L = 0; L < b.length; )
            g = b[L], m.stopped !== or && (!E || g == E || g.canRecognizeWith(E)) ? g.recognize(u) : g.reset(), !E && g.state & (Ae | bt | Ye) && (E = m.curRecognizer = g), L++;
        }
      },
      get: function(u) {
        if (u instanceof Ge)
    ...
    Zl.Hammer = je, a.exports ? a.exports = je : e[s] = je;
  })(window, document, "Hammer");
})(Ca);
var mi = Ca.exports;
const Oh = Lh(mi), Ue = /* @__PURE__ */ Ql({
  __proto__: null,
  default: Oh
...
try {
  ...
  Tt.addEventListener("test", null, a), Tt.removeEventListener("test", null);
} catch {
  Bs = !1;
}
  ...
  constructor(e, i, s) {
    super(e, i, s), this.handleEvent = (n) => {
      if (!this.options.enable)
        return;
      let r = n.deltaY;
      Tt.WheelEvent && (Uh && n.deltaMode === Tt.WheelEvent.DOM_DELTA_PIXEL && (r /= Tt.devicePixelRatio), n.deltaMode === Tt.WheelEvent.DOM_DELTA_LINE && (r *= zh)), r !== 0 && r % yr === 0 && (r = Math.floor(r / yr)), n.shiftKey && r && (r = r * Wh), this.callback({
        type: gr,
        center: {
          x: n.clientX,
          y: n.clientY
...
const { KEY_EVENTS: Yh } = mn, Tr = "keydown", Er = "keyup";
class jh extends Ji {
  constructor(e, i, s) {
    super(e, i, s), this.handleEvent = (n) => {
...
function Vs(a, e) {
  ...
  e = isNaN(e) ? oa : e, r = B(r, 0, e), o = new Number(o).toFixed(r);
  let l = `${o}`, c = "", p = 0, f = 0;
...
function pe(a = "ID") {
  M(a) ? a = a.toString() : T(a) || (a = "ID"), a = ze(a);
...
class qi {
  ...
  setConfig(e) {
    if (!C(e)) return !1;
    this.#a = I(e?.initialCnt) ? e.initialCnt : js, this.#o = I(e?.limitFuture) ? e.limitFuture : Ts, this.#l = I(e?.limitPast) ? e.limitPast : Nr, this.#h = I(e?.minCandles) ? e.minCandles : Ir, this.#c = I(e?.maxCandles) ? e.maxCandles : Rr, this.#u = M(e?.yAxisBounds) ? e.yAxisBounds : Dr;
  }
  setMaxMin(e) {
    for (let i in e)
  ...
  maxMinPriceVol(e) {
    ...
    let c = _(s, 0, l), p = _(n, 0, l), f = i[c][3], v = i[c][2], S = i[c][5], P = i[c][5], D = c, k = c, Z = c, he = c;
    for (; c++ < p; )
      i[c][3] < f && (f = i[c][3], D = c), i[c][2] > v && (v = i[c][2], k = c), i[c][5] < S && (S = i[c][5], Z = c), i[c][5] > P && (P = i[c][5], he = c);
    let F = v - f, ne = f, O = v;
  ...
  maxMinData(e) {
    ...
    if (o = I(o) ? o : 0, s = I(s) ? s - o : 0, s = s > 0 ? s - c : 0, n = I(n) ? n - c : l, l < 0 || i[0].length == 0)
      return f;
    let v = B(s, 0, l), S = B(n, 0, l), P, D, k, Z, he, F, ne;
    for (let O in f) {
      for (Z = i[v][p], k = i[v][p], P = v; P++ < S; )
        D = i[P][p], D <= k && (f[O].min = D, f[O].minIdx = P, k = D), D >= Z && (f[O].max = D, f[O].maxIdx = P, Z = D);
      (F === void 0 || k < F) && (F = k), (ne === void 0 || Z > ne) && (ne = Z), he = f[O].max - f[O].min, f[O].diff = isNaN(he) ? 0 : he, --p;
    }
    return f.data = {
      min: F,
      max: ne,
...
function Sn(a) {
  let e, i, s, n;
  return e = String(xn(a)), i = String(ja(a)).padStart(2, "0"), s = String(Ya(a)).padStart(2, "0"), n = String(Xa(a)).padStart(2, "0"), { d: e, h: i, m: s, s: n };
}
function tu(a, e) {
...
const iu = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  unitRange: Jc,
  year_start: En
}, Symbol.toStringTag, { value: "Module" })), su = ie, Pn = "1m", ci = su, Lr = 0.05, nu = 100, Or = 100, Dr = 0.3, is = 1.04, Yt = 8;
class Et {
...
const X = Object.keys(Et), js = 30, Ts = 200, Nr = 200, Ir = 20, Rr = 1920, ss = 5, kr = 50, $r = 30, ru = 8, Ks = 30, au = [!0, "top"];
class ae {
  static t = 0;
  static o = 1;
  static h = 2;
...
class xe {
  ...
  mount() {
    this.#a.lastElementChild == null ? this.#a.innerHTML = this.dividerNode() : this.#a.lastElementChild.insertAdjacentHTML("afterend", this.dividerNode()), this.#o = fa(`#${this.#e}`, this.#a);
  }
  dividerNode() {
...
class Fi extends co {
  ...
  xStep(e) {
    let i = nu, s = this.#i ? e.interval : 1, n = Zt[0], r = Oe(this.width / e.Length), o = Gs[0], l = Zt.indexOf(s);
    for (; l-- >= 0 && !(r * (Zt[l] / s) >= i); )
      ;
...
function po(a, e, i, s, n, r, o) {
  a.lineWidth = o?.width || Ne.borderWidth, a.strokeStyle = o?.border || Ne.stroke, go(a, e, i, s, n, r), a.stroke();
}
function fo(a, e, i, s, n, r, o) {
  a.fillStyle = o?.fill || Ne.fill, go(a, e, i, s, n, r), a.fill();
}
...
function gt(a, e, i, s) {
  T(e) && (a.fillStyle = e, a.fill()), M(s) && s > 0 && (a.lineWidth = s, a.strokeStyle = i || Ne.stroke, a.stroke());
}
function yo(a, e, i, s, n, r, o) {
  if (!(n < 3)) {
    ...
    a.closePath(), gt(a, o?.fill, o?.stroke, o?.width);
  }
}
function Qu(a, e, i) {
  if (e.length > 0) {
    ...
    a.closePath(), gt(a, i?.fill, i?.stroke, i?.width);
  }
}
function Ju(a, e, i, s, n) {
  yo(a, e, i, s, 3, n?.rotate || 0, n), gt(a, n?.fill, n?.stroke, n?.width);
}
function ed(a, e, i, s, n, r) {
  a.beginPath(), a.moveTo(e - s / 2, i), a.lineTo(e, i - n / 2), a.lineTo(e + s / 2, i), a.lineTo(e, i + n / 2), a.closePath(), gt(a, r?.fill, r?.stroke, r?.width);
}
function _t(a, e, i, s = () => {
}) {
  a.save();
...
function ad(a, e, i, s, n) {
  a.beginPath(), a.arc(e, i, s, 0, Math.PI * 2), a.closePath(), gt(a, n?.fill, n?.stroke, n?.width);
}
...
class xo {
  ...
  constructor(e = { offscreen: !0 }) {
    this.#e = q.idCnt++, this.#o = e?.layer, this.#a = cd.includes(e?.contextType) ? e.contextType : "2d";
    const i = document.createElement("canvas");
    i.className = "scene-canvas", i.style.display = "block", e.offscreen = G(e?.offscreen) ? e.offscreen : !0, In && e.offscreen ? (this.#n = i.transferControlToOffscreen(), this.#s = !0) : (this.#n = i, this.#s = !1), this.#a == "webgl2d" ? this.#r = this.getContext("2d") : this.#r = this.getContext(this.contextType), e?.width && e?.height && this.setSize(e.width, e.height);
  }
  get id() {
    return this.#e;
  }
...
<style>
  .colourpicker {
    display: grid;
    grid-template-columns: [first] ${Yi}px [second] ${Os}px;
...
class fd extends j {
  ...
  connectedCallback() {
    super.connectedCallback(
      () => {
        this.#E = new nt("#f00"), this.#e = this.shadowRoot.querySelector(".colourpicker"), this.build(), this.#t = this.shadowRoot.querySelector(".mixer"), this.#i = this.shadowRoot.querySelector(".palette"), this.#a = this.shadowRoot.querySelector(".alpha"), this.#o = this.shadowRoot.querySelector(".submit"), this.#m = this.shadowRoot.querySelector(".colval"), this.#v = this.shadowRoot.querySelector(".rgbv"), this.#d = this.shadowRoot.querySelector(".checker"), this.#p = this.shadowRoot.querySelector("tradex-slider");
        const e = (i) => {
  ...
  setColour(e) {
    let i;
    return T(e) ? (i = new nt(e), i.isValid ? (this.#E = i, this.#m.value = i.value.hexa, this.#p.value = Math.floor(255 * i.value.a), z(this.#g) && (this.#g.value = i.value.hexa, this.#g.dispatchEvent(new Event("change"))), this.#v.style.opacity = i.value.a, !0) : !1) : !1;
  }
  setAlpha(e) {
...
const yd = "#?([0-9a-f]{3}|[0-9a-f]{6}|[0-9a-f]{8})", Wr = /^#?([0-9a-f]{3}|[0-9a-f]{6}|[0-9a-f]{8})$/i, Gr = /^hsla?((\d{1,3}?),\s*(\d{1,3}%),\s*(\d{1,3}%)(,\s*[01]?\.?\d*)?)$/, qr = /^hsla[(]\s*0*(?:[12]?\d{1,2}|3(?:[0-5]\d|60))\s*(?:\s*,\s*0*(?:\d\d?(?:\.\d+)?\s*%|\.\d+\s*%|100(?:\.0*)?\s*%)){2}\s*,\s*0*(?:\.\d+|1(?:\.0*)?)\s*[)]$/, Xr = /^rgba?((\d{1,3}%?),\s*(\d{1,3}%?),\s*(\d{1,3}%?)(,\s*[01]?\.?\d*)?)$/, Yr = /^^rgba[(](?:\s*0*(?:\d\d?(?:\.\d+)?(?:\s*%)?|\.\d+\s*%|100(?:\.0*)?\s*%|(?:1\d\d|2[0-4]\d|25[0-5])(?:\.\d+)?)\s*,){3}\s*0*(?:\.\d+|1(?:\.0*)?)\s*[)]$/;
class nt {
  #e = {
    r: null,
    g: null,
  ...
  constructor(e) {
    this.#t(e), Wr.test(e) && this.#i(e), Gr.test(e) && this.#n(e), qr.test(e) && this.#s(e), Xr.test(e) && this.#r(e), Yr.test(e) && this.#a(e);
  }
  get value() {
    return this.#e;
  }
...
function xd(a, e, i, s, n, r) {
  ...
  ls(a, 0, p, o, f, r), mt(a, c, 0, o, r), mt(a, p, 0, o, r);
}
class K {
  static isOverlay = !0;
  #e;
  ...
  histogram(e, i) {
    this.#m instanceof jr || (this.#m = new jr(this.scene, this.theme)), this.#m.draw(e, i);
  }
}
class qe {
...
class ue {
  ...
  onOutsideClickListener(e) {
    if (!this.#l.contains(e.target) && ft(this.#l) && !this.#y) {
      let i = {
  ...
  mount(e) {
    e.lastElementChild == null ? e.innerHTML = this.windowNode() : e.lastElementChild.insertAdjacentHTML("afterend", this.windowNode()), this.#l = this.#o.querySelector(`#${this.#n.id}`), this.#h = this.#l.querySelector(".dragBar"), this.#c = this.#l.querySelector(".title"), this.#u = this.#l.querySelector(".closeIcon"), this.#m = this.#l.querySelector(".content"), this.#w = this.allContentFields(), this.#l.addEventListener("click", this.onWindow.bind(this)), z(this.#h) && (this.#g = new Ve(this.#h, { disableContextMenu: !1 }), this.#g.on("pointerdrag", this.onDragBar.bind(this)), this.#g.on("pointerdragend", this.onDragBarEnd.bind(this)));
  ...
  position(e) {
    ...
    let r = this.#d?.iPos?.width !== n.width || this.#d.x100 ? s.width * this.#d.x100 : Math.round((n.width - s.width) / 2), o = this.#d?.iPos?.height !== n.height || this.#d.y100 ? s.height * this.#d.y100 : Math.round((n.height + s.height) / -2), l = va(this.#l, "z-index");
    if (C(e)) {
      let { x: S, y: P, z: D } = { ...e };
  ...
  setOpen() {
    ue.currentActive = this, this.#s = qe.opened, this.#l.style.display = "block", this.#l.style.zindex = "10", this.#l.classList.add("active");
  }
  setClose() {
    ue.currentActive = null, this.#s = qe.closed, this.#l.style.display = "none", this.#l.classList.remove("active"), document.removeEventListener("click", this.#f.click);
  }
  remove() {
    return ue.destroy(this.id);
  }
  open(e = {}) {
    return ue.currentActive === this && this.state === qe.opened || (C(e.params) && (this.params = e.params), this.setOpen(), this.setProperties(e), this.emit("window_opened", this.id), this.emit(`window_opened_${this.parent.id}`, this.id), setTimeout(() => {
...
const np = 5, rp = [
  "highLowRange"
], ap = ["outputLegend", "outputOrder", "render", "style"], wt = new vd();
class Dt {
...
class U extends K {
  ...
  constructor(e, i = !1, s = !1, n, r, o) {
    ...
    const l = o.overlay;
    this.#i = U.cnt, this.#v = l, this.id = l?.id || pe(this.shortName), this.#m = o, this.#x = this.core.TALib, this.#E = this.xAxis.range, this.legendName = l?.legendName, this.#o = G(l?.legendVisibility) ? l.legendVisibility : !0, this.#P = wt, this.style = l?.settings?.style ? { ...this.constructor.defaultStyle, ...l.settings.style } : { ...this.constructor.defaultStyle, ...n.style };
  ...
  set value(e) {
    ...
    e[ae.t] = s, this.#g[ae.t] !== e[ae.t] ? (this.#g[ae.t] = e[ae.t], this.#y(e)) : this.#f(e);
  }
  get value() {
    return this.#g;
  }
  ...
  destroy() {
    if (this.#S !== "destroyed") {
      ...
      this.core.hub.expunge(this), this.chart.legend.remove(this.#w), this.clear(), this.core.MainPane.draw(void 0, !0), this.chartPane.graph.removeOverlay(this.id), super.destroy(), this.core.state.removeIndicator(this.id), this.#S = "destroyed";
    }
  }
  remove() {
  ...
  defineIndicator(e, i) {
    ...
    n.input = C(n.input) ? n.input : {}, n.output = C(n.output) ? n.output : {}, r = C(r) ? r : s.meta, r.input = C(r.input) ? r.input : {}, r.output = !A(r.output) || !r.output.length ? l : [...l, ...r.output], r.outputOrder = A(r.outputOrder) ? r.outputOrder : [], r.outputLegend = C(r.outputLegend) ? r.outputLegend : {}, Na(r.style) || (r.style = this.style || {}), this.validateInputs(n, e, i), this.validateOutputs(n, i, o), this.buildOutputOrder(r, o), this.buildOutputLegends(n), this.buildConfigOutputTab(r);
  }
  ...
  defaultMetaStyleLine(e, i, s) {
    ...
    let r = new nt(s[e.name]?.colour.value);
    if (r.isValid)
      n = r.value.hexa;
    else {
...
class _n extends U {
  ...
  constructor(e, i = !1, s = !1, n, r, o) {
    ...
    const l = o.overlay;
    this.id = o.overlay?.id || pe(this.shortName), this.#e = { ...this.defaultStyle, ...this.theme.volume }, this.style = l?.settings?.style ? { ...this.#e, ...l.settings.style } : { ...this.#e, ...n.style }, this.chart.type === "primaryPane" ? (this.style.Height = B(this.style.Height, 0, 100) || 100, this.#i = !0) : (this.style.Height = 100, this.#i = !1), this.mStyle.up.colour.value = this.style.UpColour, this.mStyle.dn.colour.value = this.style.DnColour, this.mStyle.height.percent.value = this.style.Height, this.#t = new Yo(e.scene, this.mStyle), this.addLegend(), this.configDialogue.start();
  }
  get primaryPane() {
    return this.#i;
  }
...
class dt {
  ...
  constructor(e) {
    this.#e = e, this.#n = e.time, this.status = { status: sh }, this.#t = dt.validateConfig(e.config?.stream), this.#s = M(e.config?.maxCandleUpdate) ? e.config.maxCandleUpdate : ah, this.#a = M(e.config?.streamPrecision) ? e.config.streamPrecision : oh;
  }
  get config() {
    return this.#t;
  }
  ...
  newCandle(e) {
    this.prevCandle(), this.#o = [
      ...
      null,
      !0
    ], this.#e.state.mergeData({ ohlcv: [this.#o] }, !0, !1), this.status = { status: on, data: { data: e, candle: this.#o } }, this.#h = this.#n.timeFrameMS, this.#l = this.roundTime(Date.now());
  }
  prevCandle() {
...
class Fn {
  ...
  #u;
  constructor(e) {
    this.#t = Fn.#e++, this.#i = e.core, this.#n = z(e.elContainer) ? e.elContainer : !1, this.#s = z(e.elHandle) ? e.elHandle : !1, this.#u = R(e.callback) ? e.callback : !1, z(this.#n) && z(this.#s) && (this.mount(), this.eventsListen());
  }
  set cursor(e) {
  ...
  eventsListen() {
    this.#c = new Ve(this.#s, { disableContextMenu: !1 }), this.#c.on("mouseenter", Ee(this.onMouseEnter, 1, this, !0)), this.#c.on("mouseout", Ee(this.onMouseOut, 1, this, !0)), this.#c.on("drag", Ba(this.onHandleDrag, 100, this)), this.#c.on("enddrag", this.onHandleDragDone.bind(this)), this.#c.on("mousedown", Ee(this.onMouseDown, 100, this, !0)), this.#c.on("mouseup", this.onMouseUp.bind(this));
  }
  on(e, i, s = this) {
    this.#i.on(e, i, s);
  }
  ...
  onMouseEnter() {
    ...
    e && (this.colour = new nt(e), this.#s.style.backgroundColor = this.colour.hex);
  }
  onMouseOut() {
...
class Up extends yt {
  ...
  destroy() {
    this.stateMachine.destroy(), this.#f.destroy(), this.#C.destroy(), this.#T.destroy(), this.core.hub.expunge(this), this.off("main_mousemove", this.#y.draw, this.#y), this.#m.removeEventListener("click", Ee), this.#u.removeEventListener("click", Ee), this.graph.destroy(), this.element.remove();
  }
  eventsListen() {
    this.#f = new Ve(this.#a, { disableContextMenu: !1 }), this.#f.on("dblclick", this.onDoubleClick.bind(this)), this.#f.on("pointerover", this.onPointerEnter.bind(this)), this.#f.on("pointerout", this.onPointerLeave.bind(this)), this.#f.on("pointerdrag", this.onPointerDrag.bind(this)), this.#C = new Ve(this.#m, { disableContextMenu: !1 }), this.#C.on("pointerover", () => this.showJump(this.#P.end)), this.#C.on("pointerleave", () => this.hideJump(this.#P.end)), this.#T = new Ve(this.#u, { disableContextMenu: !1 }), this.#T.on("pointerover", () => this.showJump(this.#P.start)), this.#T.on("pointerleave", () => this.hideJump(this.#P.start)), this.on("main_mousemove", this.#y.draw, this.#y), this.on("setRange", this.onSetRange, this), this.#m.addEventListener("click", Ee(this.onPointerClick, 1e3, this, !0)), this.#u.addEventListener("click", Ee(this.onPointerClick, 1e3, this, !0));
  }
  onPointerClick(e) {
  ...
  createGraph() {
    let e = se(Fp);
    this.graph = new pt(this, this.#a, e, !1), this.#y = this.graph.overlays.get("cursor").instance, this.#E = this.graph.overlays.get("labels").instance, this.#g = this.graph.overlays.get("overlay").instance, this.graph.addOverlays(this.#p);
  }
  addOverlays(e) {
    if (!A(e)) return !1;
...
class jp extends yt {
  ...
  setDimensions(e) {
    ...
    this.setHeight(e.h), this.graph instanceof pt && (this.graph.setSize(i, e.h, i), this.draw()), this.#c instanceof Ko && this.calcPriceDigits();
  }
  setScaleRange(e = 0) {
  ...
  createGraph() {
    let e = se(Yp);
    this.graph = new pt(this, this.#a, e, !1), this.#c = this.graph.overlays.get("cursor").instance, this.#o = this.graph.overlays.get("labels").instance, this.#l = this.graph.overlays.get("overlay").instance, this.#h = this.graph.overlays.get("price").instance, this.graph.addOverlays(this.#m), this.#h.target.moveTop(), this.#c.target.moveTop(), this.calcPriceDigits();
  }
  calcPriceDigits() {
    let e = Yt, i = "0";
    if (this.core.range.dataLength > 0 && this.#s instanceof St) {
      if (this.#i.isPrimary)
        ...
        for (let s in this.#i.indicators) {
          let n = this.range.secondaryMaxMin?.[s]?.data?.max || Yt, r = this.niceValue(n);
          r.length > i.length && (i = r);
        }
      e = `${i}`.length + 2 || Yt;
    }
    return this.#v = e < Yt ? Yt : e, this.#v;
  }
  niceValue(e) {
...
class Zp extends K {
  ...
  #t;
  constructor(e, i = !1, s = !1, n, r, o) {
    super(e, i, s, n, r, o), this.#e = new Yo(e.scene, n), this.theme.volume.Height = B(n?.volume?.Height, 0, 100) || 100;
  }
  set position(e) {
    this.target.setPosition(e[0], e[1]);
  }
...
class Jp extends K {
  ...
  draw(e = this.core.range) {
    ...
    f.colourCursorBG = this.theme?.hilo?.colour || Qt.colour, v.save(), v.strokeStyle = this.theme?.highLow?.colour || Qt.colour, v.strokeWidth = this.theme?.highLow?.width || Qt.width, v.setLineDash(this.theme?.highLow?.dash || Qt.dash), n = this.yAxis.yPos(c), mt(v, n, 0, r, l), i = "High", s = this.theme.yAxis.location == "left" ? 0 : r - (o + 25), Zi(v, i, s, n, o, f), n = this.yAxis.yPos(p), mt(v, n, 0, r, l), i = "Low", Zi(v, i, s, n, o, f), v.restore(), super.updated(), "hiLo" in this.chart.scale.overlays && (this.chart.scale.overlays.hiLo.instance.setRefresh(), this.chart.scale.overlays.hiLo.instance.scaleDraw());
  }
}
class ef extends K {
  constructor(e, i = !1, s = !1, n, r, o) {
...
class sf {
  ...
  draw(e) {
    this.data = e;
    const i = this.icon, s = this.cfg, n = this.hit.getIndexValue(e.key), r = ut(n, i), o = B(e.w, s.iconMinDim, s.iconHeight), l = B(e.w, s.iconMinDim, s.iconWidth), c = this.data.x, p = this.data.y, f = this.ctx, v = this.ctxH;
...
class rf {
  ...
  draw(e) {
    ...
    const n = this.hit.getIndexValue(e.key), r = ut(n, s), o = B(e.w, i.iconMinDim, i.iconHeight), l = B(e.w, i.iconMinDim, i.iconWidth), c = this.data.x, p = this.data.y, f = this.ctx, v = this.ctxH;
...
class af extends K {
  ...
  #n;
  constructor(e, i = !1, s = !1, n, r, o) {
    super(e, i, s, n, r, o), this.settings = o.settings, N.importData("trades", this.data, this.state, this.state.time.timeFrame), this.#e = new rf(e, n), this.core.on("primary_pointerdown", this.onPrimaryPointerDown, this), ea.parent = this, this.#n = this.core.WidgetsG.insert("Dialogue", ea), this.#n.start();
  }
  destroy() {
...
class ye extends K {
  ...
  #u = { TL: [0, 0], BR: [0, 0] };
  constructor(e, i = !1, s = !1, n, r, o) {
    super(e, i, s, n, r, o), this.#n = ye.inCnt, this.config.ID && (this.#i = ze(this.config.ID)), this.settings = o?.settings || {}, ta.parent = this, this.#a = this.core.WidgetsG.insert("ConfigDialogue", ta), this.#a.start(), this.eventsListen();
  }
  set id(e) {
    this.#i = ze(e);
  }
...
class it extends yt {
  ...
  #L = {};
  constructor(e, i = {}) {
    if (super(e, i), this.#r = it.cnt, !C(i)) throw new Error("Chart (pane) constructor failed: Expected options typeof object");
...
class ia extends yt {
  ...
  init(e) {
    ...
    this.#x = new Up(this.core, e), this.registerChartPanes(e), this.#b = M(this.config.buffer) ? this.config.buffer : ss, this.#C = M(this.config.rowMinH) ? this.config.rowMinH : kr, this.#f = M(this.config.secondaryPaneDefaultH) ? this.config.secondaryPaneDefaultH : $r, this.rowsOldH = this.rowsH;
  }
  start() {
    let e = 0;
  ...
  addChartPane(e) {
    ...
    let f;
    return e.type == "primary" ? (f = new it(this.core, e), this.#p = f) : (e.name = e.view[0].name || "Secondary", e.shortName = e.view[0].type || "Secondary", f = new it(this.core, e)), this.#d.set(f.id, f), this.tallyChartHeights().height > this.#s.height, this.setPaneDividers(), this.emit("addChartView", f), f;
  }
  removeChartPane(e) {
...
class N {
  ...
  static validate(e, i = !1, s = !1) {
    ...
    e.views.length == 0 && (e.views[0] = ["primary", n.primary]), e.views = new be(e.views), e.views.has("primary") || e.views.insert("primary", n.primary, 0), e.views.get("primary").push(e.chart), N.validateData("trades", e), e.trades = e.allData.trades, N.validateData("events", e), e.events = e.allData.events, N.validateData("annotations", e), e.annotations = e.allData.annotations, N.validateData("tools", e), e.tools = e.allData.tools;
  ...
  static export(e, i = {}) {
    if (!N.has(e)) return !1;
    C(i) || (i = {});
    const s = N.get(e), n = i?.type, r = se(s.data), o = r.chart.data;
    let l;
  ...
  static importData(e, i, s, n) {
    ...
    for (let o in i)
      if (gn(o * 1) && A(i[o]))
        for (let l of i[o])
          l?.id && (l.id = `${l.id}`), N.isValidEntry(l, ks[e]) && (C(r?.[n]) || (r[n] = {}), A(r[n]?.[o]) || (r[n][o] = []), r[n][o].push(l));
      else
        r[o] = i[o];
    return !0;
  }
  ...
  constructor(e, i = !1, s = !1) {
    C(e) ? (this.#s = N.validate(e, i, s), this.#r = "valid", this.#a = !!this.#s.chart?.isEmpty, this.#l = e?.core instanceof H ? e.core : void 0) : (this.#s = N.default, this.#r = "default", this.#a = !0), this.#s.chart.ohlcv = N.ohlcv(this.#s.chart.data), this.#n = pe(`${Jt}_state`), this.#i = e?.id || this.#n;
  }
  get id() {
    return this.#i;
  }
  ...
  mergeData(e, i = !1, s = !1) {
    ...
    let r, o, l = e?.ohlcv || !1;
    const c = this.allData.data, p = this.allData?.primaryPane, f = e?.primary || !1, v = this.allData?.secondaryPane, S = e?.secondary || !1, P = this.allData?.dataset?.data, D = e?.dataset?.data || !1;
    this.allData?.trades;
    const k = e?.trades || !1;
    ...
    if (A(l) && l.length > 0) {
      if (r = l.length - 1, c.length - 1, he.mData = this.range.inRange(l[0][0]) && this.range.inRange(l[0][r]), !G(l[r][7]) && l[r].length !== 8 && l[r][6] !== null && l[r][7] !== !0 ? l = Mp(l) : i.end >= this.range.timeFinish && i.start <= this.range.timeFinish && (i.start += this.range.interval, i.end += this.range.interval), c.length == 0) {
        let O = N.ohlcv(l);
        this.allData.data.push(...l), this.allData.ohlcv = { ...O };
      } else {
        let O = O, _ = l[0][0], oe = l[l.length - 1][0], ce = (l.length - 1) * O;
        oe > _ + ce && (l = Pp(l, O)), this.data.chart.data = this.merge(c, l);
      }
      if (s) this.#l.calcAllIndicators(s);
      else {
        if (A(f) && f.length > 0) {
          for (let O of f)
            if (A(O?.data) && O?.data.length > 0)
              for (let _ of p)
                C(_) && _.name === O.name && _.type === O.type && ei(_.settings, O.settings) && (_.data = this.merge(_.data, O.data), this.#l.getIndicator(_.id).drawOnUpdate = !0);
        }
        if (A(S) && S.length > 0) {
          for (let O of S)
            if (A(O?.data) && O?.data.length > 0)
      ...
      if (A(D) && D.length > 0) {
        for (let O of D)
          if (A(O?.data) && O?.data.length > 0)
            for (let _ of P)
              _.name === O.name && _.type === O.type && ei(_.settings, O.settings) && (_.data = this.merge(_.data, O.data));
      }
      C(k) && N.importTrades(k, this.allData, this.time.timeFrame), i && (C(i) ? (o = M(i.start) ? this.range.getTimeIndex(i.start) : this.range.indexStart, n = M(i.end) ? this.range.getTimeIndex(i.end) : this.range.indexEnd) : (l[0][0] && (o = this.range.indexStart + Z), n = this.range.indexEnd + Z), this.#l.setRange(o, n));
      let F, ne = !1;
      for (F in he)
        ne = ne || F;
  ...
  addEvent(e) {
    if (!N.isValidEntry(e, el)) return !1;
...
const ra = 20, bf = 20, wf = new nt(V.COLOUR_BORDER), nn = document.createElement("template");
nn.innerHTML = `
<style>
  .scrollBarWidget {
    display: flex;
...
class $f extends j {
  ...
  connectedCallback() {
    if (this.doInit) {
      this.doInit = !1, this.shadowRoot.appendChild(this.#n.content.cloneNode(!0)), this.style.display = "grid", this.style.minHeight = io, this.#i = this.shadowRoot.querySelector("tradex-widgets"), this.#t = this.shadowRoot.querySelector("tradex-utils"), this.#e = this.shadowRoot.querySelector("tradex-body"), this.#r = this.parentElement.clientHeight || Je, this.#s = this.parentElement.clientWidth || si;
      let e = this.getAttribute("height") || "100%", i = this.getAttribute("width") || "100%";
      this.setDimensions(i, e), this.resizeObserver = new ResizeObserver(Ee(this.onResized, 100, this)), this.resizeObserver.observe(this), this.start(ho);
    }
  }
  disconnectedCallback() {
    this.resizeObserver.disconnect();
...
class Ce {
  ...
  onOutsideClickListener(e) {
    if (!this.#a.contains(e.target) && !this.#n.primary.contains(e.target) && ft(this.#a)) {
      let i = {
        target: e.currentTarget.id,
        menu: this.#e
      };
...
class Le {
  ...
  mount(e) {
    ...
    e.lastElementChild == null ? e.innerHTML = this.progressNode(s) : e.lastElementChild.insertAdjacentHTML("afterend", this.progressNode(s)), this.#a = this.#r.querySelector(`#${this.#n.id}`), this.#o = this.#a.querySelector("svg"), this.#o.style.fill = `${Wu.COLOUR_ICONHOVER};`;
  }
}
const _s = {
  id: "widgets",
...
class Vf extends yt {
  ...
  #t = "widgets";
  #i;
  #n = { Divider: xe, Progress: Le, Menu: Ce, Window: ue, Dialogue: di, ConfigDialogue: Qi };
  #s = {};
  #r = {};
  #a;
  #o;
...
function aa(a, e, i, s, n, r) {
  const o = a.theme, l = document.createElement("template"), c = a.Timeline.graph.viewport.scene, p = a.MainPane, f = p.graph.viewport.scene, v = p.width, S = p.height, P = new q.Viewport({
    width: v,
    height: S,
    container: l
  }), D = P.scene.context;
  let k = 0, Z = 0, he = v - a.Chart.scale.width;
  o?.yAxis?.location == "left" && (Z = a.Chart.scale.width, he = 0);
  let F;
  D.save(), ls(D, 0, 0, v, S, { fill: o.chart.Background }), D.drawImage(f.canvas, Z, 0, f.width, f.height);
  for (const [O, _] of a.ChartPanes) {
    let oe = _.graph.viewport.scene, { width: ce, height: Se } = oe, Pe = _.scale.graph.viewport.scene, { width: vt, height: Xe } = Pe;
    k > 0 && (F = { stroke: o.divider.line }, mt(D, k, 0, p.width, F)), D.drawImage(oe.canvas, Z, k, ce, Se), D.drawImage(Pe.canvas, he, k - 1, vt, Xe), k += Se;
  }
  ...
  const ne = (O) => {
    if (O) {
      const oe = r?.x || 0, ce = r?.y || 0, Se = r?.width || v * 0.25, Pe = r?.height || S * 0.25;
      D.drawImage(O, oe, ce, Se, Pe);
    }
    D.restore();
    const _ = () => {
      P.destroy(), l.remove();
    ...
    switch (n) {
      case "url":
        if (R(e)) {
          ...
          P.scene.toImage(i, s, oe);
        } else
          new Promise(function(oe, ce) {
            const Se = P.scene.toImage(i, s);
            Se ? oe(Se) : ce(!1), _();
          });
        break;
      case "download":
...
class H extends $f {
  ...
  constructor() {
    super(), this.#d = this, this.#g = H.cnt(), this.logs = !1, this.infos = !1, this.warnings = !1, this.errors = !1, this.timers = !1, this.setID(null), this.#f = this.#y.create({ core: this }, !1, !1), console.warn(`!WARNING!: ${qt} changes to config format, for details please refer to https://github.com/tradex-app/TradeX-chart/blob/master/docs/notices.md`), this.log(`${Jt} instance count: ${this.inCnt}`), this.oncontextmenu = window.oncontextmenu, this.#U = sn;
    const e = this.#S;
  ...
  start(e) {
    ...
    if (r.range = { ...r.range, ...i.range }, this.#E) {
      ...
      P.interval = p, P.core = this, this.getRange(null, null, P), this.setRange(v, S), this.#H = new Vf(this, { widgets: i?.widgets }), this.#$ = new Hf(this, i), this.#_ = new tl(this, i), this.#A = new ia(this, i), this.eventsListen(), this.elStart(this.theme), this.elBody.start(this.theme), this.UtilsBar.start(), this.ToolsBar.start(), this.MainPane.start(), this.WidgetsG.start(), this.#F = this.WidgetsG.insert("Progress", {});
    }
    this.insertAdjacentHTML("beforebegin", `<style title="${this.id}_style"></style>`), this.setTheme(this.#O.id), this.#D = this.bufferPx * -1, this.stream = this.#p.stream, !C(i?.stream) && this.state.data.chart.data.length < 2 ? this.warn(`${qt} has no chart data or streaming provided.`) : C(i?.stream) && this.state.data.chart.data.length < 2 && (this.#R = !0), this.log(`Time Frame: ${this.#C.timeFrame} Milliseconds: ${this.#C.timeFrameMS}`), this.#R && this.on(st, this.delayedSetRange, this), this.#p.callbacks = this.#p.callbacks || {}, this.#E = !0, setTimeout(this.refresh.bind(this), 1e3), this.log(`${this.#m} V${H.version} configured and running...`);
  }
  use(e) {
    this.start(e);
  }
  ...
  setStream(e) {
    ...
    if (C(e)) {
      ...
      return this.#N = new dt(this), this.#p.stream = this.#N.config, this.#N;
    }
  }
  stopStream() {
  ...
  isOverlay(e) {
    return ri(e) && R(e.prototype?.draw) && !this.isIndicator(e) && Object.getPrototypeOf(e.prototype).constructor.isOverlay;
  }
  hasOverlay(e) {
  ...
  isIndicator(e) {
    return ri(e) && R(e.prototype?.draw) && "primaryPane" in e.prototype && !!e?.isIndicator;
  }
  setIndicators(e, i = !1) {
    if (!C(e)) return !1;
...
window.customElements.get("tradex-chart") || (document.head.insertAdjacentHTML("beforeend", ju), document.head.insertAdjacentHTML("beforeend", Ku), customElements.get("tradex-chart") || customElements.define("tradex-chart", H));
const zf = [
  "before",
  "after",
  "around",
