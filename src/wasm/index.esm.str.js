      ...
      for (var symName in exports) {
        ...
        if (replace || GOT[symName].value == 0) {
          if (typeof value === "function") {
            ...
            err("unhandled export_type for '" + symName + "': " + typeof value);
          }
        }
      }
    }
      ...
      for (var symName in GOT) {
        if (GOT[symName].value == 0) {
          ...
          if (typeof value === "function") {
            ...
            assert(
              false,
              "bad export_type for '" + symName + "': " + typeof value
            );
          }
        }
      }
...
const cdl3StarsInSouth = CDL3STARSINSOUTH;
...
const cdl3WhiteSoldiers = CDL3WHITESOLDIERS;
...
const cdlAbandonedBaby = CDLABANDONEDBABY;
...
const cdlClosingMarubozu = CDLCLOSINGMARUBOZU;
...
const cdlConcealBabysWall = CDLCONCEALBABYSWALL;
...
const cdlCounterAttack = CDLCOUNTERATTACK;
...
const cdlGapSideSideWhite = CDLGAPSIDESIDEWHITE;
...
const cdlHomingPigeon = CDLHOMINGPIGEON;
...
const cdlKickingByLength = CDLKICKINGBYLENGTH;
...
const cdlLadderBottom = CDLLADDERBOTTOM;
...
const cdlRiseFall3Methods = CDLRISEFALL3METHODS;
...
const cdlSeperatingLines = CDLSEPARATINGLINES;
...
const cdlStalledPattern = CDLSTALLEDPATTERN;
...
const cdlUnique3River = CDLUNIQUE3RIVER;
...
const cdlUpsideGap2Crows = CDLUPSIDEGAP2CROWS;
...
const cdlXSideGap3Methods = CDLXSIDEGAP3METHODS;
...
const linearRegAngle = LINEARREG_ANGLE;
...
const linearRegIntercept = LINEARREG_INTERCEPT;
...
const linearRegSlope = LINEARREG_SLOPE;
