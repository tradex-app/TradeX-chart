...
function Th(a, e, i, s) {
  let n = un(a, e, i, s);
  if (n)
    n.i >= 0 ? n.rules[n.i].style[n.property] = n.value : wa(n.styleSheet, n.selector, n.rules, n.index);
  else
    return;
}
function Eh(a, e, i) {
...
`;
    ...
    function Sl(u, m) {
      ...
      var L = g.firstInput, $ = g.firstMultiple, re = $ ? $.center : L.center, le = m.center = Xn(v);
    ...
    function Ml(u, m) {
      ...
      if (m.eventType != we && (v > El || g.velocity === n)) {
        var le = m.deltaX - g.deltaX, ge = m.deltaY - g.deltaY, Fe = Yn(v, le, ge);
    ...
    F(ms, Me, {
      handler: function(m) {
        var g = this.store, v = !1, E = m.type.toLowerCase().replace("ms", ""), L = kl[E], $ = $l[m.pointerType] || m.pointerType, re = $ == Ht, le = je(g, m.pointerId, "pointerId");
    ...
    function Fl(u, m) {
      ...
      return m & (Q | we) && (g = Un(g.concat(v), "identifier", !0)), [g, v];
    }
    var Bl = {
      touchstart: fe,
      touchmove: nt,
    ...
    F(ps, Me, {
      handler: function(m, g, v) {
        var E = v.pointerType == Ht, L = v.pointerType == us;
    ...
    gs.prototype = {
      ...
      preventDefaults: function(u) {
        ...
        var v = this.actions, E = Pe(v, ot) && !Ci[ot], L = Pe(v, Wt) && !Ci[Wt], $ = Pe(v, zt) && !Ci[zt];
        if (E) {
    ...
    var Ti = 1, Ae = 2, bt = 4, Ke = 8, We = Ke, Gt = 16, Be = 32;
    function Ge(u) {
      this.options = N({}, this.defaults, u || {}), this.id = vl(), this.manager = null, this.options.enable = _(this.options.enable, !0), this.state = Ti, this.simultaneous = {}, this.requireFail = [];
    }
    Ge.prototype = {
      defaults: {},
      set: function(u) {
      ...
      emit: function(u) {
        ...
        g < Ke && v(m.options.event + rr(g)), v(m.options.event), u.additionalEvent && v(u.additionalEvent), g >= Ke && v(m.options.event + rr(g));
      },
      tryEmit: function(u) {
        if (this.canEmit())
          return this.emit(u);
      ...
      recognize: function(u) {
        ...
        this.state & (We | Gt | Be) && (this.state = Ti), this.state = this.process(m), this.state & (Ae | bt | Ke | Gt) && this.tryEmit(m);
      },
      process: function(u) {
      },
    ...
    function rr(u) {
      return u & Gt ? "cancel" : u & Ke ? "end" : u & bt ? "move" : u & Ae ? "start" : "";
    }
    function ar(u) {
    ...
    F(Ie, Ge, {
      ...
      process: function(u) {
        var m = this.state, g = u.eventType, v = m & (Ae | bt), E = this.attrTest(u);
        return v && (g & we || !E) ? m | Gt : v || E ? g & Q ? m | Ke : m & Ae ? m | bt : Ae : Be;
      }
    });
    function Si() {
    ...
    function qe(u, m) {
      return m = m || {}, m.recognizers = _(m.recognizers, qe.defaults.preset), new xs(u, m);
    }
    ...
    var jl = 1, or = 2;
    function xs(u, m) {
      this.options = N({}, qe.defaults, m || {}), this.options.inputTarget = this.options.inputTarget || u, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = u, this.input = Sl(this), this.touchAction = new gs(this, this.options.touchAction), lr(this, !0), M(this.options.recognizers, function(g) {
      ...
      recognize: function(u) {
        ...
        if (!m.stopped) {
          ...
          for (var L = 0; L < v.length; )
            g = v[L], m.stopped !== or && (!E || g == E || g.canRecognizeWith(E)) ? g.recognize(u) : g.reset(), !E && g.state & (Ae | bt | Ke) && (E = m.curRecognizer = g), L++;
        }
      },
      get: function(u) {
        if (u instanceof Ge)
...
class Gi {
  ...
  constructor(e, i, s = {}) {
    ...
    if (this.data.length == 0) {
      ...
      this.data.length < 2 ? (this.#s = n, this.#r = Pt(this.interval)) : (this.#s = Ws(this.data), this.#r = Pt(this.interval));
  ...
  setConfig(e) {
    if (!C(e))
      return !1;
    this.#a = R(e?.initialCnt) ? e.initialCnt : js, this.#o = R(e?.limitFuture) ? e.limitFuture : Ts, this.#l = R(e?.limitPast) ? e.limitPast : Nr, this.#h = R(e?.minCandles) ? e.minCandles : Ir, this.#c = R(e?.maxCandles) ? e.maxCandles : Rr, this.#u = P(e?.yAxisBounds) ? e.yAxisBounds : Dr;
  }
  setMaxMin(e) {
    for (let i in e)
...
class St extends co {
  ...
  gradations(e, i, s = !0) {
    ...
    this.#c = b;
    for (var M = c; M <= p; M += l)
      n = Ri(M), S = Vs(M, b.decimals) * 1, f = this.yPos(S), r.push([S, f, n]);
    return r;
  }
...
class fd extends j {
  ...
  connectedCallback() {
    super.connectedCallback(
      () => {
        this.#E = new Ye("#f00"), this.#e = this.shadowRoot.querySelector(".colourpicker"), this.build(), this.#t = this.shadowRoot.querySelector(".mixer"), this.#i = this.shadowRoot.querySelector(".palette"), this.#a = this.shadowRoot.querySelector(".alpha"), this.#o = this.shadowRoot.querySelector(".submit"), this.#m = this.shadowRoot.querySelector(".colval"), this.#y = this.shadowRoot.querySelector(".rgbv"), this.#d = this.shadowRoot.querySelector(".checker"), this.#p = this.shadowRoot.querySelector("tradex-slider");
        const e = (i) => {
  ...
  setColour(e) {
    let i;
    return T(e) ? (i = new Ye(e), i.isValid ? (this.#E = i, this.#m.value = i.value.hexa, this.#p.value = Math.floor(255 * i.value.a), z(this.#g) && (this.#g.value = i.value.hexa, this.#g.dispatchEvent(new Event("change"))), this.#y.style.opacity = i.value.a, !0) : !1) : !1;
  }
  setAlpha(e) {
  ...
  canvasNode(e) {
    ...
    return Ui(f, b, ["#f00f", "#ff0f", "#0f0f", "#0fff", "#00ff", "#f0ff", "#f00f"]), f.fillRect(0, 0, c, c), f = l.rgbv.scene.context, b = [0, 0, 0, c], Ui(f, b, ["#fff", "#0000", "#000"]), f.fillRect(0, 0, c, c), f = l.grid.scene.context, Nn(f, 8, 16, 16, "#fff", "#ccc"), r.render(), o.render(), i;
  }
  viewportNode(e) {
    const i = document.createElement("div");
...
class ue {
  ...
  setContent(e, i = {}) {
    ...
    for (let s in i)
      k(i[s]) && i[s](this.#m);
    return this.#w = this.allContentFields(), this.#y = this.#m.querySelector("tradex-colourpicker"), this.#m;
  }
  start() {
...
class U extends K {
  ...
  constructor(e, i = !1, s = !1, n, r, o) {
    ...
    const l = o.overlay;
    this.#i = U.cnt, this.#y = l, this.id = l?.id || pe(this.shortName), this.#m = o, this.#x = this.core.TALib, this.#E = this.xAxis.range, this.legendName = l?.legendName, this.#o = G(l?.legendVisibility) ? l.legendVisibility : !0, this.#M = wt, this.style = l?.settings?.style ? { ...this.constructor.defaultStyle, ...l.settings.style } : { ...this.constructor.defaultStyle, ...n.style }, this.meta;
  ...
  defaultMetaStyleLine(e, i, s) {
    ...
    let r = new Ye(s[e.name]?.colour.value);
    if (r.isValid)
      n = r.value.hexa;
    else {
  ...
  defaultOutputField(e, i, s, n, r, o, l) {
    ...
    switch (n) {
      case "number":
        ...
        break;
      case "color":
        c = new Ye(s), s = c.isValid ? c.hexa : this.defaultColour(), f = [S, M, op, lp], p = (N) => {
...
class dt {
  ...
  onUpdate() {
    this.#o !== Li && (this.status = { status: nt, data: this.candle }, this.status = { status: Ii, data: this.#o });
  }
  newCandle(e) {
...
class Fn {
  ...
  #u;
  constructor(e) {
    this.#t = Fn.#e++, this.#i = e.core, this.#n = z(e.elContainer) ? e.elContainer : !1, this.#s = z(e.elHandle) ? e.elHandle : !1, this.#u = k(e.callback) ? e.callback : !1, z(this.#n) && z(this.#s) && (this.mount(), this.eventsListen());
  }
  set cursor(e) {
  ...
  onMouseEnter() {
    ...
    e && (this.colour = new Ye(e), this.#s.style.backgroundColor = this.colour.hex);
  }
  onMouseOut() {
...
class Up extends gt {
  ...
  init() {
    ...
    this.#P = new Fn(i), this.core.theme?.time?.navigation === !1 && this.navigationDisplay(!1);
  }
  setWidth(e) {
  ...
  destroy() {
    this.stateMachine.destroy(), this.#f.destroy(), this.#C.destroy(), this.#T.destroy(), this.core.hub.expunge(this), this.off("main_mousemove", this.#v.draw, this.#v), this.#m.removeEventListener("click", Ee), this.#u.removeEventListener("click", Ee), this.graph.destroy(), this.element.remove();
  }
  eventsListen() {
    this.#f = new Ve(this.#a, { disableContextMenu: !1 }), this.#f.on("dblclick", this.onDoubleClick.bind(this)), this.#f.on("pointerover", this.onPointerEnter.bind(this)), this.#f.on("pointerout", this.onPointerLeave.bind(this)), this.#f.on("pointerdrag", this.onPointerDrag.bind(this)), this.#C = new Ve(this.#m, { disableContextMenu: !1 }), this.#C.on("pointerover", () => this.showJump(this.#S.end)), this.#C.on("pointerleave", () => this.hideJump(this.#S.end)), this.#T = new Ve(this.#u, { disableContextMenu: !1 }), this.#T.on("pointerover", () => this.showJump(this.#S.start)), this.#T.on("pointerleave", () => this.hideJump(this.#S.start)), this.on("main_mousemove", this.#v.draw, this.#v), this.on("setRange", this.onSetRange, this), this.#m.addEventListener("click", Ee(this.onPointerClick, 1e3, this, !0)), this.#u.addEventListener("click", Ee(this.onPointerClick, 1e3, this, !0));
  }
  onPointerClick(e) {
  ...
  createGraph() {
    let e = se(Fp);
    this.graph = new pt(this, this.#a, e, !1), this.#v = this.graph.overlays.get("cursor").instance, this.#E = this.graph.overlays.get("labels").instance, this.#g = this.graph.overlays.get("overlay").instance, this.graph.addOverlays(this.#p);
  }
  addOverlays(e) {
    if (!A(e))
      return !1;
...
class jp extends gt {
  ...
  calcPriceDigits() {
    ...
    return this.#y = e < Yt ? Yt : e, this.#y;
  }
  niceValue(e) {
...
class Kp extends K {
  ...
  renderText(e) {
    ...
    const p = os(l), f = as(c, e, l), b = (this.scene.width - f) / 2, S = (this.core.Chart.height - p) / 2;
    c.fillText(e, b, S);
  }
  renderImage(e) {
    if (!e)
...
class Jp extends K {
  ...
  draw(e = this.core.range) {
    ...
    f.colourCursorBG = this.theme?.hilo?.colour || Qt.colour, b.save(), b.strokeStyle = this.theme?.highLow?.colour || Qt.colour, b.strokeWidth = this.theme?.highLow?.width || Qt.width, b.setLineDash(this.theme?.highLow?.dash || Qt.dash), n = this.yAxis.yPos(c), mt(b, n, 0, r, l), i = "High", s = this.theme.yAxis.location == "left" ? 0 : r - (o + 25), Zi(b, i, s, n, o, f), n = this.yAxis.yPos(p), mt(b, n, 0, r, l), i = "Low", Zi(b, i, s, n, o, f), b.restore(), super.updated(), "hiLo" in this.chart.scale.overlays && (this.chart.scale.overlays.hiLo.instance.setRefresh(), this.chart.scale.overlays.hiLo.instance.scaleDraw());
  }
}
class ef extends K {
  constructor(e, i = !1, s = !1, n, r, o) {
...
class sf {
  ...
  draw(e) {
    this.data = e;
    const i = this.icon, s = this.cfg, n = this.hit.getIndexValue(e.key), r = ut(n, i), o = B(e.w, s.iconMinDim, s.iconHeight), l = B(e.w, s.iconMinDim, s.iconWidth), c = this.data.x, p = this.data.y, f = this.ctx, b = this.ctxH;
...
class rf {
  ...
  draw(e) {
    ...
    const n = this.hit.getIndexValue(e.key), r = ut(n, s), o = B(e.w, i.iconMinDim, i.iconHeight), l = B(e.w, i.iconMinDim, i.iconWidth), c = this.data.x, p = this.data.y, f = this.ctx, b = this.ctxH;
...
class af extends K {
  ...
  #n;
  constructor(e, i = !1, s = !1, n, r, o) {
    super(e, i, s, n, r, o), this.settings = o.settings, I.importData("trades", this.data, this.state, this.state.time.timeFrame), this.#e = new rf(e, n), this.core.on("primary_pointerdown", this.onPrimaryPointerDown, this), ea.parent = this, this.#n = this.core.WidgetsG.insert("Dialogue", ea), this.#n.start();
  }
  destroy() {
...
class ia extends yt {
  ...
  removeChartPane(e) {
    if (!T(e) || !this.#d.has(e) || e in this.#g)
      return !1;
...
class I {
  ...
  static importData(e, i, s, n) {
    ...
    for (let o in i)
      if (gn(o * 1) && A(i[o]))
        for (let l of i[o])
          l?.id && (l.id = `${l.id}`), I.isValidEntry(l, ks[e]) && (C(r?.[n]) || (r[n] = {}), A(r[n]?.[o]) || (r[n][o] = []), r[n][o].push(l));
      else
        r[o] = i[o];
    return !0;
  }
...
const ra = 20, bf = 20, wf = new Ye(V.COLOUR_BORDER), nn = document.createElement("template");
nn.innerHTML = `
<style>
  .scrollBarWidget {
    display: flex;
...
function aa(a, e, i, s, n, r) {
  ...
  let F;
  O.save(), ls(O, 0, 0, b, S, { fill: o.chart.Background }), O.drawImage(f.canvas, Z, 0, f.width, f.height);
  for (const [D, _] of a.ChartPanes) {
    let oe = _.graph.viewport.scene, { width: ce, height: Se } = oe, Pe = _.scale.graph.viewport.scene, { width: vt, height: je } = Pe;
    N > 0 && (F = { stroke: o.divider.line }, mt(O, N, 0, p.width, F)), O.drawImage(oe.canvas, Z, N, ce, Se), O.drawImage(Pe.canvas, he, N - 1, vt, je), N += Se;
  }
...
class H extends $f {
  ...
  constructor() {
    super(), this.#d = this, this.#g = H.cnt(), this.logs = !1, this.infos = !1, this.warnings = !1, this.errors = !1, this.timers = !1, this.setID(null), this.#f = this.#v.create({ core: this }, !1, !1), console.warn(`!WARNING!: ${qt} changes to config format, for details please refer to https://github.com/tradex-app/TradeX-chart/blob/master/docs/notices.md`), this.log(`${Jt} instance count: ${this.inCnt}`), this.oncontextmenu = window.oncontextmenu, this.#U = sn;
    const e = this.#P;
  ...
  setState(e) {
    ...
    if (this.getRange(void 0, void 0, i), this.range.Length > 1) {
      const s = $c(this.time), n = R(s) ? s + this.range.initialCnt : this.#f.data.chart.data.length - 1, r = R(s) ? s : n - this.range.initialCnt;
