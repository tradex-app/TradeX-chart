...
const Qt = "TradeX-Chart", ut = "TX", yc = "tradeXutils", Qr = "tradeXmenus", vc = "tradeXmenu", Jr = "tradeXdividers", ea = "tradeXwindows", bc = "tradeXwindow", ta = "tradeXprogress", wc = 500, xo = "stream_None", ti = "stream_Listening", _s = "stream_Started", Co = "stream_Stopped", xc = "stream_Error", Ji = "stream_candleFirst", et = "stream_candleUpdate", es = "stream_candleNew", Cc = 250, Tc = 8, ia = 2, Sc = 2, To = 18, ci = 100, ii = /^(\d*\.?\d+)\s?(px|em|ex|%|in|cn|mm|pt|pc+)$/igm;
function M(a) {
  return Array.isArray(a);
}
function vi(a, e) {
  return M(a) ? a.every((i) => bi(e, i)) : !1;
}
function D(a) {
...
function Yn(a) {
  return !!a && (v(a) || D(a)) && D(a.then) && a[Symbol.toStringTag] === "Promise";
}
function Po(a) {
...
function Ce(a) {
  ...
  let r = n.right - n.left, o = n.bottom - n.top, l = Pt(a), c = Kn(a);
  return {
    top: i,
    bottom: i + o,
    left: e,
...
function er(a, e) {
  return !W(a) || !T(e) ? null : a.classList.contains(e) ? a : er(a.parentElement, e);
}
function ko(a, e) {
...
const Vc = ((a) => typeof a < "u" && ("onorientationchange" in a || typeof a.matchMedia == "function" && a.matchMedia("(any-pointer:coarse)").matches || typeof navigator < "u" && (navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0 || "ontouchstart" in a || a.DocumentTouch && document instanceof a.DocumentTouch)))(typeof window < "u" ? window : {}), zc = {
  idle: 0,
  dragStart: 1,
  dragging: 2
};
...
`;
    ...
    var Y = N(function(m, g, b) {
      for (var S = Object.keys(g), O = 0; O < S.length; )
        (!b || b && m[S[O]] === n) && (m[S[O]] = g[S[O]]), O++;
      return m;
    }, "extend", "Use `assign`."), le = N(function(m, g) {
      return Y(m, g, !0);
    }, "merge", "Use `assign`.");
    function $(u, m, g) {
      var b = m.prototype, S;
    ...
    function Ci(u, m) {
      for (var g, b, S = m[0].toUpperCase() + m.slice(1), O = 0; O < r.length; ) {
        if (g = r[O], b = g ? g + S : m, b in u)
          return b;
        O++;
      }
      return n;
    ...
    var Hh = /mobile|tablet|ip(ad|hone|od)|android/i, Ir = "ontouchstart" in e, _h = Ci(e, "PointerEvent") !== n, Fh = Ir && Hh.test(navigator.userAgent), Wt = "touch", Bh = "pen", Ms = "mouse", Uh = "kinect", Vh = 25, we = 1, gt = 2, ie = 4, Se = 8, Ti = 1, Gt = 2, qt = 4, jt = 8, Xt = 16, We = Gt | qt, yt = jt | Xt, Nr = We | yt, Rr = ["x", "y"], Si = ["clientX", "clientY"];
    function De(u, m) {
      var g = this;
      this.manager = u, this.callback = m, this.element = u.element, this.target = u.options.inputTarget, this.domHandler = function(b) {
        Q(u.options.enable, [u]) && g.handler(b);
      }, this.init();
    }
    De.prototype = {
      handler: function() {
    ...
    function zh(u) {
      ...
      return g ? m = g : _h ? m = As : Fh ? m = Mi : Ir ? m = Os : m = Pi, new m(u, Wh);
    }
    function Wh(u, m, g) {
      var b = g.pointers.length, S = g.changedPointers.length, O = m & we && b - S === 0, F = m & (ie | Se) && b - S === 0;
      g.isFirst = !!O, g.isFinal = !!F, O && (u.session = {}), g.eventType = m, Gh(u, g), u.emit("hammer.input", g), u.recognize(g), u.session.prevInput = g;
    }
    function Gh(u, m) {
      var g = u.session, b = m.pointers, S = b.length;
      g.firstInput || (g.firstInput = kr(m)), S > 1 && !g.firstMultiple ? g.firstMultiple = kr(m) : S === 1 && (g.firstMultiple = !1);
      var O = g.firstInput, F = g.firstMultiple, ce = F ? F.center : O.center, fe = m.center = $r(b);
      m.timeStamp = f(), m.deltaTime = m.timeStamp - O.timeStamp, m.angle = Ls(ce, fe), m.distance = Ei(ce, fe), qh(g, m), m.offsetDirection = _r(m.deltaX, m.deltaY);
      var xe = Hr(m.deltaTime, m.deltaX, m.deltaY);
      m.overallVelocityX = xe.x, m.overallVelocityY = xe.y, m.overallVelocity = p(xe.x) > p(xe.y) ? xe.x : xe.y, m.scale = F ? Yh(F.pointers, b) : 1, m.rotation = F ? Xh(F.pointers, b) : 0, m.maxPointers = g.prevInput ? m.pointers.length > g.prevInput.maxPointers ? m.pointers.length : g.prevInput.maxPointers : m.pointers.length, jh(g, m);
      var qe = u.element;
      ye(m.srcEvent.target, qe) && (qe = m.srcEvent.target), m.target = qe;
    }
    function qh(u, m) {
      var g = m.center, b = u.offsetDelta || {}, S = u.prevDelta || {}, O = u.prevInput || {};
      (m.eventType === we || O.eventType === ie) && (S = u.prevDelta = {
        x: O.deltaX || 0,
        y: O.deltaY || 0
      }, b = u.offsetDelta = {
        x: g.x,
        y: g.y
      }), m.deltaX = S.x + (g.x - b.x), m.deltaY = S.y + (g.y - b.y);
    }
    function jh(u, m) {
      var g = u.lastInterval || m, b = m.timeStamp - g.timeStamp, S, O, F, ce;
      if (m.eventType != Se && (b > Vh || g.velocity === n)) {
        var fe = m.deltaX - g.deltaX, xe = m.deltaY - g.deltaY, qe = Hr(b, fe, xe);
        O = qe.x, F = qe.y, S = p(qe.x) > p(qe.y) ? qe.x : qe.y, ce = _r(fe, xe), u.lastInterval = m;
      } else
        S = g.velocity, O = g.velocityX, F = g.velocityY, ce = g.direction;
      m.velocity = S, m.velocityX = O, m.velocityY = F, m.direction = ce;
    }
    function kr(u) {
    ...
    function _r(u, m) {
      return u === m ? Ti : p(u) >= p(m) ? u < 0 ? Gt : qt : m < 0 ? jt : Xt;
    }
    function Ei(u, m, g) {
      g || (g = Rr);
      var b = m[g[0]] - u[g[0]], S = m[g[1]] - u[g[1]];
    ...
    function Xh(u, m) {
      return Ls(m[1], m[0], Si) + Ls(u[1], u[0], Si);
    }
    function Yh(u, m) {
      return Ei(m[0], m[1], Si) / Ei(u[0], u[1], Si);
    }
    var Kh = {
      mousedown: we,
      mousemove: gt,
      mouseup: ie
    }, Zh = "mousedown", Qh = "mousemove mouseup";
    function Pi() {
      this.evEl = Zh, this.evWin = Qh, this.pressed = !1, De.apply(this, arguments);
    }
    $(Pi, De, {
      handler: function(m) {
        var g = Kh[m.type];
        g & we && m.button === 0 && (this.pressed = !0), g & gt && m.which !== 1 && (g = ie), this.pressed && (g & ie && (this.pressed = !1), this.callback(this.manager, g, {
          pointers: [m],
          changedPointers: [m],
          pointerType: Ms,
          srcEvent: m
    ...
    $(As, De, {
      handler: function(m) {
        var g = this.store, b = !1, S = m.type.toLowerCase().replace("ms", ""), O = Jh[S], F = ec[m.pointerType] || m.pointerType, ce = F == Wt, fe = ze(g, m.pointerId, "pointerId");
        O & we && (m.button === 0 || ce) ? fe < 0 && (g.push(m), fe = g.length - 1) : O & (ie | Se) && (b = !0), !(fe < 0) && (g[fe] = m, this.callback(this.manager, O, {
          pointers: g,
          changedPointers: [m],
          pointerType: F,
          srcEvent: m
    ...
    var tc = {
      ...
      touchend: ie,
      touchcancel: Se
    }, ic = "touchstart", sc = "touchstart touchmove touchend touchcancel";
    function Ur() {
      this.evTarget = ic, this.evWin = sc, this.started = !1, De.apply(this, arguments);
    }
    $(Ur, De, {
      handler: function(m) {
        var g = tc[m.type];
        if (g === we && (this.started = !0), !!this.started) {
          var b = nc.call(this, m, g);
          g & (ie | Se) && b[0].length - b[1].length === 0 && (this.started = !1), this.callback(this.manager, g, {
            pointers: b[0],
            changedPointers: b[1],
            pointerType: Wt,
            srcEvent: m
    ...
    function nc(u, m) {
      var g = xi(u.touches), b = xi(u.changedTouches);
      return m & (ie | Se) && (g = Or(g.concat(b), "identifier")), [g, b];
    }
    var rc = {
      touchstart: we,
      touchmove: gt,
      touchend: ie,
      touchcancel: Se
    }, ac = "touchstart touchmove touchend touchcancel";
    function Mi() {
      this.evTarget = ac, this.targetIds = {}, De.apply(this, arguments);
    }
    $(Mi, De, {
      handler: function(m) {
        var g = rc[m.type], b = oc.call(this, m, g);
    ...
    function oc(u, m) {
      var g = xi(u.touches), b = this.targetIds;
      if (m & (we | gt) && g.length === 1)
        return b[g[0].identifier] = !0, [g, g];
      var S, O, F = xi(u.changedTouches), ce = [], fe = this.target;
      ...
      for (S = 0; S < F.length; )
        b[F[S].identifier] && ce.push(F[S]), m & (ie | Se) && delete b[F[S].identifier], S++;
      if (ce.length)
        return [
    ...
    function Os() {
      ...
      this.touch = new Mi(this.manager, u), this.mouse = new Pi(this.manager, u), this.primaryTouch = null, this.lastTouches = [];
    }
    $(Os, De, {
      handler: function(m, g, b) {
        var S = b.pointerType == Wt, O = b.pointerType == Ms;
        if (!(O && b.sourceCapabilities && b.sourceCapabilities.firesTouchEvents)) {
          if (S)
            hc.call(this, g, b);
          else if (O && cc.call(this, b))
            return;
          this.callback(p, g, b);
        }
      },
    ...
    function hc(u, m) {
      u & we ? (this.primaryTouch = m.changedPointers[0].identifier, zr.call(this, m)) : u & (ie | Se) && zr.call(this, m);
    }
    function zr(u) {
    ...
    function cc(u) {
      for (var m = u.srcEvent.clientX, g = u.srcEvent.clientY, b = 0; b < this.lastTouches.length; b++) {
        var S = this.lastTouches[b], O = Math.abs(m - S.x), F = Math.abs(g - S.y);
        if (O <= Vr && F <= Vr)
          return !0;
      }
      return !1;
    }
    var Wr = Ci(o.style, "touchAction"), Gr = Wr !== n, qr = "compute", jr = "auto", Ds = "manipulation", vt = "none", Yt = "pan-x", Kt = "pan-y", Li = dc();
    function Is(u, m) {
      this.manager = u, this.set(m);
    }
    Is.prototype = {
      set: function(u) {
        u == qr && (u = this.compute()), Gr && this.manager.element.style && Li[u] && (this.manager.element.style[Wr] = u), this.actions = u.toLowerCase().trim();
      },
      update: function() {
      ...
      compute: function() {
        ...
        return L(this.manager.recognizers, function(m) {
          Q(m.options.enable, [m]) && (u = u.concat(m.getTouchAction()));
        }), uc(u.join(" "));
      },
      preventDefaults: function(u) {
        ...
        var b = this.actions, S = _(b, vt) && !Li[vt], O = _(b, Kt) && !Li[Kt], F = _(b, Yt) && !Li[Yt];
        if (S) {
    ...
    function uc(u) {
      if (_(u, vt))
        return vt;
      var m = _(u, Yt), g = _(u, Kt);
      return m && g ? vt : m || g ? m ? Yt : Kt : _(u, Ds) ? Ds : jr;
    }
    function dc() {
      if (!Gr)
        return !1;
    ...
    var Ai = 1, Ie = 2, At = 4, st = 8, Ye = st, Zt = 16, Ge = 32;
    function Ke(u) {
      this.options = k({}, this.defaults, u || {}), this.id = $h(), this.manager = null, this.options.enable = G(this.options.enable, !0), this.state = Ai, this.simultaneous = {}, this.requireFail = [];
    }
    Ke.prototype = {
      defaults: {},
      set: function(u) {
      ...
      dropRecognizeWith: function(u) {
        return E(u, "dropRecognizeWith", this) ? this : (u = Oi(u, this), delete this.simultaneous[u.id], this);
      },
      requireFailure: function(u) {
        if (E(u, "requireFailure", this))
          return this;
        var m = this.requireFail;
        return u = Oi(u, this), ze(m, u) === -1 && (m.push(u), u.requireFailure(this)), this;
      },
      dropRequireFailure: function(u) {
        if (E(u, "dropRequireFailure", this))
          return this;
        u = Oi(u, this);
        var m = ze(this.requireFail, u);
      ...
      emit: function(u) {
        ...
        g < st && b(m.options.event + Xr(g)), b(m.options.event), u.additionalEvent && b(u.additionalEvent), g >= st && b(m.options.event + Xr(g));
      },
      tryEmit: function(u) {
        if (this.canEmit())
          return this.emit(u);
      ...
      canEmit: function() {
        for (var u = 0; u < this.requireFail.length; ) {
          if (!(this.requireFail[u].state & (Ge | Ai)))
            return !1;
          u++;
        }
        return !0;
      ...
      recognize: function(u) {
        var m = k({}, u);
        if (!Q(this.options.enable, [this, m])) {
          this.reset(), this.state = Ge;
          return;
        }
        this.state & (Ye | Zt | Ge) && (this.state = Ai), this.state = this.process(m), this.state & (Ie | At | st | Zt) && this.tryEmit(m);
      },
      process: function(u) {
      },
    ...
    $(_e, Ke, {
      ...
      process: function(u) {
        var m = this.state, g = u.eventType, b = m & (Ie | At), S = this.attrTest(u);
        return b && (g & Se || !S) ? m | Zt : b || S ? g & ie ? m | st : m & Ie ? m | At : Ie : Ge;
      }
    });
    function Di() {
    ...
    $(Di, _e, {
      ...
      getTouchAction: function() {
        ...
        return u & We && m.push(Kt), u & yt && m.push(Yt), m;
      },
      directionTest: function(u) {
        var m = this.options, g = !0, b = u.distance, S = u.direction, O = u.deltaX, F = u.deltaY;
        return S & m.direction || (m.direction & We ? (S = O === 0 ? Ti : O < 0 ? Gt : qt, g = O != this.pX, b = Math.abs(u.deltaX)) : (S = F === 0 ? Ti : F < 0 ? jt : Xt, g = F != this.pY, b = Math.abs(u.deltaY))), u.direction = S, g && b > m.threshold && S & m.direction;
      },
      attrTest: function(u) {
    ...
    $(Rs, Ke, {
      ...
      process: function(u) {
        var m = this.options, g = u.pointers.length === m.pointers, b = u.distance < m.threshold, S = u.deltaTime > m.time;
        if (this._input = u, !b || !g || u.eventType & (ie | Se) && !S)
          this.reset();
      ...
      emit: function(u) {
        this.state === Ye && (u && u.eventType & ie ? this.manager.emit(this.options.event + "up", u) : (this._input.timeStamp = f(), this.manager.emit(this.options.event, this._input)));
      }
    });
    function ks() {
      _e.apply(this, arguments);
    ...
    $($s, _e, {
      ...
      getTouchAction: function() {
        return Di.prototype.getTouchAction.call(this);
      },
      attrTest: function(u) {
        var m = this.options.direction, g;
        return m & (We | yt) ? g = u.overallVelocity : m & We ? g = u.overallVelocityX : m & yt && (g = u.overallVelocityY), this._super.attrTest.call(this, u) && m & u.offsetDirection && u.distance > this.options.threshold && u.maxPointers == this.options.pointers && p(g) > this.options.velocity && u.eventType & ie;
      },
      emit: function(u) {
        var m = Yr(u.offsetDirection);
    ...
    $(Ii, Ke, {
      ...
      process: function(u) {
        ...
        if (b && S && g) {
          if (u.eventType != ie)
            return this.failTimeout();
          var O = this.pTime ? u.timeStamp - this.pTime < m.interval : !0, F = !this.pCenter || Ei(this.pCenter, u.center) < m.posThreshold;
          this.pTime = u.timeStamp, this.pCenter = u.center, !F || !O ? this.count = 1 : this.count += 1, this._input = u;
          var ce = this.count % m.taps;
          if (ce === 0)
            return this.hasRequireFailures() ? (this._timer = C(function() {
              this.state = Ye, this.tryEmit();
            }, m.interval, this), Ie) : Ye;
        }
        return Ge;
      },
    ...
    function nt(u, m) {
      return m = m || {}, m.recognizers = G(m.recognizers, nt.defaults.preset), new Hs(u, m);
    }
    nt.VERSION = "2.0.7", nt.defaults = {
      ...
      preset: [
        ...
        [Ns, { enable: !1 }, ["rotate"]],
        [$s, { direction: We }],
        [Di, { direction: We }, ["swipe"]],
        [Ii],
        [Ii, { event: "doubletap", taps: 2 }, ["tap"]],
        [Rs]
      ],
      cssProps: {
        userSelect: "none",
    ...
    var mc = 1, Kr = 2;
    function Hs(u, m) {
      this.options = k({}, nt.defaults, m || {}), this.options.inputTarget = this.options.inputTarget || u, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = u, this.input = zh(this), this.touchAction = new Is(this, this.options.touchAction), Zr(this, !0), L(this.options.recognizers, function(g) {
    ...
    Hs.prototype = {
      ...
      stop: function(u) {
        this.session.stopped = u ? Kr : mc;
      },
      recognize: function(u) {
        var p = this.session;
        if (!p.stopped) {
          this.touchAction.preventDefaults(u);
          var g, b = this.recognizers, S = m.curRecognizer;
          (!S || S && S.state & Ye) && (S = m.curRecognizer = null);
          for (var O = 0; O < b.length; )
            g = b[O], m.stopped !== Kr && (!S || g == S || g.canRecognizeWith(S)) ? g.recognize(u) : g.reset(), !S && g.state & (Ie | At | st) && (S = m.curRecognizer = g), O++;
        }
      },
      get: function(u) {
        if (u instanceof Ke)
      ...
      remove: function(u) {
        if (E(u, "remove", this))
          return this;
        if (u = this.get(u), u) {
          var m = this.recognizers, g = ze(m, u);
      ...
      off: function(u, p) {
        if (u !== n) {
          var g = this.handlers;
          return L(U(u), function(b) {
            m ? g[b] && g[b].splice(ze(g[b], m), 1) : delete g[b];
          }), this;
        }
      },
      emit: function(u, m) {
        this.options.domEvents && pc(u, m);
    ...
    function Zr(u, m) {
      ...
      if (g.style) {
        ...
        L(u.options.cssProps, function(S, O) {
          b = Ci(g.style, O), m ? (u.oldCssProps[b] = g.style[b], g.style[b] = S) : g.style[b] = u.oldCssProps[b] || "";
        }), m || (u.oldCssProps = {});
      }
    }
    function pc(u, m) {
    ...
    var fc = typeof e < "u" ? e : typeof self < "u" ? self : {};
    fc.Hammer = nt, a.exports ? a.exports = nt : e[s] = nt;
  })(window, document, "Hammer");
})($o);
var wi = $o.exports;
const Gc = Wc(wi), je = /* @__PURE__ */ gc({
  __proto__: null,
  default: Gc
}, [wi]), Ho = 1, _o = 2, Cn = 4, qc = {
  mousedown: Ho,
  mousemove: _o,
  mouseup: Cn
};
...
function Xc(a) {
  ...
  a.prototype.handler = function(s) {
    const n = this.store;
    s.button > 0 && s.type === "pointerdown" && (jc(n, (r) => r.pointerId === s.pointerId) || n.push(s)), e.call(this, s);
  };
}
function Yc(a) {
  a.prototype.handler = function(i) {
    let s = qc[i.type];
    s & Ho && i.button >= 0 && (this.pressed = !0), s & _o && i.which === 0 && (s = Cn), this.pressed && (s & Cn && (this.pressed = !1), this.callback(this.manager, s, {
      pointers: [i],
      changedPointers: [i],
      pointerType: "mouse",
      srcEvent: i
...
}, tu = typeof navigator < "u" && navigator.userAgent ? navigator.userAgent.toLowerCase() : "", Rt = typeof window < "u" ? window : global;
let Tn = !1;
try {
  const a = {
    get passive() {
...
const iu = tu.indexOf("firefox") !== -1, { WHEEL_EVENTS: su } = tr, ra = "wheel", aa = 4.000244140625, nu = 40, ru = 0.25;
class au extends ms {
  constructor(e, i, s) {
    super(e, i, s), this.handleEvent = (n) => {
      if (!this.options.enable)
        return;
      let r = n.deltaY;
      Rt.WheelEvent && (iu && n.deltaMode === Rt.WheelEvent.DOM_DELTA_PIXEL && (r /= Rt.devicePixelRatio), n.deltaMode === Rt.WheelEvent.DOM_DELTA_LINE && (r *= nu)), r !== 0 && r % aa === 0 && (r = Math.floor(r / aa)), n.shiftKey && r && (r = r * ru), this.callback({
        type: ra,
        center: {
          x: n.clientX,
          y: n.clientY
    ...
    }, this.events = (this.options.events || []).concat(su), this.events.forEach((n) => e.addEventListener(n, this.handleEvent, Tn ? { passive: !1 } : !1));
  }
  destroy() {
...
const { MOUSE_EVENTS: ou } = tr, oa = "pointermove", la = "pointerover", ha = "pointerout", ca = "pointerenter", ua = "pointerleave";
class lu extends ms {
  constructor(e, i, s) {
    ...
    this.enableMoveEvent = n, this.enableLeaveEvent = n, this.enableEnterEvent = n, this.enableOutEvent = n, this.enableOverEvent = n, this.events = (this.options.events || []).concat(ou), this.events.forEach((r) => e.addEventListener(r, this.handleEvent));
  }
  destroy() {
    this.events.forEach((e) => this.element.removeEventListener(e, this.handleEvent));
  }
...
const { KEY_EVENTS: hu } = tr, da = "keydown", ma = "keyup";
class cu extends ms {
  constructor(e, i, s) {
    super(e, i, s), this.handleEvent = (n) => {
    ...
    }, this.enableDownEvent = this.options.enable, this.enableUpEvent = this.options.enable, this.events = (this.options.events || []).concat(hu), e.tabIndex = this.options.tabIndex || 0, e.style.outline = "none", this.events.forEach((n) => e.addEventListener(n, this.handleEvent));
  }
  destroy() {
    this.events.forEach((e) => this.element.removeEventListener(e, this.handleEvent));
  }
...
const Sn = 1, is = 2, En = 4, du = {
  ...
  mousemove: is,
  mouseup: En
}, mu = 1, pu = 2, fu = 3, gu = 0, yu = 1, vu = 2, bu = 1, wu = 2, xu = 4;
function Cu(a) {
  const e = du[a.srcEvent.type];
  if (!e)
    return null;
  const { buttons: i, button: s, which: n } = a.srcEvent;
  let r = !1, o = !1, l = !1;
  return e === En || e === is && !Number.isFinite(i) ? (r = n === mu, o = n === pu, l = n === fu) : e === is ? (r = !!(i & bu), o = !!(i & xu), l = !!(i & wu)) : e === Sn && (r = s === gu, o = s === yu, l = s === vu), { leftButton: r, middleButton: o, rightButton: l };
}
function Tu(a, e) {
  const i = a.center;
  if (!i)
...
class Su {
  ...
  add(e, i, s, n = !1, r = !1) {
    ...
    let c = Fs;
    typeof s == "string" || s && s.addEventListener ? c = { ...Fs, srcElement: s } : s && (c = { ...Fs, ...s });
...
class Pu {
  constructor(e = null, i) {
    this._onBasicInput = (n) => {
      const { srcEvent: r } = n, o = Jc[r.type];
      o && this.manager.emit(o, n);
    }, this._onOtherEvent = (n) => {
      this.manager.emit(n.type, n);
    }, this.options = { ...Eu, ...i }, this.events = /* @__PURE__ */ new Map(), this.setElement(e);
  ...
  setElement(e) {
    ...
    this.wheelInput = new au(e, this._onOtherEvent, {
      enable: !1
    }), this.moveInput = new lu(e, this._onOtherEvent, {
      enable: !1
    }), this.keyInput = new cu(e, this._onOtherEvent, {
      enable: !1,
      tabIndex: i.tabIndex
    }), this.contextmenuInput = new uu(e, this._onOtherEvent, {
      enable: !1
    });
  ...
  _addEventHandler(e, i, s, n, r) {
    ...
    let p = l.get(c);
    p || (p = new Su(this), l.set(c, p), p.recognizerName = eu[c] || c, o && o.on(c, p.handleEvent)), p.add(e, i, s, n, r), p.isEmpty() || this._toggleRecognizer(p.recognizerName, !0);
  }
...
class Xe {
  ...
  pad = { left: !1 };
  constructor(e, i) {
    if (this.#e = { ...Mu, ...i }, this.#s = zc.idle, this.#h = Vc, this.#t = e, !this.#t && this.#e.elementId && (this.#t = document.getElementById(this.#e.elementId)), !W(this.#t))
...
function Fi(a) {
  const e = {};
  return e.value = a, e.sign = !!a, e.integers = Fo(a), e.decimals = Au(a), e.total = e.integers + e.decimals, e;
}
function Fo(a) {
...
let Du = Object.prototype.hasOwnProperty;
function Iu(a, e, i = void 0) {
...
function Ve(a, e) {
  return !v(a) || !v(e) ? e : (Object.keys(e).forEach((i) => {
    const s = a[i], n = e[i];
    M(s) && M(n) ? a[i] = Ve(s.concat([]), n) : v(s) && v(n) ? a[i] = Ve(Object.assign({}, s), n) : a[i] = n;
  }), a);
}
function ir(a, e = !0) {
  if (a === null || typeof a != "object" || "isActiveClone" in a)
    return a;
  let i;
  a instanceof Date ? i = new a.constructor() : i = M(a) ? [] : {};
  for (let s in a)
    Object.prototype.hasOwnProperty.call(a, s) && (a.isActiveClone = null, i[s] = ir(a[s], !1), delete a.isActiveClone);
  return i;
}
function Z(a) {
  try {
...
function ps(a, e) {
  if (!M(a) || !M(e) || a.length !== e.length) return !1;
  let i = a.length;
  for (; i--; ) {
    if (M(a[i]) || M(e[i])) {
...
function fs(a, e) {
  return M(e) ? M(a) ? a.every((i) => e.includes(i)) : e.includes(a) : !1;
}
const Fu = (a) => [...new Set(a)], Bu = (a, e) => Object.values(a.reduce((i, s) => (i[e(s)] = s, i), {})), Uu = (a, e) => a.filter((i) => e.includes(i)), di = (a, e) => a.filter((i) => !e.includes(i)), Vu = (a, e) => di(a, e).concat(di(e, a)), zu = (a, e) => di(a, e).concat(e);
function Wu(a) {
...
function ri(a, e) {
  ...
  return i.length !== s.length ? !1 : i.every((r, o) => {
    const l = a[r], c = e[s[o]];
    return M(l) || M(c) ? ps(l, c) : v(l) || v(c) ? ri(l, c) : l === c;
  });
}
function ne(a = "ID") {
...
class me extends Map {
  ...
  setMultiple(e) {
    return M(e) ? (e.forEach(([i, s]) => this.set(i, s)), !0) : !1;
  }
  populate(e) {
    return M(e) ? (this.clear(), e.forEach(([i, s]) => this.set(i, s)), !0) : !1;
  }
  insertIndex(e, i, s) {
    if (!P(e)) return !1;
    const n = [...this];
...
class se {
  ...
  static isValid(e, i, s, n) {
    return !v(e) || !W(i) || !T(s) || !D(n);
  }
  static add(e, i, s, n) {
    if (!this.isValid(e, i, s, n)) return !1;
    i.addEventListener(s, n), se.#e.has(e) || se.#e.set(e, new me());
    const r = se.#e.get(e);
    r.has(i) || r.set(i, {});
    const o = r.get(i);
    return M(o[s]) || (o[s] = []), o[s].push(n), !0;
  }
...
const b1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  cyrb53: nr,
  debounce: Oe,
  decodePNGDataStore: Qu,
  diff: di,
  doStructuredClone: Z,
  encodePNGDataStore: Zu,
  extender: Xu,
  findInObjectById: Vo,
  firstEntryInMap: qo,
  firstKeyInMap: jo,
...
class ss {
  ...
  constructor(e, i, s) {
    ...
    this.#e = ne(`${ut}_Range`), this.#n = !0, this.setConfig(s);
    let n;
    if (I(s?.interval) ? n = s.interval : T(s?.interval) ? n = it(s?.interval) : n = as, this.data.length == 0) {
      let r = Date.now();
    ...
    (!I(e) || this.isPastLimit(e)) && (e = this.data.length - this.#d), (!I(i) || this.isFutureLimit(i)) && (i = this.data.length), i - e > this.#y && (i = i - (i - e - this.#y)), i == 0 && this.data.length >= this.rangeLimit ? i = this.rangeLimit : i == 0 && (i = this.data.length), this.set(e, i), `${this.maxMinPriceVol.toString()}`;
  }
  get id() {
    return this.#e;
  }
  ...
  set(e = 0, i = this.dataLength, s = this.maxCandles) {
    ...
    let p = this.Length;
    return this.#h = e, this.#o = i, p -= this.Length, this.setMaxCandles(s), this.setAllMaxMin(), (this.#n || this.#u.valueMax != this.valueMax || this.#u.valueMin != this.valueMin) && this.#t.emit("range_valueMaxMin", { max: this.valueMax, min: this.valueMin }), this.#t.emit("range_set", [r, o, l, c]), !0;
  }
  setConfig(e) {
    let i = e?.state;
    this.#i = i;
    ...
    this.#t = s;
    let n = I(e?.initialCnt) ? e.initialCnt : Nn;
    this.#d = this.#t.config?.range?.initialCnt || n, this.#m = I(e?.limitFuture) ? e.limitFuture : Ui, this.#p = I(e?.limitPast) ? e.limitPast : Rn, this.#b = P(e?.yAxisBounds) ? e.yAxisBounds : In, this.#g = I(e?.minCandles) ? e.minCandles : kn, this.setMaxCandles(e?.maxCandles);
  }
  setMaxCandles(e) {
    let i = this.#t?.MainPane?.graph?.width || Math.floor(this.#t?.parentElement?.clientWidth) || $n;
    this.#y = I(e) ? e : i;
  }
  setMaxMin(e) {
    for (let i in e)
  ...
  maxMinPriceVol(e) {
    ...
    let c = he(s, 0, l), p = he(n, 0, l), f = i[c][3] || 1 / 0, C = i[c][2] || -1 / 0, E = i[c][5] || 1 / 0, L = i[c][5] || -1 / 0, N = c, k = c, Y = c, le = c, $;
    for (; c++ < p; )
      $ = i[c][3], P($) && $ < f && (f = $, N = c), $ = i[c][2], P($) && $ > C && (C = $, k = c), $ = i[c][5], P($) && $ < E && (E = $, Y = c), P($) && $ > L && (L = $, le = c);
    let re = C - f, Q = f, G = C;
    return f -= re * r.yAxisBounds, f = f > 0 ? f : 0, C += re * r.yAxisBounds, re = C - f, {
      valueLo: Q,
      valueHi: G,
      valueMin: f,
      valueMax: C,
  ...
  maxMinData(e) {
    let { data: i, start: s, end: n, that: r } = { ...e }, o = Ue(this.#t.bufferPx / this.#t.candleW), l = i.length - 1, c = this.dataLength - i.length, p = i[0]?.length - 1 || 0;
    const f = {}, C = {
      min: 0,
      max: 1,
      minIdx: 0,
    ...
    if (o = I(o) ? o : 0, s = I(s) ? s - o : 0, s = s > 0 ? s - c : 0, n = I(n) ? n - c : l, l < 0 || i[0].length == 0)
      return f;
    let E = B(s, 0, l), L = B(n, 0, l), N, k, Y, le, $, re, Q;
    for (let G in f) {
      for (le = i[E][p] || -1 / 0, Y = i[E][p] || 1 / 0, N = E; N++ < L; )
        k = i[N][p], P && (k <= Y && (f[G].min = k, f[G].minIdx = N, Y = k), k >= le && (f[G].max = k, f[G].maxIdx = N, le = k));
      (re === void 0 || Y < re) && (re = Y), (Q === void 0 || le > Q) && (Q = le), $ = f[G].max - f[G].min, f[G].diff = isNaN($) ? 0 : $, --p;
    }
    return f.data = {
      min: re,
      max: Q,
...
const td = [
  ...
  "timeStart",
  "yAxisBounds"
], tl = ["y", "M", "d", "h", "m", "s", "ms"], il = ["years", "months", "days", "hours", "minutes", "seconds", "milliseconds"], id = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334], sd = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335], sl = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], nd = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], ai = 1231006505e3, ot = 1, oe = 1e3, J = oe * 60, ge = J * 60, q = ge * 24, Ft = q * 7, Ae = q * 30;
function nl(a = 3, e = !1) {
  let i = sl[a % 12] * q;
  return e && a > 0 && (i += q), i;
}
const $e = q * 365, pi = {
  ...
  HOUR2: [ge * 2, "hours", 2],
  HOUR: [ge, "hours", 1],
  MINUTE30: [J * 30, "minutes", 30],
  MINUTE15: [J * 15, "minutes", 15],
  MINUTE10: [J * 10, "minutes", 10],
  MINUTE5: [J * 5, "minutes", 5],
  MINUTE3: [J * 3, "minutes", 3],
  MINUTE2: [J * 2, "minutes", 2],
  MINUTE: [J, "minutes", 1],
  SECOND30: [oe * 30, "seconds", 30],
  SECOND15: [oe * 15, "seconds", 15],
  SECOND10: [oe * 10, "seconds", 10],
  SECOND5: [oe * 5, "seconds", 5],
  SECOND2: [oe * 2, "seconds", 2],
  SECOND: [oe, "seconds", 1],
...
}, al = J, ad = al, ol = tt.YEARS10[0], od = ol, ld = () => {
...
function pd(a, e) {
  let i = rt.inYears(a, e), s = rt.inMonths(a, e), n = rt.inWeeks(a, e), r = rt.inDays(a, e), o = rt.inHours(a, e), l = rt.inMinutes(a, e), c = rt.inSeconds(a, e), p = new Date(e).getTime() - new Date(a).getTime();
  return {
    y: i,
    M: s,
    w: n,
...
function rr(a) {
  return I(a) && !(a < oe) && a !== 1 / 0;
}
function gs(a) {
  let e = oe;
  return T(a) ? (e = it(a), e ? a = a : (e = oe, a = "1s")) : I(a) ? (e = a, a = Te(a)) : a = "1s", { tf: a, ms: e };
}
function it(a) {
  if (!T(a)) return !1;
...
function pr(a) {
  let e, i, s, n;
  return e = String(cr(a)), i = String(cl(a)).padStart(2, "0"), s = String(hl(a)).padStart(2, "0"), n = String(ll(a)).padStart(2, "0"), { d: e, h: i, m: s, s: n };
}
function vd(a, e) {
...
class yl {
  ...
  constructor(e) {
    e instanceof ss && (this.#e = e), this.setTimeZone(Intl.DateTimeFormat().resolvedOptions().timeZone);
  }
  get range() {
    return this.#e;
  }
...
const bd = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  time_start: Bi,
  timestampDiff: rt,
  timestampDifference: pd,
  unitRange: gd,
  year_start: mr
}, Symbol.toStringTag, { value: "Module" })), wd = J, rs = "1m", as = wd, va = 0.05, xd = 100, ba = 100, In = 0.3, vs = 1.04, Ot = 8;
class R {
...
const w1 = R.types, Nn = 30, Ui = 200, Rn = 200, kn = 20, $n = 1920, bs = 5, wa = 50, xa = 30, Cd = 8, Hn = 30, Td = [!0, "top"];
class de {
  static t = 0;
  static o = 1;
  static h = 2;
...
class Ee {
  ...
  static type = "divider";
  static create(e, i) {
    const s = `${i.core.ID}_divider_${++Ee.divideCnt}`;
    return i.id = s, Ee.dividerList[s] = new Ee(e, i), Ee.dividerList[s];
  }
  static destroy() {
    for (let e in Ee.dividerList)
      Ee.dividerList[e].destroy(), delete Ee.dividerList[e];
  }
  static defaultNode() {
    return `
  ...
  constructor(e, i) {
    const s = { ...i };
    this.#n = e, this.#t = s.core, this.#i = s, this.#s = s.core.theme, this.#e = s.id, this.#r = s.chartPane, this.#a = e.elements[Ee.type], this.init();
  }
  get el() {
    return this.#l;
  }
  ...
  destroy() {
    this.#c.destroy(), this.el.remove(), delete Ee.dividerList[this.id];
  }
  eventsListen() {
  ...
  dividerNode() {
    ...
    let s = P(this.config.dividerHeight) ? this.config.dividerHeight : Cd, n = this.#t.elBody.tools.width;
...
const Sd = '<svg width="46.08" height="46.08" viewBox="-51.2 -51.2 614.4 614.4" ><path d="M471.993 112h-89.2l-16.242-46.75a32.023 32.023 0 00-30.229-21.5H175.241a31.991 31.991 0 00-30.294 21.691L129.1 112H40a24.027 24.027 0 00-24 24v312a24.027 24.027 0 0024 24h431.993a24.027 24.027 0 0024-24V136a24.027 24.027 0 00-24-24zm-8 328H48.007V144h104.01l23.224-68.25h161.081l23.71 68.25h103.961z" class="ci-primary"></path><path d="M256 168a114 114 0 10114 114 114.13 114.13 0 00-114-114zm0 196a82 82 0 1182-82 82.093 82.093 0 01-82 82z"></path></svg>', Ed = '<svg width="46.08" height="46.08" viewBox="-51.2 -51.2 614.4 614.4"><path d="M376 160v32h65.372L252 381.373l-72-72L76.686 412.686l22.628 22.628L180 354.627l72 72 212-211.999V280h32V160H376z"></path><path d="M48 104H16v392h480v-32H48V104z"></path></svg>', Pd = '<svg width="46.08" height="46.08" viewBox="-51.2 -51.2 614.4 614.4"><path d="M271.514 95.5h-32v178.111l115.613 54.948 13.737-28.902-97.35-46.268V95.5z"></path><path d="M256 16C123.452 16 16 123.452 16 256s107.452 240 240 240 240-107.452 240-240S388.548 16 256 16zm0 448c-114.875 0-208-93.125-208-208S141.125 48 256 48s208 93.125 208 208-93.125 208-208 208z"></path></svg>', bl = '<svg width="46.08" height="46.08" viewBox="-51.2 -51.2 614.4 614.4"><path d="M245.151 168a88 88 0 1088 88 88.1 88.1 0 00-88-88zm0 144a56 56 0 1156-56 56.063 56.063 0 01-56 56z"></path><path d="M464.7 322.319l-31.77-26.153a193.081 193.081 0 000-80.332l31.77-26.153a19.941 19.941 0 004.606-25.439l-32.612-56.483a19.936 19.936 0 00-24.337-8.73l-38.561 14.447a192.038 192.038 0 00-69.54-40.192l-6.766-40.571A19.936 19.936 0 00277.762 16H212.54a19.937 19.937 0 00-19.728 16.712l-6.762 40.572a192.03 192.03 0 00-69.54 40.192L77.945 99.027a19.937 19.937 0 00-24.334 8.731L21 164.245a19.94 19.94 0 004.61 25.438l31.767 26.151a193.081 193.081 0 000 80.332l-31.77 26.153A19.942 19.942 0 0021 347.758l32.612 56.483a19.937 19.937 0 0024.337 8.73l38.562-14.447a192.03 192.03 0 0069.54 40.192l6.762 40.571A19.937 19.937 0 00212.54 496h65.222a19.936 19.936 0 0019.728-16.712l6.763-40.572a192.038 192.038 0 0069.54-40.192l38.564 14.449a19.938 19.938 0 0024.334-8.731l32.609-56.487a19.939 19.939 0 00-4.6-25.436zm-50.636 57.12l-48.109-18.024-7.285 7.334a159.955 159.955 0 01-72.625 41.973l-10 2.636L267.6 464h-44.89l-8.442-50.642-10-2.636a159.955 159.955 0 01-72.625-41.973l-7.285-7.334-48.117 18.024L53.8 340.562l39.629-32.624-2.7-9.973a160.9 160.9 0 010-83.93l2.7-9.972L53.8 171.439l22.446-38.878 48.109 18.024 7.285-7.334a159.955 159.955 0 0172.625-41.973l10-2.636L222.706 48H267.6l8.442 50.642 10 2.636a159.955 159.955 0 0172.625 41.973l7.285 7.334 48.109-18.024 22.447 38.877-39.629 32.625 2.7 9.972a160.9 160.9 0 010 83.93l-2.7 9.973 39.629 32.623z"></path></svg>', Md = '<svg width="46.08" height="46.08" version="1.1" viewBox="-51.2 -51.2 614.4 614.4"><rect x="16" y="240.18" width="188.84" height="31.635"/><g transform="translate(-3.3234e-7 -112.18)"><rect x="307.16" y="352.37" width="188.84" height="31.635"/></g><rect transform="rotate(-90)" x="-496" y="240.18" width="188.84" height="31.635"/><rect transform="rotate(-90)" x="-204.84" y="240.18" width="188.84" height="31.635"/></svg>', Ld = '<svg width="46.08" height="46.08" viewBox="0 0 24 24"><path fill="none" d="M0 0h24v24H0z"></path><path d="M6.535 3H21a1 1 0 011 1v16a1 1 0 01-1 1H6.535a1 1 0 01-.832-.445l-5.333-8a1 1 0 010-1.11l5.333-8A1 1 0 016.535 3zm.535 2l-4.666 7 4.666 7H20V5H7.07zM13 10.586l2.828-2.829 1.415 1.415L14.414 12l2.829 2.828-1.415 1.415L13 13.414l-2.828 2.829-1.415-1.415L11.586 12 8.757 9.172l1.415-1.415L13 10.586z"></path></svg>', Ad = '<svg width="46.08" height="46.08" version="1.1" viewBox="-51.2 -51.2 614.4 614.4"><g stroke-width="30.155"><rect x="14.757" y="240.92" width="482.49" height="30.155" rx="15.078"/><rect x="14.757" y="147" width="482.49" height="30.155" rx="15.078"/><rect x="14.757" y="334.84" width="482.49" height="30.155" rx="15.078"/></g ><g transform="translate(5.937 -288.34)"><path d="m23.904 712.34c-8.3532 0-15.078 6.7252-15.078 15.078s6.7249 15.078 15.078 15.078h173.93c-0.65295-3.3651-2.0312-6.4697-2.0312-10.026 0-7.1393 1.5573-13.888 4.0625-20.13zm276.35 0c2.5051 6.2423 4.0365 12.991 4.0365 20.13 0 3.5554-1.3526 6.6618-2.0052 10.026h173.93c8.3532 0 15.078-6.7252 15.078-15.078s-6.7249-15.078-15.078-15.078z"/><path d="m250.06 759.97c17.965 0 32.545-14.58 32.545-32.545 0-17.965-14.58-32.545-32.545-32.545-17.965 0-32.545 14.58-32.545 32.545 0 17.965 14.58 32.545 32.545 32.545zm0 21.697c-29.964 0-54.242-24.279-54.242-54.242 0-29.964 24.279-54.242 54.242-54.242 29.964 0 54.242 24.279 54.242 54.242 0 29.964-24.279 54.242-54.242 54.242z" stroke-width="21.697"/></g ><path d="m144.05 18.672c-24.694 0-45.285 16.595-51.849 39.167h-62.37c-8.3532 0-15.078 6.7252-15.078 15.078s6.7249 15.078 15.078 15.078h62.37c6.5639 22.572 27.155 39.167 51.849 39.167s45.285-16.595 51.849-39.167h120.03c6.5639 22.572 27.155 39.167 51.849 39.167 24.694 0 45.285-16.595 51.849-39.167h62.552c8.3532 0 15.078-6.7252 15.078-15.078s-6.7249-15.078-15.078-15.078h-62.552c-6.5639-22.572-27.155-39.167-51.849-39.167-24.694 0-45.285 16.595-51.849 39.167h-120.03c-6.5639-22.572-27.155-39.167-51.849-39.167zm0 21.693c17.965 0 32.552 14.587 32.552 32.552 0 17.965-14.587 32.552-32.552 32.552-17.965 1e-5 -32.552-14.587-32.552-32.552 0-17.965 14.587-32.552 32.552-32.552zm223.72 0c17.965 0 32.552 14.587 32.552 32.552 0 17.965-14.587 32.552-32.552 32.552-17.965 0-32.552-14.587-32.552-32.552 0-17.965 14.587-32.552 32.552-32.552z" stroke-width="30.155"/></svg>', bt = '<svg width="46.08" height="46.08" version="1.1" viewBox="-51.2 -51.2 614.4 614.4"><g transform="matrix(21.697 0 0 21.697 -47.758 -47.758)"><path d="m7.354 21.354 14-14-0.707-0.707-14 14z"/><path d="m22.5 7c0.828 0 1.5-0.672 1.5-1.5s-0.672-1.5-1.5-1.5-1.5 0.672-1.5 1.5 0.672 1.5 1.5 1.5zm0 1c-1.381 0-2.5-1.119-2.5-2.5s1.119-2.5 2.5-2.5 2.5 1.119 2.5 2.5-1.119 2.5-2.5 2.5zm-17 16c0.828 0 1.5-0.672 1.5-1.5s-0.672-1.5-1.5-1.5-1.5 0.672-1.5 1.5 0.672 1.5 1.5 1.5zm0 1c-1.381 0-2.5-1.119-2.5-2.5s1.119-2.5 2.5-2.5 2.5 1.119 2.5 2.5-1.119 2.5-2.5 2.5z"/></g></svg>', Od = '<svg width="46.08" height="46.08" viewBox="0 0 32 32"><path d="M 3.2758709,20.241377 11.758622,28.72413 28.72413,11.758622 20.241377,3.2758709 Z m 2.1206881,0 1.5905161,-1.590515 3.7112049,3.711203 1.060342,-1.060345 -3.7112027,-3.711204 1.0603441,-1.060344 2.1206876,2.12069 1.060346,-1.060346 -2.120689,-2.120688 1.060343,-1.060344 3.711203,3.711203 L 16,17.060346 l -3.711203,-3.711208 1.060341,-1.060341 2.12069,2.120687 1.060344,-1.060346 -2.120688,-2.120687 1.060344,-1.060343 3.711204,3.711205 1.060345,-1.060345 -3.711205,-3.7112046 1.060344,-1.0603441 2.120687,2.1206887 1.060346,-1.0603446 -2.120687,-2.1206883 1.590515,-1.5905161 6.362065,6.362063 -14.84482,14.84482 z" style="stroke-width:0.749776" /></svg>', Dd = '<svg width="46.08" height="46.08" viewBox="-51.2 -51.2 614.4 614.4"><g id="g930" transform="matrix(21.128963,0,0,21.128963,-29.235597,-50.369964)"><path clip-rule="evenodd" d="m 4.5,5 a 1.5,1.5 0 1 0 0,3 1.5,1.5 0 0 0 0,-3 z M 2,6.5 A 2.5,2.5 0 0 1 6.95,6 H 24 V 7 H 6.95 A 2.5,2.5 0 0 1 2,6.5 Z M 4.5,15 a 1.5,1.5 0 1 0 0,3 1.5,1.5 0 0 0 0,-3 z M 2,16.5 A 2.5,2.5 0 0 1 6.95,16 h 13.1 a 2.5,2.5 0 1 1 0,1 H 6.95 A 2.5,2.5 0 0 1 2,16.5 Z M 22.5,15 a 1.5,1.5 0 1 0 0,3 1.5,1.5 0 0 0 0,-3 z m -18,6 a 1.5,1.5 0 1 0 0,3 1.5,1.5 0 0 0 0,-3 z M 2,22.5 A 2.5,2.5 0 0 1 6.95,22 H 24 v 1 H 6.95 A 2.5,2.5 0 0 1 2,22.5 Z" id="path908" /><path clip-rule="evenodd" d="M 22.4,8.94 21.01,9.57 20.6,8.66 21.99,8.03 Z m -4,1.8 -1.39,0.63 -0.41,-0.91 1.39,-0.63 z m -4,1.8 -1.4,0.63 -0.4,-0.91 1.39,-0.63 z m -4,1.8 L 9,14.97 8.6,14.06 9.99,13.43 Z" id="path910" /></g></svg>', Id = '<svg width="46.08" height="46.08" viewBox="-51.2 -51.2 614.4 614.4"><path d="M231.359 147l-80.921 205h45.155l15.593-39.5h89.628l15.593 39.5h45.155l-80.921-205zm-3.594 123.5L256 198.967l28.235 71.533z"></path><path d="M384 56H128V16H16v112h40v256H16v112h112v-40h256v40h112V384h-40V128h40V16H384zM48 96V48h48v48zm48 368H48v-48h48zm288-40H128v-40H88V128h40V88h256v40h40v256h-40zm80-8v48h-48v-48zM416 48h48v48h-48z"></path></svg>', Nd = '<svg style="width: 46px; height: 46px" viewBox="-1.6 -1.6 19.2 19.2"><path d="M 15,2 C 15,1.4477153 14.552285,1 14,1 H 2 C 1.4477153,1 1,1.4477153 1,2 v 12 c 0,0.552285 0.4477153,1 1,1 h 12 c 0.552285,0 1,-0.447715 1,-1 z M 0,2 C 0,0.8954305 0.8954305,0 2,0 h 12 c 1.104569,0 2,0.8954305 2,2 v 12 c 0,1.104569 -0.895431,2 -2,2 H 2 C 0.8954305,16 0,15.104569 0,14 Z" id="path2" /><g id="g718" transform="translate(0,1.2499996)"><path d="M 7.5010125,7.9560661 5.355012,10.103066 c -0.472,0.472 -1.18,-0.2360003 -0.708,-0.7080003 L 7.6470125,6.3950659 c 0.195364,-0.195858 0.512636,-0.195858 0.708,0 l 3.0000005,2.9999998 c 0.472,0.472 -0.236,1.1800003 -0.708,0.7080003 L 8.5010125,7.9560661 c -0.431103,-0.417289 -0.523896,-0.423024 -1,0 z" style="" id="path566-5" /><path d="m 7.4989873,5.5439348 -2.1460003,-2.147 c -0.472,-0.472 -1.18,0.236 -0.708,0.708 l 3.0000003,3 c 0.1953639,0.195858 0.5126361,0.195858 0.708,0 l 2.9999997,-3 c 0.472,-0.472 -0.236,-1.18 -0.708,-0.708 l -2.1459997,2.147 c -0.4311027,0.417289 -0.5238956,0.423024 -1,0 z" style="" id="path566-6-3" /></g></svg>', Rd = '<svg style="width: 46px; height: 46px" viewBox="-1.6 -1.6 19.2 19.2"><path d="M 15,2 C 15,1.4477153 14.552285,1 14,1 H 2 C 1.4477153,1 1,1.4477153 1,2 v 12 c 0,0.552285 0.4477153,1 1,1 h 12 c 0.552285,0 1,-0.447715 1,-1 z M 0,2 C 0,0.8954305 0.8954305,0 2,0 h 12 c 1.104569,0 2,0.8954305 2,2 v 12 c 0,1.104569 -0.895431,2 -2,2 H 2 C 0.8954305,16 0,15.104569 0,14 Z" id="path2" /><path d="m 7.4989873,7.7026182 -2.1460003,2.147 c -0.472,0.4719998 -1.18,-0.236 -0.708,-0.708 l 3.0000003,-3 c 0.1953639,-0.1958581 0.5126361,-0.1958581 0.708,0 l 2.9999997,3 c 0.472,0.472 -0.236,1.1799998 -0.708,0.708 l -2.1459997,-2.147 c -0.4311027,-0.417289 -0.5238956,-0.423024 -1,0 z" style="" id="path566-6-3" /></svg>', kd = '<svg style="width: 46px; height: 46px" viewBox="-1.6 -1.6 19.2 19.2"><path d="M 15,2 C 15,1.4477153 14.552285,1 14,1 H 2 C 1.4477153,1 1,1.4477153 1,2 v 12 c 0,0.552285 0.4477153,1 1,1 h 12 c 0.552285,0 1,-0.447715 1,-1 z M 0,2 C 0,0.8954305 0.8954305,0 2,0 h 12 c 1.104569,0 2,0.8954305 2,2 v 12 c 0,1.104569 -0.895431,2 -2,2 H 2 C 0.8954305,16 0,15.104569 0,14 Z" id="path2" /><path d="m 7.4989873,8.2973819 -2.1460003,-2.147 c -0.472,-0.472 -1.18,0.236 -0.708,0.708 l 3.0000003,3 c 0.1953639,0.1958581 0.5126361,0.1958581 0.708,0 l 2.9999997,-3 c 0.472,-0.472 -0.236,-1.18 -0.708,-0.708 l -2.1459997,2.147 c -0.4311027,0.417289 -0.5238956,0.423024 -1,0 z" style="" id="path566-6-3" /></svg>', $d = '<svg width="46.08" height="46.08" version="1.1" viewBox="-1.6 -1.6 19.2 19.2" xmlns="http://www.w3.org/2000/svg"> <path d="m1 14a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-12a1 1 0 0 0-1-1h-12a1 1 0 0 0-1 1zm15 0a2 2 0 0 1-2 2h-12a2 2 0 0 1-2-2v-12a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2zm-8.5-2.5a0.5 0.5 0 0 0 1 0v-5.793l2.146 2.147a0.50063 0.50063 0 1 0 0.708-0.708l-3-3a0.5 0.5 0 0 0-0.708 0l-3 3a0.50063 0.50063 0 0 0 0.708 0.708l2.146-2.147z" fill-rule="evenodd"/></svg>', Hd = '<svg width="46.08" height="46.08" viewBox="-1.6 -1.6 19.2 19.2" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M 15,2 A 1,-1 0 0 0 14,1 H 2 A 1,-1 0 0 0 1,2 v 12 a 1,-1 0 0 0 1,1 h 12 a 1,-1 0 0 0 1,-1 z M 0,2 A 2,-2 0 0 1 2,0 h 12 a 2,-2 0 0 1 2,2 v 12 a 2,-2 0 0 1 -2,2 H 2 A 2,-2 0 0 1 0,14 Z m 8.5,2.5 a 0.5,-0.5 0 0 0 -1,0 v 5.793 L 5.354,8.146 A 0.5006316,-0.5006316 0 1 0 4.646,8.854 l 3,3 a 0.5,-0.5 0 0 0 0.708,0 l 3,-3 A 0.5006316,-0.5006316 0 0 0 10.646,8.146 L 8.5,10.293 Z" id="path2" /></svg>', _d = '<svg style="width: 46px; height: 46px" viewBox="-1.6 -1.6 19.2 19.2"><path d="M 15,2 C 15,1.4477153 14.552285,1 14,1 H 2 C 1.4477153,1 1,1.4477153 1,2 v 12 c 0,0.552285 0.4477153,1 1,1 h 12 c 0.552285,0 1,-0.447715 1,-1 z M 0,2 C 0,0.8954305 0.8954305,0 2,0 h 12 c 1.104569,0 2,0.8954305 2,2 v 12 c 0,1.104569 -0.895431,2 -2,2 H 2 C 0.8954305,16 0,15.104569 0,14 Z" id="path2" /><g id="g687" transform="translate(15.647255,-0.0288128)"><path d="m -8.1462425,10.484879 -2.1460005,2.146999 c -0.472,0.472 -1.18,-0.236 -0.708,-0.708 l 3.0000005,-2.9999994 c 0.195364,-0.195858 0.512636,-0.195858 0.708,0 l 3.0000005,2.9999994 c 0.472,0.472 -0.236,1.18 -0.708,0.708 l -2.1460005,-2.146999 c -0.431103,-0.417289 -0.523896,-0.423024 -1,0 z" style="" id="path566-5" /><path d="m -8.1482677,5.5727476 -2.1460003,-2.147 c -0.472,-0.472 -1.18,0.236 -0.708,0.708 l 3.0000003,3 c 0.1953639,0.195858 0.5126361,0.195858 0.708,0 l 2.9999997,-3 c 0.472,-0.472 -0.236,-1.18 -0.708,-0.708 l -2.1459997,2.147 c -0.4311027,0.417289 -0.5238956,0.423024 -1,0 z" style="" id="path566-6-3" /></g></svg>', Fd = '<svg style="width: 46px; height: 46px" viewBox="-1.6 -1.6 19.2 19.2"><path d="M 15,2 C 15,1.4477153 14.552285,1 14,1 H 2 C 1.4477153,1 1,1.4477153 1,2 v 12 c 0,0.552285 0.4477153,1 1,1 h 12 c 0.552285,0 1,-0.447715 1,-1 z M 0,2 C 0,0.8954305 0.8954305,0 2,0 h 12 c 1.104569,0 2,0.8954305 2,2 v 12 c 0,1.104569 -0.895431,2 -2,2 H 2 C 0.8954305,16 0,15.104569 0,14 Z" id="path2" /><g id="g611" transform="translate(0.2050748,-0.8829888)"><path d="m 7.2959375,11.933818 -2.146,-2.1469999 c -0.472,-0.4719998 -1.18,0.2359999 -0.708,0.7079999 l 3,3 c 0.195364,0.195858 0.512636,0.195858 0.708,0 l 3.0000005,-3 c 0.472,-0.472 -0.236,-1.1799997 -0.708,-0.7079999 L 8.2959375,11.933818 c -0.431103,0.417289 -0.523896,0.423024 -1,0 z" style="" id="path566" /><path d="m 7.2939123,5.8321596 -2.146,2.147 c -0.4719998,0.472 -1.1799998,-0.236 -0.708,-0.708 l 3,-3 c 0.1953639,-0.195858 0.5126361,-0.195858 0.708,0 l 2.9999997,3 c 0.472,0.472 -0.236,1.18 -0.708,0.708 l -2.1459997,-2.147 c -0.4311027,-0.417289 -0.5238956,-0.423024 -1,0 z" style="" id="path566-6" /></g></svg>', Bd = '<svg style="width: 46px; height: 46px" viewBox="-1.6 -1.6 19.2 19.2"><path d="M 15,2 C 15,1.4477153 14.552285,1 14,1 H 2 C 1.4477153,1 1,1.4477153 1,2 v 12 c 0,0.552285 0.4477153,1 1,1 h 12 c 0.552285,0 1,-0.447715 1,-1 z M 0,2 C 0,0.8954305 0.8954305,0 2,0 h 12 c 1.104569,0 2,0.8954305 2,2 v 12 c 0,1.104569 -0.895431,2 -2,2 H 2 C 0.8954305,16 0,15.104569 0,14 Z" id="path2" /><path d="m 11.500447,8.5 c 0.666666,0 0.666666,-1 0,-1 H 4.444275 c -0.1571231,0 -0.224029,0.07336 -0.2978281,0.1459999 -0.1958579,0.195364 -0.1958579,0.5126361 0,0.7080001 0,0 0.113806,0.146 0.320186,0.146 z" style="" id="path887" /></svg>', Ud = '<svg style="height:46px;width:46px" version="1.1" viewBox="-1.6 -1.6 19.2 19.2" xmlns="http://www.w3.org/2000/svg"> <g fill-rule="evenodd">  <path d="m15 2c0-0.55228-0.44772-1-1-1h-12c-0.55228 0-1 0.44772-1 1v12c0 0.55228 0.44772 1 1 1h12c0.55228 0 1-0.44772 1-1zm-15 0c0-1.1046 0.89543-2 2-2h12c1.1046 0 2 0.89543 2 2v12c0 1.1046-0.89543 2-2 2h-12c-1.1046 0-2-0.89543-2-2z"/>  <path d="m4.4449 4.097c-0.01964 0-0.037678 0.0018-0.054687 0.0039-0.017011 0.0022-0.034068 0.0058-0.048828 0.0098-0.014761 4e-3 -0.028126 0.0081-0.041016 0.01367-0.012889 0.0056-0.025711 0.01268-0.037109 0.01953-0.022796 0.01371-0.041442 0.02783-0.060547 0.04492s-0.038191 0.03653-0.056641 0.05469c-0.024482 0.02442-0.046092 0.05037-0.064453 0.07813-0.018362 0.02775-0.032681 0.05776-0.044922 0.08789s-0.021223 0.06023-0.027344 0.0918c-0.00612 0.03156-0.00977 0.06366-0.00977 0.0957 0 8e-3 -4.378e-4 0.01543 0 0.02344v1.2988c0 0.02083 6.41e-5 0.04102 0.00195 0.06055 0.00189 0.01953 0.0061 0.03841 0.00977 0.05664 0.00366 0.01823 0.00836 0.03581 0.013672 0.05273 0.00531 0.01693 0.010742 0.0332 0.017578 0.04883 0.013672 0.03125 0.029785 0.0599 0.048828 0.08594s0.041016 0.04948 0.064453 0.07031 0.049316 0.03906 0.076172 0.05469c0.026855 0.01563 0.054687 0.02865 0.083984 0.03906 0.029297 0.01042 0.059082 0.01823 0.089844 0.02344 0.030762 0.0052 0.0625 0.0078 0.09375 0.0078s0.062988-0.0026 0.09375-0.0078 0.060547-0.01302 0.089844-0.02344 0.057129-0.02344 0.083984-0.03906c0.026855-0.01563 0.052734-0.03385 0.076172-0.05469 0.023437-0.02083 0.04541-0.04427 0.064453-0.07031s0.035156-0.05469 0.048828-0.08594c0.00684-0.01563 0.012268-0.0319 0.017578-0.04883s0.01001-0.0345 0.013672-0.05273c0.00366-0.01823 0.00787-0.03711 0.00977-0.05664 0.00189-0.01953 0.00195-0.03971 0.00195-0.06055v-0.82227h6v0.98633c0 0.02083 2e-3 0.04102 0.0039 0.06055s0.0042 0.03841 0.0078 0.05664c0.0037 0.01823 0.0084 0.03581 0.01367 0.05273 0.0053 0.01693 0.01074 0.0332 0.01758 0.04883 0.01367 0.03125 0.03174 0.0599 0.05078 0.08594s0.03906 0.04948 0.0625 0.07031 0.04932 0.03906 0.07617 0.05469c0.02686 0.01563 0.05469 0.02865 0.08399 0.03906 0.0293 0.01042 0.06104 0.01823 0.0918 0.02344 0.03076 0.0052 0.06055 0.0078 0.0918 0.0078s0.06299-0.0026 0.09375-0.0078 0.06055-0.01302 0.08984-0.02344c0.0293-0.01042 0.05908-0.02344 0.08594-0.03906 0.02686-0.01563 0.05078-0.03385 0.07422-0.05469 0.02344-0.02083 0.04541-0.04427 0.06445-0.07031s0.03516-0.05469 0.04883-0.08594c0.0068-0.01563 0.01422-0.0319 0.01953-0.04883 0.0053-0.01693 0.01001-0.0345 0.01367-0.05273 0.0037-0.01823 0.0059-0.03711 0.0078-0.05664s2e-3 -0.03971 2e-3 -0.06055v-1.4629c3.25e-4 -0.0078 0-0.01563 0-0.02344 0-0.03125-0.0026-0.06299-0.0078-0.09375s-0.01302-0.06055-0.02344-0.08984c-0.01042-0.0293-0.02344-0.05713-0.03906-0.08398-0.01563-0.02685-0.03385-0.05273-0.05469-0.07617-0.02083-0.02344-0.04427-0.04541-0.07031-0.06445s-0.05469-0.03516-0.08594-0.04883c-0.01563-0.0068-0.0319-0.01227-0.04883-0.01758-0.01693-0.0053-0.0345-0.01001-0.05273-0.01367-0.01823-0.0037-0.03711-0.0059-0.05664-0.0078s-0.03971-0.0039-0.06055-0.0039h-6.5z"/>  <path d="m11.555 11.903c0.01964 0 0.03768-0.0018 0.05469-0.0039 0.01701-0.0022 0.03407-0.0058 0.04883-0.0098s0.02813-0.0081 0.04102-0.01367c0.01289-0.0056 0.02571-0.01268 0.03711-0.01953 0.0228-0.01371 0.04144-0.02783 0.06055-0.04492 0.0191-0.01709 0.03819-0.03653 0.05664-0.05469 0.02448-0.02442 0.04609-0.05037 0.06445-0.07813 0.01836-0.02775 0.03268-0.05776 0.04492-0.08789s0.02122-0.06023 0.02734-0.0918c0.0061-0.03156 0.0098-0.06366 0.0098-0.0957 0-8e-3 4.38e-4 -0.01543 0-0.02344v-1.2988c0-0.02083-6.4e-5 -0.04102-2e-3 -0.06055-0.0019-0.01953-0.0061-0.03841-0.0098-0.05664s-0.0084-0.03581-0.01367-0.05273c-0.0053-0.01693-0.01074-0.0332-0.01758-0.04883-0.01367-0.03125-0.02979-0.0599-0.04883-0.08594s-0.04102-0.04948-0.06445-0.07031c-0.02344-0.02083-0.04932-0.03906-0.07617-0.05469s-0.05469-0.02865-0.08398-0.03906c-0.0293-0.01042-0.05908-0.01823-0.08984-0.02344-0.03076-0.0052-0.0625-0.0078-0.09375-0.0078s-0.06299 0.0026-0.09375 0.0078-0.06055 0.01302-0.08984 0.02344c-0.0293 0.01042-0.05713 0.02344-0.08398 0.03906-0.02685 0.01563-0.05273 0.03385-0.07617 0.05469-0.02344 0.02083-0.04541 0.04427-0.06445 0.07031s-0.03516 0.05469-0.04883 0.08594c-0.0068 0.01563-0.01227 0.0319-0.01758 0.04883-0.0053 0.01693-0.01001 0.0345-0.01367 0.05273-0.0037 0.01823-0.0079 0.03711-0.0098 0.05664s-0.0019 0.03971-0.0019 0.06055v0.82227h-6v-0.98633c0-0.02083-2e-3 -0.04102-0.0039-0.06055s-0.0042-0.03841-0.0078-0.05664c-0.0037-0.01823-0.0084-0.03581-0.01367-0.05273-0.0053-0.01693-0.01074-0.0332-0.01758-0.04883-0.01367-0.03125-0.03174-0.0599-0.05078-0.08594s-0.03906-0.04948-0.0625-0.07031-0.04932-0.03906-0.07617-0.05469c-0.02686-0.01563-0.05469-0.02865-0.08399-0.03906-0.0293-0.01042-0.06104-0.01823-0.0918-0.02344-0.03076-0.0052-0.06055-0.0078-0.0918-0.0078s-0.06299 0.0026-0.09375 0.0078-0.06055 0.01302-0.08984 0.02344c-0.0293 0.01042-0.05908 0.02344-0.08594 0.03906-0.02686 0.01563-0.05078 0.03385-0.07422 0.05469-0.02344 0.02083-0.04541 0.04427-0.06445 0.07031s-0.03516 0.05469-0.04883 0.08594c-0.0068 0.01563-0.01422 0.0319-0.01953 0.04883-0.0053 0.01693-0.01001 0.03451-0.01367 0.05273-0.0037 0.01823-0.0059 0.03711-0.0078 0.05664s-2e-3 0.03971-2e-3 0.06055v1.4629c-3.25e-4 0.0078 0 0.01563 0 0.02344 0 0.03125 0.0026 0.06299 0.0078 0.09375s0.01302 0.06055 0.02344 0.08984c0.01042 0.0293 0.02344 0.05713 0.03906 0.08398 0.01563 0.02685 0.03385 0.05273 0.05469 0.07617 0.02083 0.02344 0.04427 0.04541 0.07031 0.06445s0.05469 0.03516 0.08594 0.04883c0.01563 0.0068 0.0319 0.01227 0.04883 0.01758 0.01693 0.0053 0.0345 0.01001 0.05273 0.01367 0.01823 0.0037 0.03711 0.0059 0.05664 0.0078s0.03971 0.0039 0.06055 0.0039h6.5z"/></g></svg>', Vd = '<svg style="height:46px;width:46px" version="1.1" viewBox="-1.6 -1.6 19.2 19.2" xmlns="http://www.w3.org/2000/svg"> <path d="m15 2c0-0.55228-0.44772-1-1-1h-12c-0.55228 0-1 0.44772-1 1v12c0 0.55228 0.44772 1 1 1h12c0.55228 0 1-0.44772 1-1zm-15 0c0-1.1046 0.89543-2 2-2h12c1.1046 0 2 0.89543 2 2v12c0 1.1046-0.89543 2-2 2h-12c-1.1046 0-2-0.89543-2-2z" fill-rule="evenodd"/> <path d="m13.291 7.7876c-1.0729-2.491-3.0911-4.0365-5.2687-4.0365-2.1776 0-4.1958 1.5456-5.2687 4.0365a0.53112 0.53112 0 0 0 0 0.4249c1.0729 2.491 3.0911 4.0365 5.2687 4.0365 2.1776 0 4.1959-1.5456 5.2687-4.0365a0.53112 0.53112 0 0 0 0-0.4249zm-5.2687 3.3992c-1.6836 0-3.277-1.2163-4.1958-3.1867 0.91884-1.9705 2.5122-3.1867 4.1958-3.1867 1.6837 0 3.277 1.2163 4.1959 3.1867-0.91884 1.9705-2.5122 3.1867-4.1959 3.1867zm0-5.3112a2.1245 2.1245 0 1 0 2.1245 2.1245 2.1245 2.1245 0 0 0-2.1245-2.1245zm0 3.1867a1.0622 1.0622 0 1 1 1.0622-1.0622 1.0622 1.0622 0 0 1-1.0622 1.0622z" stroke-width=".53112"/></svg>', zd = '<svg style="height:46px;width:46px" version="1.1" viewBox="-1.6 -1.6 19.2 19.2" xmlns="http://www.w3.org/2000/svg"> <path d="m15 2c0-0.55228-0.44772-1-1-1h-12c-0.55228 0-1 0.44772-1 1v12c0 0.55228 0.44772 1 1 1h12c0.55228 0 1-0.44772 1-1zm-15 0c0-1.1046 0.89543-2 2-2h12c1.1046 0 2 0.89543 2 2v12c0 1.1046-0.89543 2-2 2h-12c-1.1046 0-2-0.89543-2-2z" fill-rule="evenodd"/> <path d="m13.291 7.7876c-1.0729-2.491-3.0911-4.0365-5.2687-4.0365-2.1776 0-4.1958 1.5456-5.2687 4.0365a0.53112 0.53112 0 0 0 0 0.4249c1.0729 2.491 3.0911 4.0365 5.2687 4.0365 2.1776 0 4.1959-1.5456 5.2687-4.0365a0.53112 0.53112 0 0 0 0-0.4249zm-5.2687 3.3992c-1.6836 0-3.277-1.2163-4.1958-3.1867 0.91884-1.9705 2.5122-3.1867 4.1958-3.1867 1.6837 0 3.277 1.2163 4.1959 3.1867-0.91884 1.9705-2.5122 3.1867-4.1959 3.1867zm0-5.3112a2.1245 2.1245 0 1 0 2.1245 2.1245 2.1245 2.1245 0 0 0-2.1245-2.1245zm0 3.1867a1.0622 1.0622 0 1 1 1.0622-1.0622 1.0622 1.0622 0 0 1-1.0622 1.0622z" stroke-width=".53112"/> <path d="m12.757 3.0055c-0.11087 0.0051358-0.22696 0.051177-0.33008 0.1543l-4.9883 4.9902c-0.061946 0.061947-0.086644 0.12038-0.097656 0.17773l-4.8184 4.8164c-0.1111 0.1111-0.1066 0.2109-0.10742 0.31445-3.5e-4 0.27663 0.22337 0.50035 0.5 0.5 0 0 0.18415 0.022881 0.33008-0.12305l4.9746-4.9727c0.06758-0.06758 0.10951-0.13979 0.13281-0.21289l4.7832-4.7832c0.36828-0.36828 0.017071-0.87967-0.37891-0.86133z" fill-rule="evenodd"/></svg>', Wd = '<svg class="ov-icon" width="46.08" height="46.08" version="1.1" viewBox="-1.6 -1.6 19.2 19.2"><path d="m14 15c0.55228 0 1-0.44772 1-1v-12c0-0.55228-0.44772-1-1-1h-12c-0.55228 0-1 0.44772-1 1v12c0 0.55228 0.44772 1 1 1zm0-15c1.1046 0 2 0.89543 2 2v12c0 1.1046-0.89543 2-2 2h-12c-1.1046 0-2-0.89543-2-2v-12c0-1.1046 0.89543-2 2-2z" fill-rule="evenodd"/><g transform="translate(-1.1585)" fill-rule="evenodd">  <path d="m8.2964 7.5-2.147-2.146c-0.472-0.472 0.236-1.18 0.708-0.708l3 3c0.19586 0.19536 0.19586 0.51264 0 0.708l-3 3c-0.472 0.472-1.18-0.236-0.708-0.708l2.147-2.146c0.41729-0.4311 0.42302-0.5239 0-1z"/>  <path d="m12.323 4.4996c0-0.66667-1-0.66667-1 0v7.0562c0 0.15712 0.07336 0.22403 0.146 0.29783 0.19536 0.19586 0.51264 0.19586 0.708 0 0 0 0.146-0.11381 0.146-0.32019z"/></g></svg>', Gd = '<svg class="ov-icon" width="46.08" height="46.08" version="1.1" viewBox="-1.6 -1.6 19.2 19.2"><path d="m2 15c-0.55228 0-1-0.44772-1-1v-12c0-0.55228 0.44772-1 1-1h12c0.55228 0 1 0.44772 1 1v12c0 0.55228-0.44772 1-1 1zm0-15c-1.1046 0-2 0.89543-2 2v12c0 1.1046 0.89543 2 2 2h12c1.1046 0 2-0.89543 2-2v-12c0-1.1046-0.89543-2-2-2z" fill-rule="evenodd"/><g transform="matrix(-1 0 0 1 17.159 0)" fill-rule="evenodd">  <path d="m8.2964 7.5-2.147-2.146c-0.472-0.472 0.236-1.18 0.708-0.708l3 3c0.19586 0.19536 0.19586 0.51264 0 0.708l-3 3c-0.472 0.472-1.18-0.236-0.708-0.708l2.147-2.146c0.41729-0.4311 0.42302-0.5239 0-1z"/>  <path d="m12.323 4.4996c0-0.66667-1-0.66667-1 0v7.0562c0 0.15712 0.07336 0.22403 0.146 0.29783 0.19536 0.19586 0.51264 0.19586 0.708 0 0 0 0.146-0.11381 0.146-0.32019z"/></g></svg>', qd = '<svg clip-rule="evenodd" fill-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" version="1.1" viewBox="0 0 336.96 336.36" xmlns="http://www.w3.org/2000/svg"><path d="m0 0 168.48 336.36 168.48-336.36z"/></svg>', jd = '<svg clip-rule="evenodd" fill-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" version="1.1" viewBox="0 0 336.96 336.36" xmlns="http://www.w3.org/2000/svg"><path d="m0 336.36 168.48-336.36 168.48 336.36z"/></svg>', Xd = '<svg clip-rule="evenodd" fill-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" version="1.1" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m512 256c0 70.67-28.66 134.68-74.99 181.01s-110.34 74.99-181.01 74.99c-70.68 0-134.69-28.66-181.01-74.99-46.33-46.33-74.99-110.34-74.99-181.01 0-70.68 28.66-134.69 74.99-181.01 46.32-46.33 110.33-74.99 181.01-74.99 70.67 0 134.68 28.66 181.01 74.99 46.33 46.32 74.99 110.33 74.99 181.01zm-204.29-21.97v-67.04c0-7.53-6.19-13.72-13.73-13.72h-75.96c-7.53 0-13.72 6.17-13.72 13.72v67.03h-42.84c-16.5 0-24.78 19.64-13.86 31.54l94.74 110.57c7.44 9 21.03 9.01 28.66 0.37l93.71-111.31c10.69-12.27 1.64-31.14-14.19-31.16h-42.81zm105.52 179.2c40.22-40.24 65.11-95.84 65.11-157.23 0-61.4-24.89-117-65.11-157.23-40.24-40.23-95.84-65.11-157.23-65.11-61.4 0-117 24.88-157.23 65.11s-65.11 95.83-65.11 157.23c0 61.39 24.88 116.99 65.11 157.23 40.23 40.22 95.83 65.11 157.23 65.11 61.39 0 116.99-24.89 157.23-65.11z" fill-rule="nonzero"/></svg>', Yd = '<svg clip-rule="evenodd" fill-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" version="1.1" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m512 256c0-70.67-28.66-134.68-74.99-181.01s-110.34-74.99-181.01-74.99c-70.68 0-134.69 28.66-181.01 74.99-46.33 46.33-74.99 110.34-74.99 181.01 0 70.68 28.66 134.69 74.99 181.01 46.32 46.33 110.33 74.99 181.01 74.99 70.67 0 134.68-28.66 181.01-74.99 46.33-46.32 74.99-110.33 74.99-181.01zm-204.29 21.97v67.04c0 7.53-6.19 13.72-13.73 13.72h-75.96c-7.53 0-13.72-6.17-13.72-13.72v-67.03h-42.84c-16.5 0-24.78-19.64-13.86-31.54l94.74-110.57c7.44-9 21.03-9.01 28.66-0.37l93.71 111.31c10.69 12.27 1.64 31.14-14.19 31.16zm105.52-179.2c40.22 40.24 65.11 95.84 65.11 157.23 0 61.4-24.89 117-65.11 157.23-40.24 40.23-95.84 65.11-157.23 65.11-61.4 0-117-24.88-157.23-65.11s-65.11-95.83-65.11-157.23c0-61.39 24.88-116.99 65.11-157.23 40.23-40.22 95.83-65.11 157.23-65.11 61.39 0 116.99 24.89 157.23 65.11z" fill-rule="nonzero"/></svg>', Kd = '<svg clip-rule="evenodd" fill-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" version="1.1" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M512 256c0-70.67-28.66-134.68-74.98-181.02C390.69 28.66 326.68 0 256 0S121.31 28.66 74.98 74.98C28.66 121.32 0 185.33 0 256c0 70.68 28.66 134.69 74.98 181.02C121.31 483.34 185.32 512 256 512c70.67 0 134.69-28.66 181.02-74.98C483.34 390.69 512 326.68 512 256zm-160.23-21.5h-43.38v-67.93c0-7.63-6.27-13.9-13.91-13.9H217.5c-7.62 0-13.9 6.25-13.9 13.9v67.92h-43.41c-16.71 0-25.11 19.9-14.05 31.96l96.01 112.05c7.54 9.12 21.31 9.12 29.04.37l94.96-112.8c10.83-12.43 1.66-31.55-14.38-31.57z"/></svg>', Zd = '<svg clip-rule="evenodd" fill-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" version="1.1" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m512 256c0 70.67-28.66 134.68-74.98 181.02-46.33 46.32-110.34 74.98-181.02 74.98s-134.69-28.66-181.02-74.98c-46.32-46.34-74.98-110.35-74.98-181.02 0-70.68 28.66-134.69 74.98-181.02 46.33-46.32 110.34-74.98 181.02-74.98 70.67 0 134.69 28.66 181.02 74.98 46.32 46.33 74.98 110.34 74.98 181.02zm-160.23 21.5h-43.38v67.93c0 7.63-6.27 13.9-13.91 13.9h-76.98c-7.62 0-13.9-6.25-13.9-13.9v-67.92h-43.41c-16.71 0-25.11-19.9-14.05-31.96l96.01-112.05c7.54-9.12 21.31-9.12 29.04-0.37l94.96 112.8c10.83 12.43 1.66 31.55-14.38 31.57z"/></svg>', Qd = '<svg width="800px" height="800px" version="1.1" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">  <defs>   <clipPath id="clipPath1">    <path d="m6.1885 15.281v-9.0209h3.1721q1.0764 0 1.6765 0.65299 0.63822 0.71345 0.63822 1.7171 0 0.58043-0.22862 1.0158-0.21909 0.42323-0.743 0.84646 1.1812 0.87065 1.1812 2.1887 0 0.53206-0.19051 1.0762-0.19051 0.53206-0.51439 0.87065-0.60964 0.65299-1.7908 0.65299zm1.467-7.4731v2.0315h1.5813q1.0383 0 1.0383-1.0158 0-1.0158-1.0383-1.0158zm0 3.5793v2.3459h1.7432q1.0859 0 1.0859-1.1609 0-1.185-1.0859-1.185zm9.6876-5.1271h1.467v6.1066q0 1.4874-0.69538 2.2854-0.80016 0.91902-2.1242 0.91902t-2.1242-0.91902q-0.69538-0.79809-0.69538-2.2854v-6.1066h1.4574v6.1066q0 1.6083 1.3622 1.6083 1.3526 0 1.3526-1.6083zm6.2108 5.6834v3.3375h-1.467v-3.3375l-2.3528-5.6834h1.6289l1.4479 3.9784 1.3622-3.9784h1.6384z" display="none" stroke-width=".041213" style="white-space:pre" aria-label="BUY"/>    <path class="powerclip" d="m-5-5h42v42.001h-42zm11.189 20.281h3.2006q1.1812 0 1.7908-0.65299 0.32387-0.33859 0.51439-0.87065 0.19051-0.54416 0.19051-1.0762 0-1.3181-1.1812-2.1887 0.52391-0.42323 0.743-0.84646 0.22862-0.43532 0.22862-1.0158 0-1.0037-0.63822-1.7171-0.60012-0.65299-1.6765-0.65299h-3.1721zm1.467-7.4731v2.0315h1.5813q1.0383 0 1.0383-1.0158 0-1.0158-1.0383-1.0158zm0 3.5793v2.3459h1.7432q1.0859 0 1.0859-1.1609 0-1.185-1.0859-1.185zm9.6876-5.1271v6.1066q0 1.6083-1.3526 1.6083-1.3622 0-1.3622-1.6083v-6.1066h-1.4574v6.1066q0 1.4874 0.69538 2.2854 0.80016 0.91902 2.1242 0.91902t2.1242-0.91902q0.69538-0.79809 0.69538-2.2854v-6.1066zm6.2108 5.6834 2.2576-5.6834h-1.6384l-1.3622 3.9784-1.4479-3.9784h-1.6289l2.3528 5.6834v3.3375h1.467z" stroke-width=".041213" style="white-space:pre"/>   </clipPath>  </defs>  <g clip-path="url(#clipPath1)" fill="none" fill-rule="evenodd">   <g id="Icon-Set" transform="translate(-360 -255)" fill="#000">    <path d="m386.67 255h-21.334c-2.945 0-5.333 2.371-5.333 5.297v12.33c0 2.924 2.055 4.813 5 4.813h6.639l4.361 9.561 4.361-9.561h6.639c2.945 0 5-1.889 5-4.813v-12.33c0-2.926-2.388-5.297-5.333-5.297z"/>   </g>  </g> </svg>', Jd = '<svg width="800px" height="800px" version="1.1" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">  <defs>   <clipPath id="clipPath4">    <path d="m10.026 8.6238h-1.2531q-0.06962-1.4148-1.3576-1.4148-0.51344 0-0.81803 0.30231-0.30458 0.30231-0.30458 0.81019 0 0.49579 0.25237 0.74972 0.26107 0.24185 0.97467 0.43532l1.0182 0.26603q0.90505 0.24185 1.3054 0.83437 0.40901 0.59252 0.40901 1.6566 0 1.3785-0.7049 2.1524-0.69619 0.77391-1.958 0.77391-1.2444 0-1.9406-0.76182-0.68749-0.77391-0.74841-2.225h1.2967q0.03481 0.72554 0.40901 1.1125t1.053 0.38696q0.60917 0 0.95727-0.32649 0.3568-0.32649 0.3568-0.89483 0-0.54416-0.27848-0.83437-0.27848-0.30231-0.94856-0.4716l-0.90505-0.25394q-0.99208-0.26603-1.4098-0.81019-0.41772-0.55625-0.41772-1.6083 0-1.3181 0.64398-2.0436 0.65268-0.73763 1.8188-0.73763 1.4185 0 2.0886 1.0278 0.46123 0.71345 0.46123 1.8743zm2.5672 2.3822v2.3459h3.5245v1.5478h-4.8559v-9.0209h4.6993v1.5478h-3.3678v2.0315h3.1155v1.5478zm5.9612-5.1271v7.4731h3.1068v1.5478h-4.4469v-9.0209zm5.439 0v7.4731h3.1068v1.5478h-4.4469v-9.0209z" display="none" stroke-width=".039392" style="white-space:pre" aria-label="SELL"/>    <path class="powerclip" d="m-5-5h42v42.001h-42zm15.026 13.624q0-1.1609-0.46123-1.8743-0.67009-1.0278-2.0886-1.0278-1.1661 0-1.8188 0.73763-0.64398 0.72554-0.64398 2.0436 0 1.052 0.41772 1.6083 0.41772 0.54416 1.4098 0.81019l0.90505 0.25394q0.67009 0.16929 0.94856 0.4716 0.27848 0.29022 0.27848 0.83437 0 0.56834-0.3568 0.89483-0.3481 0.32649-0.95727 0.32649-0.67879 0-1.053-0.38696-0.3742-0.38695-0.40901-1.1125h-1.2967q0.060917 1.4511 0.74841 2.225 0.69619 0.76182 1.9406 0.76182 1.2619 0 1.958-0.77391 0.7049-0.77391 0.7049-2.1524 0-1.0641-0.40901-1.6566-0.40031-0.59252-1.3054-0.83437l-1.0182-0.26603q-0.7136-0.19348-0.97467-0.43532-0.25237-0.25394-0.25237-0.74972 0-0.50788 0.30458-0.81019t0.81803-0.30231q1.288 0 1.3576 1.4148zm2.5672 2.3822h3.1155v-1.5478h-3.1155v-2.0315h3.3678v-1.5478h-4.6993v9.0209h4.8559v-1.5478h-3.5245zm5.9612-5.1271h-1.3402v9.0209h4.4469v-1.5478h-3.1068zm5.439 0h-1.3402v9.0209h4.4469v-1.5478h-3.1068z" stroke-width=".039392" style="white-space:pre"/>   </clipPath>  </defs>  <path d="m26.667 0h-21.334c-2.945 0-5.333 2.371-5.333 5.297v12.33c0 2.924 2.055 4.813 5 4.813h6.639l4.361 9.561 4.361-9.561h6.639c2.945 0 5-1.889 5-4.813v-12.33c0-2.926-2.388-5.297-5.333-5.297z" clip-path="url(#clipPath4)" fill-rule="evenodd"/> </svg>', em = '<svg width="493px" height="512px" clip-rule="evenodd" fill-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" version="1.1" viewBox="0 0 493 511.77" xmlns="http://www.w3.org/2000/svg"><path d="m33.11 458.2 104.5-79.1c3.09-3 7.08-4.47 11.08-4.45l302.6-0.08c2.67 0 5.09-1.08 6.78-2.77 1.74-1.81 2.84-4.24 2.84-6.87v-323.2c0-2.59-1.12-5-2.86-6.74-1.78-1.78-4.2-2.9-6.76-2.9h-409.56c-2.54 0-4.94 1.14-6.72 2.92s-2.92 4.18-2.92 6.72c0 793.72 1.02 39.329 1.02 416.47zm90.6-229.77c10.9 0 19.74 8.85 19.74 19.74s-8.84 19.73-19.74 19.73c-10.89 0-19.73-8.84-19.73-19.73s8.84-19.74 19.73-19.74zm0-101.14c10.9 0 19.74 8.85 19.74 19.74s-8.84 19.74-19.74 19.74c-10.89 0-19.73-8.85-19.73-19.74s8.84-19.74 19.73-19.74zm61.72 138.89c-9.95 0-18.02-8.07-18.02-18.01 0-9.95 8.07-18.02 18.02-18.02h185.56c9.95 0 18.01 8.07 18.01 18.02 0 9.94-8.06 18.01-18.01 18.01zm0-101.13c-9.95 0-18.02-8.07-18.02-18.02 0-9.94 8.07-18.01 18.02-18.01h185.56c9.95 0 18.01 8.07 18.01 18.01 0 9.95-8.06 18.02-18.01 18.02zm-30.38 241.61-125.97 99.69c-2.96 3.32-7.24 5.42-12.01 5.42-8.85 0-17.07-7.1228-17.07-15.963v-454.08c0-11.4 4.77-21.88 12.31-29.42s18.02-12.31 29.42-12.31h409.56c11.4 0 21.9 4.74 29.45 12.29 7.5 7.51 12.26 17.96 12.26 29.44v323.2c0 11.48-4.7 21.95-12.24 29.49-7.61 7.54-18.05 12.24-29.47 12.24z" fill-rule="nonzero"/></svg>', tm = '<svg width="800px" height="800px" fill="none" version="1.1" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="m15.746 2.7281c-5.1207-2.0689-10.949 0.40512-13.018 5.5258-2.0689 5.1207 0.40512 10.949 5.5258 13.018 5.1207 2.0689 10.949-0.40508 13.018-5.5258 2.0689-5.1207-0.40508-10.949-5.5258-13.018zm-1.3378 8.3035-1.2703-0.51325c-0.21854-0.08829-0.32785-0.13246-0.3683-0.22775-0.04045-0.09529 0.0037-0.20461 0.09201-0.42314l1.6595-4.1073c0.33362-0.82575 0.50047-1.2387 0.33474-1.3523-0.16582-0.11359-0.49058 0.19103-1.1403 0.8003l-4.7426 4.4469c-1.0274 0.96338-1.541 1.445-1.4405 1.9835 0.10054 0.53837 0.75347 0.80216 2.0594 1.3298l1.2703 0.51325c0.21854 0.08829 0.32785 0.13246 0.3683 0.22775 0.04045 0.09529-0.0037 0.20461-0.09201 0.42314l-1.6595 4.1073c-0.33365 0.82582-0.50047 1.2387-0.33475 1.3523 0.16582 0.1136 0.49059-0.19104 1.1403-0.80025l4.7425-4.4469c1.0275-0.96346 1.5411-1.4451 1.4406-1.9836-0.10057-0.53838-0.75352-0.80218-2.0594-1.3298z" clip-rule="evenodd" fill-rule="evenodd"/></svg>', im = '<svg enable-background="new 0 0 100 100" version="1.1" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">  <g>   <rect transform="scale(-1)" x="-15" y="-100" width="15" height="100">    <animate attributeName="height" attributeType="XML" dur="1s" repeatCount="indefinite" values="30; 100; 30"/>   </rect>   <rect transform="scale(-1)" x="-36.25" y="-100" width="15" height="100">    <animate attributeName="height" attributeType="XML" begin="0.1s" dur="1s" repeatCount="indefinite" values="30; 100; 30"/>   </rect>   <rect transform="scale(-1)" x="-57.5" y="-100" width="15" height="100">    <animate attributeName="height" attributeType="XML" begin="0.3s" dur="1s" repeatCount="indefinite" values="30; 100; 30"/>   </rect>   <rect transform="scale(-1)" x="-78.75" y="-100" width="15" height="100">    <animate attributeName="height" attributeType="XML" begin="0.5s" dur="1s" repeatCount="indefinite" values="30; 100; 30"/>   </rect>   <rect transform="scale(-1)" x="-100" y="-100" width="15" height="100">    <animate attributeName="height" attributeType="XML" begin="0.1s" dur="1s" repeatCount="indefinite" values="30; 100; 30"/>   </rect>  </g> </svg>', sm = '<svg version="1.1" id="L7" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"  viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">   <path fill="#fff" d="M42.3,39.6c5.7-4.3,13.9-3.1,18.1,2.7c4.3,5.7,3.1,13.9-2.7,18.1l4.1,5.5c8.8-6.5,10.6-19,4.1-27.7  c-6.5-8.8-19-10.6-27.7-4.1L42.3,39.6z">      <animateTransform         attributeName="transform"         attributeType="XML"         type="rotate"         dur="3s"         from="0 50 50"         to="360 50 50"         repeatCount="indefinite" />  </path> <path fill="#fff" d="M82,35.7C74.1,18,53.4,10.1,35.7,18S10.1,46.6,18,64.3l7.6-3.4c-6-13.5,0-29.3,13.5-35.3s29.3,0,35.3,13.5  L82,35.7z">      <animateTransform         attributeName="transform"         attributeType="XML"         type="rotate"         dur="2s"         from="0 50 50"         to="360 50 50"         repeatCount="indefinite" />  </path>   <path fill="#fff" d="M31.6,3.5C5.9,13.6-6.6,42.7,3.5,68.4c10.1,25.7,39.2,38.3,64.9,28.1l-3.1-7.9c-21.3,8.4-45.4-2-53.8-23.3  c-8.4-21.3,2-45.4,23.3-53.8L31.6,3.5z">      <animateTransform         attributeName="transform"         attributeType="XML"         type="rotate"         dur="1s"         from="0 50 50"         to="360 50 50"         repeatCount="indefinite" />  </path></svg>', lt = 300, li = 400, nm = `${li}px`, wl = `${lt}px`, xl = "100%", Cl = "100%", Tl = 30, Bs = 35, ws = 25, Sl = 25, rm = ws + Sl, _n = 60, zi = "normal", kt = 12, Us = "normal", Wi = "Avenir, Helvetica, Arial, sans-serif", fr = "Andalé, Lucida, Monaco, Courier", gr = "#141414", yr = "#333", vr = "#cccccc", gi = "#888888", Bt = "#cccccc", El = "25px", am = "position: relative;", z = {
  ...
  FONTFAMILY: Wi,
  FONT: `${Us} ${kt}px ${zi} ${Wi}`,
  FONTSTRING: `font-style: ${Us}; font-size: ${kt}px; font-weight: ${zi}; font-family: ${Wi};`
}, He = {
  fontSize: kt,
  fontWeight: zi,
  fontFamily: Wi,
...
}, lm = 1.75, Ta = 500, qi = kt + 2, ji = fr, ke = {
  COLOUR_TICK: "#888",
  COLOUR_LABEL: "888",
  COLOUR_CURSOR: "#000",
  ...
  FONTSIZE: qi,
  FONTWEIGHT: Ta,
  FONT_LABEL: `${Ta} ${qi}px ${ji}`,
  FONT_LABEL_BOLD: `bold ${qi}px ${ji}`
}, Sa = 500, Ea = kt + 2, Pa = fr, wt = {
  COLOUR_TICK: "#888",
  COLOUR_LABEL: "888",
  COLOUR_CURSOR: "#000",
  COLOUR_CURSOR_BG: "#CCC",
...
}, zs = { arrowDown: qd, arrowUp: jd, arrowDownRound: Xd, arrowUpRound: Yd, arrowDownRoundSolid: Kd, arrowUpRoundSolid: Zd, buySolid: Qd, sellSolid: Jd }, La = { noteSolid: em, lightning: tm }, xs = {
  title: {
    display: !0
  },
  candle: {
    Type: be.CANDLE_SOLID,
    UpBodyColour: Ni.COLOUR_CANDLE_UP,
    UpWickColour: Ni.COLOUR_WICK_UP,
    DnBodyColour: Ni.COLOUR_CANDLE_DN,
    DnWickColour: Ni.COLOUR_WICK_DN
  },
  volume: {
...
<style id="txc_globalCSS">
  tradex-chart {
    ...
    min-width: var(--txc-min-width, ${nm});
    min-height: var(--txc-min-height, ${wl});
    max-width: var(--txc-max-width, ${xl});
    max-height: var(--txc-max-height, ${Cl});
    overflow: hidden;
...
`, Aa = "initialEmptyState", Ws = "Empty", Ml = {
  id: void 0,
  title: Ws,
  symbol: Ws,
  width: xl,
...
class Xi extends Ll {
  ...
  calcXAxisGrads(e = this.range.snapshot()) {
    ...
    for (; c < l; ) {
      let f = Bi(c, "years"), C = Bi(c, "months"), E = Bi(c, "days");
      !(f in i.entries) && f >= p ? i.entries[f] = [this.dateTimeValue(f, n, o), this.t2Pixel(f), f, "major"] : !(C in i.entries) && C >= p ? i.entries[C] = [this.dateTimeValue(C, n, o), this.t2Pixel(C), C, "major"] : !(E in i.entries) && E >= p ? i.entries[E] = [this.dateTimeValue(E, n, o), this.t2Pixel(E), E, "major"] : i.entries[c] = [this.dateTimeValue(c, n, o), this.t2Pixel(c), c, "minor"], c += r;
    }
    return i.values = Object.values(i.entries), i;
  }
  xStep(e) {
    let i = xd, s = this.#i ? e.interval : 1, n = si[0], r = Ue(this.width / e.Length), o = Ln[0], l = si.indexOf(s);
    for (; l-- >= 0 && !(r * (si[l] / s) >= i); )
      ;
    return n = si[l], o = Ln[l], { xStep: n, rank: o };
  }
  dateTimeValue(e, i, s) {
    let n;
    if (e / q % 1 === 0) {
      const r = cr(e);
      return r === 1 ? ur(e) === 0 ? pl(e) : dl(e) : `${ul(e, n)} ${r}`;
    } else
      switch (s) {
        case "milliseconds":
          return Dn(e);
...
class hi extends Ll {
  ...
  setMode(e) {
    ...
    let i = this.#r.manual;
    return this.mode == "automatic" && e == "manual" ? (i.max = this.#u.valueMax, i.min = this.#u.valueMin, i.diff = i.max - i.min, i.zoom = 0, i.secondaryMaxMin = Z(this.#u.secondaryMaxMin), this.#n = e, this.core.emit("yaxis_setmode", { mode: e, axis: this })) : this.mode == "manual" && e == "automatic" && (i.zoom = 0, this.#n = e, this.core.emit("yaxis_setmode", { mode: e, axis: this })), !0;
  }
  ...
  gradations(e, i, s = !0) {
    let n, r = [], o = e - i, l = this.niceNumber(o), c = Math.ceil(i / l) * l, p = Math.floor(e / l) * l, f = this.height, C = Fi(l), E;
    this.#c = C;
    for (var L = c; L <= p; L += l)
      n = Fi(L), E = Pn(L, C.decimals) * 1, f = this.yPos(E), r.push([E, f, n]);
    return r;
  }
  niceNumber(e = this.rangeH) {
    const i = e / (this.height / (this.core.theme.yAxis.fontSize * lm));
...
function Cs(a, e, i) {
  ...
  const s = br(a, e), n = i?.paddingLeft || 0, r = i?.paddingRight || 0, o = i?.borderWidth || 0;
  return n + r + s + o * 2;
}
function Ts(a) {
...
function wr(a, e, i, s, n, r) {
  T(r.fill) && Ss(a, e, i, s, n, r), P(r.width) && r.width > 0 && Ol(a, e, i, s, n, r);
}
function Dl(a, e, i, s, n, r, o) {
  a.lineWidth = o?.width || He.borderWidth, a.strokeStyle = o?.border || He.stroke, Nl(a, e, i, s, n, r), a.stroke();
}
function Il(a, e, i, s, n, r, o) {
  a.fillStyle = o?.fill || He.fill, Nl(a, e, i, s, n, r), a.fill();
}
function Nl(a, e, i, s, n, r) {
...
function pm(a, e, i, s, n, r, o) {
  T(o.fill) && Il(a, e, i, s, n, r, o?.fill), P(o.width) && o.width > 0 && Dl(a, e, i, s, n, r, o?.border, o?.width);
}
function Yi(a, e = [], i = []) {
  let [s, n, r, o] = e;
...
function gm(a, e, i, s, n) {
  Rl(a, e, i, s, 3, n?.rotate || 0, n), Mt(a, n?.fill, n?.stroke, n?.width);
}
function ym(a, e, i, s, n, r) {
...
function wm(a, e, i) {
  ...
  for (var s = i ?? 1, n = 0; n < e.length - 1; n++) {
    var r = n > 0 ? e[n - 1] : e[0], o = e[n], l = e[n + 1], c = n != e.length - 2 ? e[n + 2] : l, p = o.x + (l.x - r.x) / 6 * s, f = o.y + (l.y - r.y) / 6 * s, C = l.x - (c.x - o.x) / 6 * s, E = l.y - (c.y - o.y) / 6 * s;
    a.bezierCurveTo(p, f, C, E, l.x, l.y);
  }
  a.stroke();
}
function Et(a, e, i, s, n = {}) {
...
class ei {
  ...
  on(e, i, s) {
    return !T(e) || !D(i) ? !1 : (this.#e[e] || (this.#e[e] = []), this.#e[e].push({ handler: i, context: s }), !0);
  }
  off(e, i, s) {
    if (!T(e) || !D(i) || !(e in this.#e)) return !1;
    const n = this.#e[e];
...
class ee extends HTMLElement {
  ...
  getDims() {
    ...
    return this.DOM.visible = Pt(this), this.DOM.viewport = Kn(this), this.DOM;
  }
  onIntersection(e) {
...
const kl = document.createElement("template");
kl.innerHTML = `
<style>
...
`;
const Em = ["min", "max", "value", "step", "orient", "width", "height"];
class Pm extends ee {
  #e;
  #t;
  #i;
...
const $l = ["source-over", "source-atop", "source-in", "source-out", "destination-over", "destination-atop", "destination-in", "destination-out", "lighter", "copy", "xor", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], Cr = typeof OffscreenCanvas < "u", Mm = ["2d", "webgl", "webgl2d", "webgl2", "webgpu", "bitmaprenderer"];
let Hl = class {
  #e = 0;
  #t;
  #i;
  ...
  constructor(e = {}) {
    ...
    this.#n = e.container, this.#s = [], this.#t = X.idCnt++, this.#i = new X.Scene(e);
    let { width: i, height: s } = os(e?.width || 0, e?.height || 0);
    this.setSize(i, s);
  }
  get id() {
    return this.#t;
  ...
  setSize(e, i) {
    let { width: s, height: n } = os(e, i);
    return this.width = s, this.height = n, this.scene.setSize(s, n), this.layers.forEach(function(r) {
      r.setSize(s, n);
    }), this;
  }
  addLayer(e) {
    return e instanceof Fn ? (this.layers.push(e), e.setSize(e.width || this.width, e.height || this.height), e.viewport = this, this) : !1;
  }
  removeLayer(e) {
    return e instanceof Fn ? (this.layers.splice(e.index, 1), !0) : !1;
  }
  getIntersection(e, i) {
  ...
  render(e = !1) {
    ...
    for (n of s)
      if (e && M(n.layers) && n.layers.length > 0 && n.render(e), n.visible && n.width > 0 && n.height > 0) {
        const r = i.context;
        $l.includes(n?.composition) && (r.globalCompositeOperation = n.composition), r.globalAlpha = n.alpha, r.scale(1, 1), r.drawImage(
          n.scene.canvas,
          n.x,
          n.y,
          n.width,
...
class Fn {
  ...
  constructor(e = {}) {
    const i = { ...e };
    this.id = X.idCnt++, this.#l = j(e?.offscreen) ? e.offscreen : this.#l, i.layer = this, i.offscreen = this.#l, this.hit = new X.Hit(i), this.scene = new X.Scene(i), e?.x && e?.y && this.setPosition(e.x, e.y), e?.width && e?.height && this.setSize(e.width, e.height), e?.composition && (this.setComposition = e.composition), e?.alpha && (this.alpha = e.alpha), e?.visible && (this.visible = e.visible);
  }
  set x(e) {
    P(e) && (this.#e = e);
  }
  ...
  destroy() {
    Fl(1, 1), this.scene.clear(), this.hit.clear();
  }
}
class _l {
  #e;
  ...
  constructor(e = { offscreen: !0 }) {
    this.#e = X.idCnt++, this.#l = e?.layer, this.#a = Mm.includes(e?.contextType) ? e.contextType : "2d";
    const i = document.createElement("canvas");
    i.className = "scene-canvas", i.style.display = "block", e.offscreen = j(e?.offscreen) ? e.offscreen : !0, Cr && e.offscreen ? (this.#s = i.transferControlToOffscreen(), this.#n = !0) : (this.#s = i, this.#n = !1), this.#a == "webgl2d" ? this.#r = this.getContext("2d") : this.#r = this.getContext(this.contextType), e?.width && e?.height && this.setSize(e.width, e.height);
  }
  get id() {
    return this.#e;
  }
...
function Fl(a, e, i, s = !0) {
  let { width: n, height: r } = os(a, e);
...
<style>
  .colourpicker {
    display: grid;
    grid-template-columns: [first] ${ls}px [second] ${Gs}px;
...
`;
class ae {
  static opened = new ae("opened");
  static active = new ae("active");
  static closed = new ae("closed");
  constructor(e) {
    this.name = e;
  }
}
class Im extends ee {
  ...
  onOutsideClickListener(e) {
    if (!this.contains(e.target) && this.state === ae.opened && (this.state = ae.active, this.classList.toggle("active"), document.removeEventListener("click", this.#w.click), delete this.#w.click), !this.contains(e.target) && e.target?.type === "color" && (this.state === ae.closed || this.state === ae.active))
      this.state = ae.opened, this.classList.add("active"), this.setColour(e.target.value), e.preventDefault();
    else if (!this.contains(e.target) && e.target.tagName === "LABEL" && this.state === ae.closed) {
      const i = e.target.htmlFor, s = e.target.parentElement.querySelector(`#${i}`);
      s?.type === "color" && (this.state = ae.opened, this.classList.add("active"), this.setColour(s.value), e.preventDefault());
    } else !this.contains(e.target) && e.target.tagName === "LABEL" && this.state === ae.opened ? (this.state = ae.closed, this.classList.remove("active"), e.preventDefault()) : this.contains(e.target) || (this.state = ae.closed, this.classList.remove("active"));
  }
  onCanvasClick(e) {
  ...
  open(e, i, s) {
    return this.state !== ae.closed ? !1 : (s?.cfg == "gradient" || (this.#S.cfg == "default", this.#g.setAttribute("orient", "horizontal"), this.#g.setAttribute("width", ls), this.#g.setAttribute("height", "")), this.setColour(e), this.target = i, this.state = ae.opened, this.classList.add("active"), setTimeout(() => {
      this.#w.click = this.onOutsideClickListener.bind(this), document.addEventListener("click", this.#w.click);
    }, 250), !0);
  }
  close() {
    this.state = ae.closed, this.classList.remove("active");
  }
  build() {
  ...
  canvasNode(e) {
    ...
    const r = s.viewport, o = n.viewport, l = {}, c = this.#y.size, p = { x: 0, y: 0, width: c, height: c };
    this.#y.layers = l, this.#y.view = r, l.grid = new X.Layer(p), r.addLayer(l.grid), l.rgbv = new X.Layer(p), o.addLayer(l.rgbv), this.#y[e] = { element: i, viewport: s, layers: l };
    let f = l.rgbv.scene.context, C = [0, 0, c, 0];
    return Yi(f, C, ["#f00f", "#ff0f", "#0f0f", "#0fff", "#00ff", "#f0ff", "#f00f"]), f.fillRect(0, 0, c, c), f = l.rgbv.scene.context, C = [0, 0, 0, c], Yi(f, C, ["#fff", "#0000", "#000"]), f.fillRect(0, 0, c, c), f = l.grid.scene.context, xr(f, 8, 16, 16, "#fff", "#ccc"), r.render(), o.render(), i;
  }
  viewportNode(e) {
    const i = document.createElement("div");
...
customElements.get("tradex-colourpicker") || window.customElements.define("tradex-colourpicker", Im);
const Ul = document.createElement("template"), Bn = 24, Oa = Bn;
Ul.innerHTML = `
<style>
  .swatch {
...
<div class="colourInput">
  <div class="swatch">
    <canvas width="${Bn}" height="${Oa}"></canvas>
...
customElements.get("tradex-colourinput") || window.customElements.define("tradex-colourinput", Nm);
const Rm = "#?([0-9a-f]{3}|[0-9a-f]{6}|[0-9a-f]{8})", Da = /^#?([0-9a-f]{3}|[0-9a-f]{6}|[0-9a-f]{8})$/i, Ia = /^hsla?((\d{1,3}?),\s*(\d{1,3}%),\s*(\d{1,3}%)(,\s*[01]?\.?\d*)?)$/, Na = /^hsla[(]\s*0*(?:[12]?\d{1,2}|3(?:[0-5]\d|60))\s*(?:\s*,\s*0*(?:\d\d?(?:\.\d+)?\s*%|\.\d+\s*%|100(?:\.0*)?\s*%)){2}\s*,\s*0*(?:\.\d+|1(?:\.0*)?)\s*[)]$/, Ra = /^rgba?((\d{1,3}%?),\s*(\d{1,3}%?),\s*(\d{1,3}%?)(,\s*[01]?\.?\d*)?)$/, ka = /^^rgba[(](?:\s*0*(?:\d\d?(?:\.\d+)?(?:\s*%)?|\.\d+\s*%|100(?:\.0*)?\s*%|(?:1\d\d|2[0-4]\d|25[0-5])(?:\.\d+)?)\s*,){3}\s*0*(?:\.\d+|1(?:\.0*)?)\s*[)]$/;
class pt {
  #e = {
    r: null,
    g: null,
...
class km {
  ...
  validateMatrix(e) {
    return M(e) && e.length == 2 && I(e[0]) && I(e[1]);
  }
  validateColours(e) {
...
function Tt(a, e) {
  const i = zl(e), s = i.ctx;
  let n;
  if (Object.keys(qs).includes(a))
    n = qs[a];
  else {
    let r = new pt(a);
    n = r.isValid ? r.hexa : qs.alpa;
  }
...
const K = {
  ...
  renderSpline: wm,
  renderLine: Cm,
  renderLineHorizontal: Et,
  renderLineVertical: xm,
  renderCircle: Tm,
  renderRect: wr,
  renderRectFill: Ss,
  renderRectStroke: Ol,
  renderRectRound: pm,
  renderRectRoundFill: Il,
  renderRectRoundStroke: Dl,
  renderPolygonRegular: Rl,
  renderPolygonIrregular: fm,
  renderDiamond: ym,
  renderTriangle: gm,
  renderCheckerBoard: xr,
  chartBar: Sm
};
class Gl {
  areaCoordinates = [];
  ...
  draw(e) {
    ...
    l = Es(l);
    let c = Math.max(Math.floor(l * 0.5), 1), p = Math.abs(e.o - e.c), f = e.c === e.o ? 1 : 2, C = e.x, E = Math.floor(C) - 0.5;
    if (i.save(), i.strokeStyle = o, i.beginPath(), i.moveTo(E, Math.floor(e.h)), s.candle.Type === be.OHLC ? i.lineTo(E, Math.floor(e.l)) : n ? (i.lineTo(E, Math.floor(e.c)), i.moveTo(E, Math.floor(e.o))) : (i.lineTo(E, Math.floor(e.o)), i.moveTo(E, Math.floor(e.c))), i.lineTo(E, Math.floor(e.l)), i.stroke(), l == 3) {
      i.fillStyle = o;
      let L = n ? 1 : -1;
      i.rect(
        Math.floor(C - c),
    ...
    } else if (l > 3 && !this.fill && s.candle.Type !== be.OHLC) {
      let L = n ? 1 : -1;
      i.rect(
        Math.floor(C - c),
        e.c,
    ...
    } else s.candle.Type === be.OHLC ? (i.beginPath(), i.moveTo(E - c, e.o), i.lineTo(E, e.o), i.moveTo(E, e.c), i.lineTo(E + c, e.c), i.stroke()) : (i.strokeStyle = o, i.beginPath(), i.moveTo(
      E,
...
class $a {
  ...
  draw(e) {
    ...
    for (let r of e) {
      ...
      o = Es(o), l = l - o / 2, c < p ? (n = p - c, s.fill = "#0f0") : (n = c - p, c = p, s.fill = "#f00"), wr(i, l, c, o, n, s);
    }
  }
}
function _m(a, e, i, s, n, r) {
  let o = e - i;
  Ss(a, 0, i, s, o, r), Et(a, e, 0, s, r), Et(a, i, 0, s, r);
}
class te {
  static isOverlay = !0;
  #e;
  ...
  getXAxis() {
    return this.#n instanceof Xi ? this.#n : this.core.Chart.time?.xAxis instanceof Xi ? this.core.Chart.time.xAxis : "time" in this.#e ? this.#e.time.xAxis : !1;
  }
  getYAxis() {
    return this.#r instanceof hi ? this.#r : this.chart?.yAxis instanceof hi ? this.chart.yAxis : "scale" in this.#e ? this.#e.scale.yAxis : !1;
  }
  contextIs() {
    return !this.#n && !this.#r ? "chart" : this.getXAxis() instanceof Xi ? "timeline" : this.getYAxis() instanceof hi ? "scale" : !1;
  }
  mustUpdate() {
  ...
  plot(e, i, s) {
    ...
    switch (n.save(), i) {
      ...
      case "renderCircle":
        ...
        break;
      case "renderImage":
        K[i](n, s.src, r[0], r[1], r[2], r[3], r[4], r[5], r[6], r[7]);
        break;
      case "renderText":
        K[i](n, r[0], r[1], s);
        break;
...
class ve {
  ...
  `;
  static create(e, i) {
    return i.id = i?.id || ne("window"), i.id = `${i.id}_${++ve.windowCnt}`, i.type = i?.type || ve.type, i.class = i?.class || "window", ve.windowList[i.id] = new ve(e, i), ve.windowList[i.id];
  }
  static destroy(e) {
  ...
  onOutsideClickListener(e) {
    if (!this.#h.contains(e.target) && Pt(this.#h) && !this.#w) {
      let i = {
  ...
  mount(e) {
    e.lastElementChild == null ? e.innerHTML = this.windowNode() : e.lastElementChild.insertAdjacentHTML("afterend", this.windowNode()), this.#h = this.#l.querySelector(`#${this.#s.id}`), this.#o = this.#h.querySelector(".dragBar"), this.#c = this.#h.querySelector(".title"), this.#u = this.#h.querySelector(".closeIcon"), this.#d = this.#h.querySelector(".content"), this.#E = this.allContentFields(), this.#h.addEventListener("click", this.onWindow.bind(this)), W(this.#o) && (this.#x = new Xe(this.#o, { disableContextMenu: !1 }), this.#x.on("pointerdrag", this.onDragBar.bind(this)), this.#x.on("pointerdragend", this.onDragBarEnd.bind(this)));
  ...
  windowNode() {
    ...
    return `
      ...
      <div id="${e.id}" class="${bc} ${e.class}" style="${i}">
          ${s}
          ${n}
          ${o}
          ${r}
  ...
  position(e) {
    ...
    if (v(e)) {
      let { x: E, y: L, z: N } = { ...e };
      P(E) && (r = E), P(L) && (o = L), P(N) && (l = N), this.#p = { x: E, y: L, z: l };
    }
...
const Fm = {
  ...
  CDL3OUTSIDE: sp,
  CDL3STARSINSOUTH: np,
  CDL3WHITESOLDIERS: rp,
  CDLABANDONEDBABY: ap,
  CDLADVANCEBLOCK: op,
  CDLBELTHOLD: lp,
  CDLBREAKAWAY: hp,
  CDLCLOSINGMARUBOZU: cp,
  CDLCONCEALBABYSWALL: up,
  CDLCOUNTERATTACK: dp,
  CDLDARKCLOUDCOVER: mp,
  CDLDOJI: pp,
  CDLDOJISTAR: fp,
  CDLDRAGONFLYDOJI: gp,
  CDLENGULFING: yp,
  CDLEVENINGDOJISTAR: vp,
  CDLEVENINGSTAR: bp,
  CDLGAPSIDESIDEWHITE: wp,
  CDLGRAVESTONEDOJI: xp,
  CDLHAMMER: Cp,
  CDLHANGINGMAN: Tp,
  CDLHARAMI: Sp,
  CDLHARAMICROSS: Ep,
  ...
  CDLHIKKAKEMOD: Lp,
  CDLHOMINGPIGEON: Ap,
  CDLIDENTICAL3CROWS: Op,
  CDLINNECK: Dp,
  CDLINVERTEDHAMMER: Ip,
  CDLKICKING: Np,
  CDLKICKINGBYLENGTH: Rp,
  CDLLADDERBOTTOM: kp,
  CDLLONGLEGGEDDOJI: $p,
  CDLLONGLINE: Hp,
  CDLMARUBOZU: _p,
  CDLMATCHINGLOW: Fp,
  CDLMATHOLD: Bp,
  CDLMORNINGDOJISTAR: Up,
  CDLMORNINGSTAR: Vp,
  CDLONNECK: zp,
  CDLPIERCING: Wp,
  CDLRICKSHAWMAN: Gp,
  CDLRISEFALL3METHODS: qp,
  CDLSEPARATINGLINES: jp,
  CDLSHOOTINGSTAR: Xp,
  CDLSHORTLINE: Yp,
  CDLSPINNINGTOP: Kp,
  CDLSTALLEDPATTERN: Zp,
  CDLSTICKSANDWICH: Qp,
  CDLTAKURI: Jp,
  CDLTASUKIGAP: e0,
  CDLTHRUSTING: t0,
  CDLTRISTAR: i0,
  CDLUNIQUE3RIVER: s0,
  CDLUPSIDEGAP2CROWS: n0,
  CDLXSIDEGAP3METHODS: r0,
  CEIL: a0,
  CMO: Zl,
  CORREL: o0,
  COS: l0,
...
const Tf = 5, Sf = [
  "highLowRange"
], Ef = ["outputLegend", "outputOrder", "render", "style"], Dt = new km();
class Ht {
...
class V extends te {
  ...
  constructor(e, i = !1, s = !1, n, r, o) {
    super(e, i, s, void 0, r, o), v(this.definition) || Cf(`Indicator: ${this.shortName}`, "does not provide a valid definition");
    const l = o.overlay;
    this.#i = V.cnt, this.#m = l, this.id = l?.id || ne(this?.shortName || l?.name), this.#s = l?.key || Un(l), this.#y = this.core.TALib, this.#b = this.core.range, this.legendName = l?.legendName || l?.name || this?.shortName, this.#h = j(l?.legendVisibility) ? l.legendVisibility : !0, this.#A = j(l?.gapFill) ? l.gapFill : !0, this.#P = Dt, this.style = v(l?.settings?.style) ? { ...this.constructor.defaultStyle, ...l.settings.style } : { ...this.constructor.defaultStyle, ...n.style };
  ...
  setLegendName(e) {
    this.#l = T(e) ? e : this.overlay?.name || this.shortName || this.#t, this.chart.legend.modify(this.#E, { legendName: this.#l });
  }
  setLegendVisibility(e) {
    this.#h = !!e, this.chart.legend.modify(this.#E, { legendVisibility: !!e });
  }
  ...
  destroy(e = !0) {
    if (this.#T !== Me.destroyed) {
      ...
      this.core.hub.expunge(this), this.chart.legend.remove(this.#E), this.clear(), this.core.MainPane.draw(void 0, !0), this.chartPane.graph.removeOverlay(this.id), super.destroy(), e && this.core.state.removeIndicator(this.id), this.#T = Me.destroyed;
    }
  }
  remove() {
  ...
  dataProxy(e, i = []) {
    ...
    D(e) && e(o, n, s), this.data.length = 0;
    for (let p of o)
      this.data.push(p);
  }
  visible(e) {
  ...
  defineIndicator(e, i) {
    ...
    let r = this.definition, o = r.meta, l = [], c = xf?.[this.libName]?.outputs || [];
    r.input = v(r.input) ? { ...r.input, ...s } : s, r.output = v(r.output) ? r.output : {}, o = v(o) ? o : n.meta, o.input = v(o.input) ? o.input : {}, o.output = !M(o.output) || !o.output.length ? c : [...c, ...o.output], o.outputOrder = M(o.outputOrder) ? o.outputOrder : [], o.outputLegend = v(o.outputLegend) ? o.outputLegend : {}, Go(o.style) || (o.style = this.style || {}), this.validateInputs(r, s, i), this.populateMetaInputs(r), this.validateOutputs(r, i, l), this.buildOutputOrder(o, l), this.buildOutputLegends(r), this.buildConfigOutputTab(o);
  }
  retrieveInput(e) {
  ...
  defaultOutputField(e, i, s, n, r, o, l) {
    ...
    switch (n) {
      case "number":
        p = [C], c = (L) => {
          this.configDialogue.provideEventListeners(`#${e}`, p)(L);
        };
        break;
      case "color":
        p = [C, Pf, Mf], c = (L) => {
          this.configDialogue.provideInputColor(L, `#${e}`), this.configDialogue.provideEventListeners(`#${e}`, p)(L);
        }, n = "text";
        break;
      case "dash":
        p = [C], c = (L) => {
  ...
  legendInputs(e = this.chart.cursorPos) {
    ...
    for (let f of this.definition.meta.output) {
      ...
      f.type == "overlay" || !M(C) || C.length == 0 || (i[p] = !1, n[f.name] = this.scale.nicePrice(this.overlay.data[l][p + 1]), f.plot == "histogram" ? this.overlay.data[l][p + 1] < 0 ? s[p] = this.definition.meta.style?.[f.name].dnStroke : s[p] = this.definition.meta.style?.[f.name].upStroke : s[p] = this.definition.meta.style?.[f.name]?.colour?.value || "#ccc", p++);
    }
  ...
  noCalcCustom(e, i = this.range) {
    return this.chart.status == "destroyed" || !this.core.TALibReady || !D(e) || !v(i) || i.dataLength < this.definition.input.timePeriod;
  }
  calcIndicator(e, i = {}, s, n) {
    ...
    let E = [], L, N, k;
    for (; l < c; )
      N = this.indicatorInput(l, l + f), i = { ...i, ...N }, L = r(i), k = this.formatValue(L), E.push([s.value(l + p - 1)[0], ...k]), l++;
    return E;
  }
  ...
  plotIt(e, i, s, n, r) {
    ...
    let C = [];
    for (; e; )
      i < 0 || i >= o.length || !M(o[i]) ? C.push({ x: null, y: null }) : (p.x = this.xAxis.xPos(o[i][0]), p.y = this.yAxis.yPos(o[i][s]), C.push({ ...p })), i++, e--;
    for (let E in r)
  ...
  draw(e = this.range) {
    ...
    for (let E of C) {
      let L = this.formatStyle(this.definition.meta.style[E], E);
      this.plotIt(c, l, n[E].x, n[E].r, L);
    }
...
function Un(a) {
  const e = JSON.stringify(a), i = nr(e);
  return `${ut}_Indicator_${i}`;
}
let js = "ADX", _a = "Average Directional Movement Index";
class Lf extends V {
  get name() {
    return _a;
  }
...
let Xs = "ATR", Fa = "Average True Range";
class Af extends V {
  get name() {
    return Fa;
  }
...
let Ks = "CCI", za = "Commodity Channel Index";
class If extends V {
  get name() {
    return za;
  }
...
let Zs = "CMO", Wa = "Chande Momentum Oscillator";
class Nf extends V {
  get name() {
    return Wa;
  }
...
let Qs = "DX", ja = "Directional Movement Index";
class kf extends V {
  get name() {
    return ja;
  }
...
let Js = "EMA", Xa = "Exponential Moving Average";
class Tr extends V {
  get name() {
    return Xa;
  }
  ...
  constructor(e, i = !1, s = !1, n, r, o) {
    super(e, i, s, n, r, o), Tr.inCnt++, this.init(Jl);
  }
}
let en = "MA", Ya = "Moving Average";
class _t extends V {
  get name() {
    return Ya;
  }
  ...
  constructor(e, i = !1, s = !1, n, r, o) {
    super(e, i, s, n, r, o), _t.inCnt++, this.init(eh);
  }
}
let tn = "MMA", Ka = "Moving Average Multi";
class Nt extends V {
  static nameShort = tn;
  static nameLong = Ka;
  static version = "1.0";
...
let sn = "MACD", $f = "Moving Average Convergence/Divergence";
class Sr extends V {
  get name() {
  ...
  static timePeriodMultiplier = !0;
  constructor(e, i = !1, s = !1, n, r, o) {
    super(e, i, s, n, r, o), Sr.inCnt++, this.init(th);
  }
  draw() {
    return super.draw();
  }
}
let nn = "MFI", Za = "Money Flow Index";
class Hf extends V {
  get name() {
    return Za;
  }
...
let rn = "OBV", Qa = "On Balance Volume";
class _f extends V {
  get name() {
    return Qa;
  }
...
let an = "PPO", Ff = "Percentage Price Oscillator";
class Bf extends V {
  get name() {
...
let on = "PSAR", Ja = "Parabolic Stop and Reverse";
class Uf extends V {
  get name() {
    return Ja;
  }
...
let hn = "RSI", to = "Average Directional Movement Index";
class hs extends V {
  get name() {
    return to;
  }
...
let cn = "SMA", io = "Simple Moving Average";
class Er extends V {
  get name() {
    return io;
  }
  ...
  constructor(e, i = !1, s = !1, n, r, o) {
    super(e, i, s, n, r, o), Er.inCnt++, this.init(lh);
  }
}
let un = "STOCH", so = "Stochastic Oscillator";
class C1 extends V {
  get name() {
    return so;
  }
...
let dn = "STOCHRSI", no = "Stochastic RSI";
class zf extends V {
  get name() {
    return no;
  }
...
class Pr extends V {
  ...
  constructor(e, i = !1, s = !1, n, r, o) {
    super(e, i, s, n, r, o), Pr.inCnt++;
    const l = o.overlay;
    this.id = o.overlay?.id || ne(this.shortName), this.#e = { ...this.defaultStyle, ...this.theme.volume }, this.style = l?.settings?.style ? { ...this.#e, ...l.settings.style } : { ...this.#e, ...n.style }, this.chart.type === "primaryPane" ? (this.style.Height = B(this.style.Height, 0, 100) || 100, this.#i = !0) : (this.style.Height = 100, this.#i = !1), this.mStyle.up.colour.value = this.style.UpColour, this.mStyle.dn.colour.value = this.style.DnColour, this.mStyle.height.percent.value = this.style.Height, this.#t = new uh(e.scene, this.mStyle), this.addLegend(), this.configDialogue.start();
  }
  get primaryPane() {
    return this.#i;
  }
  ...
  draw(e = this.range) {
    ...
    let c = this.core.rangeScrollOffset, p = e.indexStart - c, f = e.Length + c * 2, C = f, E = p, L, N = 0;
    for (; C--; )
      L = e.value(E), L[4] !== null && (N = L[5] > N ? L[5] : N), E++;
    for (; f--; )
      L = e.value(p), o.x = Ue(this.xAxis.xPos(L[0]) - r / 2), L[4] !== null && (o.h = l - l * ((N - L[5]) / N), o.raw = i[p], this.#t.draw(o)), p++;
    super.updated();
  }
}
const dh = {
...
String.prototype.compress = Wf;
String.prototype.decompress = Gf;
function qf(a, e = !1) {
  if (!M(a)) return !1;
  let i = Lu(0, a.length);
  if (!Ki(a[0], e) || !Ki(a[i], e) || !Ki(a[a.length - 1], e)) return !1;
...
function jf(a, e = !1) {
  ...
  let i = 0, s = 0;
  for (; i < a.length; ) {
    if (!Ki(a[i], e) || a[i][0] < s) return !1;
    s = a[i][0], i++;
  }
  return !0;
}
function Ki(a, e = !1) {
  return !(!M(a) || a.length !== 6 || e && !ns(a[0]) || !P(a[1]) || !P(a[2]) || !P(a[3]) || !P(a[4]) || !P(a[5]));
}
function Xf(a) {
  for (let e of a)
    for (let i = 0; i < 6; i++)
...
class Yf {
  ...
  findFillGaps(e) {
    ...
    let s, n, r, o, l, c = 0, p = (e[e.length - 1][0] - e[c][0]) / i;
    for (; c < p; )
  ...
  fillRangeGaps() {
    ...
    s >= i[0] && s <= i[i.length - 1] && D(this.source?.rangeLimitPast) && this.source?.rangeLimitPast(l), n >= i[0] && n <= i[i.length - 1] && D(this.source?.rangeLimitFuture) && this.source?.rangeLimitFuture(l);
  }
...
class mn {
  ...
  add(e, i, s) {
    if (isNaN(e) || !D(s)) return !1;
    const n = ne(Kf), r = { price: e, condition: i };
    if (this.list.has(r)) {
...
const Zf = [xo, Co], Qf = ["t", "o", "h", "l", "c", "v"], Jf = 0, eg = 1, tg = 2, ig = 3, sg = 4, ng = 5, ki = [null, null, null, null, null], $i = {
  tfCountDown: !0,
  alerts: []
};
class St {
  ...
  #w;
  constructor(e, i) {
    e instanceof H ? this.#e = e : oo({ id: "invalid" }, "not a valid chart instance"), i instanceof A ? this.#i = i : oo(e, "state not a valid State instance"), this.status = { status: xo }, this.#t = rg(e.config?.stream), this.#n = P(e.config?.maxCandleUpdate) ? e.config.maxCandleUpdate : Cc, this.#a = P(e.config?.streamPrecision) ? e.config.streamPrecision : Tc;
  }
  get state() {
    return this.#i;
  }
  ...
  set dataReceived(e) {
    this.#d || (this.#d = !0, this.status = { status: Ji, data: e });
  }
  get alerts() {
    return this.#w;
  }
  ...
  set lastTick(e) {
    M(e) && (this.#g, this.#g = e, this.alerts.check(e, this.#h));
  }
  get isActive() {
    return !![
      ti,
  ...
  set candle(e) {
    ...
    fs(Qf, Object.keys(e)) && mt(e.t) && (e.ts = Date.now(), e.t = this.roundTime(new Date(e.t)), e.o = e.o * 1, e.h = e.h * 1, e.l = e.l * 1, e.c = e.c * 1, e.v = e.v * 1, this.#l = e, this.dataReceived = e, this.#h[Jf] !== e.t ? this.newCandle(e) : this.updateCandle(e), this.status = { status: ti, data: this.#h }, this.lastTick = s, i - this.#r > this.#n && this.onUpdate(), this.#r = i);
  }
  get candle() {
    return this.#h !== ki ? this.#h : null;
  }
  setLastScrollPos(e) {
    P(e) && (this.#y = e);
  }
  ...
  start() {
    if (!Zf.includes(this.status)) {
      this.#e.error("ERROR: Invoke stopStream() before starting a new one.");
      return;
    }
    this.#w instanceof mn || (this.#w = new mn(this.#t.alerts)), this.status = { status: _s };
  }
  stop() {
    this.#w instanceof mn && this.#w.destroy(), this.status = { status: Co }, this.resetLastPos();
  }
  emit(e, i) {
    this.#e.emit(e, i);
  }
  error() {
    this.status = { status: xc };
  }
  onTick(e) {
    if ((this.#s == _s || this.#s == ti) && v(e)) {
      if (!I(e.t * 1)) return;
  ...
  onUpdate() {
    this.#i?.isActive && this.#h !== ki && (this.status = { status: et, data: this.candle }, this.status = { status: ti, data: this.#h });
  }
  newCandle(e) {
    this.prevCandle(), this.#h = [
      ...
      null,
      !0
    ], console.log(`State: ${this.#i.key} new candle:`, this.#h), this.#i.mergeData({ ohlcv: [this.#h] }, !0, !1), this.status = { status: es, data: { data: e, candle: this.#h } }, this.#c = this.#i.timeFrame, this.#o = this.roundTime(e.ts);
  }
  prevCandle() {
  ...
  updateCandle(e) {
    let i = this.#h;
    i[eg] = e.o, i[tg] = e.h, i[ig] = e.l, i[sg] = e.c, i[ng] = e.v, this.#h = i, console.log(`State: ${this.#i.key} candle update:`, i);
    const s = this.#i.data.chart.data, n = s.length > 0 ? s.length - 1 : 0;
    s[n] = this.#h, this.#i?.isActive && this.countDownUpdate();
  }
  countDownUpdate() {
    let e, i, s, n, r, o, l, c = this.#i.timeFrame, p = this.#l.ts, f = c - (p - this.#o);
    return f < 0 && (f = 0), this.#c = f, f > $e ? (e = String(Math.floor(f / $e)), i = String(Math.floor(f % $e / Ae)).padStart(2, "0"), this.#u = `${e}Y ${i}M`) : f > Ae ? (i = String(Math.floor(f / Ae)).padStart(2, "0"), n = String(Math.floor(f % Ae / q)).padStart(2, "0"), this.#u = `${i}M ${n}D`) : f > Ft ? (s = String(Math.floor(f / Ft)).padStart(2, "0"), n = String(Math.floor(f % Ae / q)).padStart(2, "0"), this.#u = `${s}W ${n}D`) : f > q ? (n = String(Math.floor(f / q)).padStart(2, "0"), r = String(Math.floor(f % q / ge)).padStart(2, "0"), o = String(Math.floor(f % ge / J)).padStart(2, "0"), this.#u = `${n}D ${r}:${o}`) : f > ge ? (r = String(Math.floor(f / ge)).padStart(2, "0"), o = String(Math.floor(f % ge / J)).padStart(2, "0"), l = String(Math.floor(f % J / oe)).padStart(2, "0"), this.#u = `${r}:${o}:${l}`) : f > J ? (o = String(Math.floor(f / J)).padStart(2, "0"), l = String(Math.floor(f % J / oe)).padStart(2, "0"), this.#u = `00:${o}:${l}`) : (l = String(Math.floor(f / oe)).padStart(2, "0"), String(f % oe).padStart(4, "0"), this.#u = `00:00:${l}`), this.#u;
  }
  roundTime(e) {
...
function rg(a) {
  if (v(a)) {
    let e = Z($i);
    a = Ve(e, a), a.tfCountDown = j(a.tfCountDown) ? a.tfCountDown : $i.tfCountDown, a.alerts = M(a.alerts) ? a.alerts : $i.alerts;
  } else
    return $i;
  return a;
}
...
class ag {
  ...
  #s = [];
  constructor(e, i) {
    this.#e = e, this.#t = T(i.id) ? i.id : ne, this.#i = T(i.type) ? i.type : "default", this.#s = M(i.data) ? i.data : [];
  }
}
class Ps {
  #e;
  ...
  notify(e, i) {
    ...
    let n = s.on[e];
    if (!n || !D(n.action) || this.#a !== "running" && this.#a !== "await")
      return !1;
  ...
  static validateConfig(e) {
    ...
    for (let n in e.states) {
      if (!v(e.states[n]) || "onEnter" in e.states[n] && !D(e.states[n].onEnter) || "onExit" in e.states[n] && !D(e.states[n].onExit)) return !1;
      if ("on" in e.states[n])
        for (let r in e.states[n].on) {
          let o = e.states[n].on[r];
          if (!T(o.target) || "action" in o && !D(o.action)) return !1;
        }
    }
    return !0;
  }
...
class ft {
  ...
  createViewport(e = [], i = !1) {
    ...
    this.#n = new r({
      ...
      height: n,
      container: this.#h
    }), this.#l = this.#n.scene.canvas, this.#r = new og(this, e);
  }
  layerConfig() {
...
class Ar {
  ...
  #u;
  constructor(e) {
    this.#t = Ar.#e++, this.#i = e.core, this.#s = W(e.elContainer) ? e.elContainer : !1, this.#n = W(e.elHandle) ? e.elHandle : !1, this.#u = D(e.callback) ? e.callback : !1, W(this.#s) && W(this.#n) && (this.mount(), this.eventsListen());
  }
  set cursor(e) {
  ...
  handlePos(e) {
    let i = this.#i.range, s = parseInt(this.#n.style.marginLeft), n = this.#s.getBoundingClientRect().width, r = this.#n.getBoundingClientRect().width, o = n - r, l = e.position.x - this.#o.x, c = B(s + l, 0, o), p = (i.dataLength + i.limitFuture + i.limitPast) / n, f = Math.floor(c * p);
...
const dg = [
  ["labels", { class: hg, fixed: !1, required: !0 }],
  ["overlay", { class: cg, fixed: !1, required: !0 }],
  ["cursor", { class: ug, fixed: !1, required: !0 }]
];
class mg extends Lt {
  #e = "Timeline";
  #t = "time";
  ...
  #E = { end: !1, start: !1 };
  constructor(e, i) {
    super(e, i), this.#r = i.elements.elTime, this.#i = e.Chart, this.#s = new Xi(this), this.init();
  }
  get name() {
    return this.#e;
  }
  ...
  start() {
    this.createGraph(), this.onSetRange(), this.#s.initXAxisGrads(), this.draw(), this.eventsListen(), pn.id = this.id, pn.context = this, this.stateMachine = pn, this.stateMachine.start(), this.log(`Timeline ${this.#e} instantiated and running`);
  }
  destroy() {
  ...
  eventsListen() {
    this.#f = new Xe(this.#a, { disableContextMenu: !1 }), this.#f.on("dblclick", this.onDoubleClick.bind(this)), this.#f.on("pointerover", this.onPointerEnter.bind(this)), this.#f.on("pointerout", this.onPointerLeave.bind(this)), this.#f.on("pointerdrag", this.onPointerDrag.bind(this)), this.#S = new Xe(this.#d, { disableContextMenu: !1 }), this.#S.on("pointerover", () => this.showJump(this.#P.end)), this.#S.on("pointerleave", () => this.hideJump(this.#P.end)), this.#v = new Xe(this.#u, { disableContextMenu: !1 }), this.#v.on("pointerover", () => this.showJump(this.#P.start)), this.#v.on("pointerleave", () => this.hideJump(this.#P.start)), this.on("main_mouseMove", this.#w.draw, this.#w), this.on("range_set", this.onSetRange, this), this.#d.addEventListener("click", Oe(this.onPointerClick, 1e3, this, !0)), this.#u.addEventListener("click", Oe(this.onPointerClick, 1e3, this, !0));
  }
  onPointerClick(e) {
...
const pg = {
  ...
  status: !1,
  init: function(a) {
    v(a) && (this.renderLog = a?.renderLog || !1, this.dropFrames = a?.dropFrames || !0, this.graphs = M(a?.graphs) ? [...a.graphs] : [], this.range = v(a?.range) ? a.range : {});
  },
...
class fg {
  ...
  add(e) {
    ...
    e.id = e?.id || ne("legend"), e.type = e?.type || "overlay", e.title = e?.title || e?.parent.legendName, e.parent = e?.parent || i, e.visible = j(e?.visible) ? e.visible : !0;
...
class bg extends te {
  ...
  draw(e) {
    ...
    this.scene.clear(), i.save(), e[4] >= e[1] ? o.bakCol = this.theme.candle.UpBodyColour : o.bakCol = this.theme.candle.DnBodyColour, Ut(i, r, l, p, o), s && (r = this.core.stream.countDownUpdate(), o.fontSize = o?.fontSize / 1.1, Ut(i, r, l, p + c, o)), i.restore(), this.viewport.render();
  }
}
const wg = [
  ["labels", { class: yg, fixed: !0, required: !0 }],
  ["overlay", { class: vg, fixed: !0, required: !0 }],
  ["price", { class: bg, fixed: !0, required: !0 }],
  ["cursor", { class: mh, fixed: !0, required: !0 }]
];
class xg extends Lt {
  #e = "Y Scale Axis";
  #t = "scale";
  ...
  start() {
    ...
    this.setYAxis(), e.font = Vt(i.fontSize, i.fontWeight, i.fontFamily), this.#p = br(e, "0");
  ...
  onMouseMove(e) {
    this.#b = M(e) ? e : [Math.floor(e.position.x), Math.floor(e.position.y)], this.#c.draw(this.#b);
  }
  onDrag(e) {
    this.#b = [
  ...
  setDimensions(e = {}) {
    e = v(e) ? e : {};
    const i = e?.w || this.width || Ot * ke.FONTSIZE * zn, s = e?.h || this.parent.height;
    this.#f(i), this.#w(s), this.graph instanceof ft && (this.graph.setSize(i, s, i), this.draw()), this.#c instanceof mh && this.calcPriceDigits();
  }
  setYAxis() {
  ...
  calcScaleWidth() {
    return (this.calcPriceDigits() + 2) * this.#p * zn;
  }
  addOverlays(e) {
    if (!M(e)) return !1;
...
class Cg extends te {
  ...
  draw() {
    ...
    if (super.mustUpdate(), e?.display !== !1) {
      if (e?.imgURL)
        this.watermark.imgURL = e.imgURL, Zn(e?.imgURL, this.renderImage.bind(this));
      else if (T(e?.text)) {
  ...
  renderText(e) {
    ...
    const p = Ts(l), f = Cs(c, e, l), C = (this.scene.width - f) / 2, E = (this.core.Chart.height - p) / 2;
    c.fillText(e, C, E);
  }
  renderImage(e) {
    if (!e) return;
    ...
    o.save(), Vl(o, e, n, r, i, s), o.restore();
  }
}
class Tg extends te {
  #e;
  #t;
  constructor(e, i = !1, s = !1, n, r, o) {
    super(e, i, s, n, r, o), this.#e = new uh(e.scene, n), this.theme.volume.Height = B(n?.volume?.Height, 0, 100) || 100;
  }
  set position(e) {
    this.target.setPosition(e[0], e[1]);
  }
  draw(e = this.core.range) {
    ...
    for (; C--; )
      L = e.value(E), L[4] !== null && (N = L[5] > N ? L[5] : N), E++;
    for (; f--; )
      L = e.value(p), o.x = Ue(this.xAxis.xPos(L[0]) - r / 2), L[4] !== null && (o.h = l - l * ((N - L[5]) / N), o.raw = i[p], this.#e.draw(o)), p++;
    super.updated();
  }
}
class ph extends te {
  #e;
  constructor(e, i = !1, s = !1, n, r) {
    super(e, i, s, n, r), this.#e = new Gl(e.scene, n);
  }
  set position(e) {
    this.target.setPosition(e[0], e[1]);
  }
...
class Sg extends te {
  #e;
  constructor(e, i = !1, s = !1, n, r, o) {
    super(e, i, s, n, r, o), this.#e = new Gl(e.scene, n), this.theme.priceLineStyle = this.theme?.priceLineStyle || hm;
  }
  set position(e) {
  ...
  draw() {
    ...
    r.o = this.yAxis.yPos(i[1]), r.h = this.yAxis.yPos(i[2]), r.l = this.yAxis.yPos(i[3]), r.c = this.yAxis.yPos(i[4]), r.raw = i, e.inRenderRange(i[0]) && s(r), i[4] >= i[1] ? this.theme.priceLineStyle.stroke = this.core.theme.candle.UpBodyColour : this.theme.priceLineStyle.stroke = this.core.theme.candle.DnBodyColour, Et(
      this.scene.context,
      r.c,
      0,
      this.target.width,
...
class Eg extends te {
  constructor(e, i = !1, s = !1, n, r, o) {
    super(e, i, s, n, r, o);
    const l = { class: Pg, fixed: !0, required: !1 };
...
class Pg extends te {
  ...
  scaleDraw(e = this.core.range) {
    ...
    c.colourCursorBG = this.theme?.hilo?.colour || ni.colour, i = this.chart.Scale.nicePrice(o), s = 1, n = this.yAxis.yPos(o) + 1, r = this.viewport.width, us(p, i, s, n, r, c), i = this.chart.Scale.nicePrice(l), n = this.yAxis.yPos(l) + 1, us(p, i, s, n, r, c), super.updated();
  }
}
...
class Mg {
  ...
  icon;
  constructor(e, i) {
    this.scene = e.scene, this.hit = e.hit, this.ctx = this.scene.context, this.ctxH = this.hit.context, this.width = this.scene.width, this.cfg = i.events, this.dims = { w: this.cfg.iconWidth, h: this.cfg.iconHeight }, this.icon = ts(this.cfg.iconEvent, this.cfg.iconColour, this.dims);
  }
  draw(e) {
    this.data = e;
    const i = this.icon, s = this.cfg, n = this.hit.getIndexValue(e.key), r = Tt(n, i), o = B(e.w, s.iconMinDim, s.iconHeight), l = B(e.w, s.iconMinDim, s.iconWidth), c = this.data.x, p = this.data.y, f = this.ctx, C = this.ctxH;
...
class Lg extends te {
  ...
  #i;
  constructor(e, i = !1, s = !1, n, r, o) {
    super(e, i, s, n, r, o), this.#e = new Mg(e, n), this.core.on("chart_primaryPointerDown", this.onPrimaryPointerDown, this), ho.parent = this, this.#i = this.core.WidgetsG.insert("Dialogue", ho), this.#i.start();
  }
  set position(e) {
    this.target.setPosition(e[0], e[1]);
  }
  ...
  isNewsEventSelected(e) {
    ...
    let f = Object.keys(this.data)[n] * 1, C = this.xAxis.xPos(l) + c, E = s - o * 1.5 - p.height, L = "";
    for (let k of this.data[f])
      L += this.buildNewsEventHTML(k);
    const N = {
      dimensions: { h: void 0, w: 150 },
      position: { x: C + o / 2 + 1, y: E },
      content: L,
      offFocus: ci + 1
    };
...
class Ag {
  ...
  dims = { w: 0, h: 0 };
  constructor(e, i) {
    this.scene = e.scene, this.hit = e.hit, this.ctx = this.scene.context, this.ctxH = this.hit.context, this.width = this.scene.width, this.cfg = i.trades, this.dims = { w: this.cfg.iconWidth, h: this.cfg.iconHeight }, this.buy = ts(this.cfg.iconBuy, this.cfg.buyColour, this.dims), this.sell = ts(this.cfg.iconSell, this.cfg.sellColour, this.dims);
  }
  draw(e) {
    this.data = e;
    const i = this.cfg, s = e.side === "buy" ? this.buy : this.sell;
    e.side === "buy" ? i.iconBuy : i.iconSell;
    const n = this.hit.getIndexValue(e.key), r = Tt(n, s), o = B(e.w, i.iconMinDim, i.iconHeight), l = B(e.w, i.iconMinDim, i.iconWidth), c = this.data.x, p = this.data.y, f = this.ctx, C = this.ctxH;
...
class Og extends te {
  ...
  #s;
  constructor(e, i = !1, s = !1, n, r, o) {
    super(e, i, s, n, r, o), this.settings = o.settings, A.importData("trades", this.data, this.state, this.state.time.timeFrame), this.#e = new Ag(e, n), this.core.on("chart_primaryPointerDown", this.onPrimaryPointerDown, this), co.parent = this, this.#s = this.core.WidgetsG.insert("Dialogue", co), this.#s.start();
  }
  destroy() {
  ...
  isTradeSelected(e) {
    ...
    let E = Object.keys(this.data)[o] * 1, L = this.xAxis.xPos(p) + f, N = r - c * 1.5 - C.height, k = "";
    for (let le of this.data[E])
      k += this.buildTradeHTML(le);
    const Y = {
      dimensions: { h: void 0, w: 150 },
      position: { x: L + c / 2 + 1, y: N },
      content: k,
      offFocus: ci + 1
    };
    this.core.emit("trade_selected", E), this.#s.open(Y);
  }
  buildTradeHTML(e) {
    let i = `<style>
...
class Le extends te {
  ...
  constructor(e, i = !1, s = !1, n, r, o) {
    super(e, i, s, n, r, o);
    const l = o?.overlay;
    this.#s = Le.inCnt, this.id = l?.id || ne(this.shortName), this.settings = o?.settings || {}, uo.parent = this, this.#a = this.core.WidgetsG.insert("ConfigDialogue", uo), this.#a.start(), this.eventsListen();
  }
  set id(e) {
    this.#i = dt(e);
  }
  get id() {
    return this.#i || `${this.core.ID}-${ne(this.#r)}_${this.#s}`;
  }
  get inCnt() {
    return this.#s;
  }
...
const fh = {
  primaryPane: [
    ["watermark", { class: Cg, fixed: !0, required: !0, params: { content: null } }],
    ["grid", { class: cs, fixed: !0, required: !0, params: { axes: "y" } }],
    ["candles", { class: ph, fixed: !1, required: !0 }],
    ["hiLo", { class: Eg, fixed: !0, required: !1 }],
    ["stream", { class: Sg, fixed: !1, required: !0 }],
    ["cursor", { class: Vn, fixed: !0, required: !0 }]
  ],
  secondaryPane: [
    ["grid", { class: cs, fixed: !0, required: !0, params: { axes: "y" } }],
    ["cursor", { class: Vn, fixed: !0, required: !0 }]
  ...
  primaryPane: {
    trades: { class: Og, fixed: !1, required: !1 },
    events: { class: Lg, fixed: !1, required: !1 },
    volume: { class: Tg, fixed: !1, required: !0, params: { maxVolumeH: Gi.ONCHART_VOLUME_HEIGHT } }
  },
  secondaryPane: {
    candles: { class: ph, fixed: !1, required: !0 }
  }
...
class Je extends Lt {
  ...
  constructor(e, i = {}) {
    ...
    if (this.#i = this.options.name, this.#s = this.options.shortName, this.#n = this.options.title, this.#a = this.options.type == "primary" ? "primaryPane" : "secondaryPane", this.#x = this.options.view, this.#c = this.options.elements.elScale, this.#o = this.options.elements.elTarget, this.#o.id = this.id, this.legend = new fg(this.elLegend, this), this.isPrimary)
  ...
  start() {
    this.#d = this.core.Timeline, this.createGraph(), this.#u.start(), this.draw(this.range), this.cursor = "crosshair", fn.id = this.id, fn.context = this, this.stateMachine = fn, this.stateMachine.start(), this.eventsListen(), this.isPrimary && this.setTitle(this.core.state.symbol);
  ...
  onPointerOut(e) {
    this.#E = !1, this.#v = [Math.round(e.position.x), Math.round(e.position.y)], this.scale.layerCursor.visible = !1, this.emit(`${this.id}_pointerout`, this.#v);
  }
  onPointerDown(e) {
  ...
  setScaleBar() {
    ...
    e.parent = this, e.chart = this, e.elScale = this.elScale, e.yAxisType = this.yAxisType, this.scale = new xg(this.core, e);
  }
  setTitle(e) {
    let i = this.#n, s;
    if (v(e))
  ...
  addOverlays(e) {
    ...
    for (let s of e) {
      ...
      else if (s.type in Wn[this.type])
        n.cnt = 1, n.id = `${this.id}-${s.type}`, n.class = Wn[this.type][s.type].class, n.oType = "overlayOptional";
      ...
      n.params = { overlay: s }, s.id = n.id, s.paneID = this.id, s.key = Un(s), i.push([s.id, n]);
    }
  ...
  collapse(e) {
    ...
    s.state ? (this.setDimensions({ w: void 0, h: e }), n.visibility = "visible", i.display = "block", s.state = !1) : (n.visibility = "hidden", i.display = "none", s.state = !0, s.height = this.element.clientHeight, s.rowsHeight = this.core.MainPane.rowsH, s.rowsCnt = this.core.ChartPanes.size, this.setDimensions({ W: void 0, h: Hn }));
  }
  zoomRange() {
...
class mo extends Lt {
  ...
  init(e) {
    ...
    this.#p = new mg(this.core, e), this.chartPanes.clear(), this.chartPanesRegister(e), this.#v = P(this.config.buffer) ? this.config.buffer : bs, this.#x = P(this.config.rowMinH) ? this.config.rowMinH : wa, this.#b = P(this.config.secondaryPaneDefaultH) ? this.config.secondaryPaneDefaultH : xa, this.rowsOldH = this.rowsH;
  }
  start() {
    this.#s.start(this.theme), this.#p.start(), this.createGraph(), this.rowsOldH = this.rowsH, this.chartPanesStart(), this.chartPanesSizeToInventory(), this.setScaleWidth(), this.draw(this.range, !0), this.renderLoop.init({
      graphs: [this.graph],
      range: this.range
    }), this.renderLoop.start(), this.renderLoop.queueFrame(this.range, [this.graph], !1), this.eventsListen(), gn.id = this.id, gn.context = this, this.stateMachine = gn, this.stateMachine.start(), this.log(`Main Pane ${this.#e} instantiated and running`);
  }
  destroy(e = !0) {
  ...
  eventsListen() {
    this.#T = new Xe(this.#n, { disableContextMenu: !1 }), this.#T.on("keydown", this.onChartKeyDown.bind(this)), this.#T.on("keyup", this.onChartKeyUp.bind(this)), this.#T.on("wheel", this.onMouseWheel.bind(this)), this.#T.on("pointerenter", this.onMouseEnter.bind(this)), this.#T.on("pointerout", this.onMouseOut.bind(this)), this.#T.on("pointerup", this.onChartDragDone.bind(this)), this.#T.on("pointermove", this.onMouseMove.bind(this)), this.on(Ji, this.onFirstStreamValue, this), this.on(es, this.onNewStreamValue, this), this.on("range_set", this.onSetRange, this), this.on("chart_scrollUpdate", this.draw, this), this.on("chart_render", this.draw, this), this.on("chart_paneDestroy", this.chartPaneRemove, this);
  }
  onSetRange() {
    this.#P = this.#C, this.#C = this.chart.scale.calcScaleWidth(), this.#P != this.#C && (this.core.elBody.setYAxisWidth(this.#C), this.setDimensions(), this.draw());
  }
  onMouseWheel(e) {
  ...
  setDimensions() {
    ...
    this.core.scrollPos = -1, this.#o.style.width = `${i}px`, this.#o.style.height = `${r}px`, this.#p.setDimensions({ w: i }), this.graph.setSize(i, r, o), this.#o.style.width = `${i}px`, this.chartPanes.size == 1 && n != this.#n.height ? this.#m.setDimensions({ w: i, h: this.#n.height }) : this.chartPanes.forEach((c, p) => {
  ...
  chartPanesRegister(e) {
    ...
    for (let i of this.inventory)
      M(i) && i.length > 1 && (e.type = i[0] == "primary" ? i[0] : "secondary", e.view = vi(i[1], "object") ? i[1] : [i[1]], e.state = i[2], this.chartPaneAdd(e));
  }
  ...
  chartPaneHeightsCalc(e) {
    ...
    if (n === 1)
      ...
      let c = this.rowsH;
      const p = Math.round(c * this.#b / 100);
      l[s[0].id] = c - p, l.new = p;
    } else if (s.length === 2) {
      const c = s[0].viewport.height, p = s[1].viewport.height, f = c + p, C = Math.round(f * this.#b / 100), E = f / (f + C);
      l[s[0].id] = Math.floor(c * E), l[s[1].id] = Math.floor(p * E), l.new = Math.floor(C * E), l.new += f - (l[s[0].id] + l[s[1].id] + l.new);
    } else if (s.length >= 3) {
      ...
      for (let C of s)
        l[C.id] = f * (C.viewport.height / c), p += l[C.id];
      l.new += c - p;
    }
    return l;
  }
  ...
  chartPaneCollapse(e) {
    ...
    if (r = p.indexOf(e), r > -1 && p.splice(r, 1), r = f.indexOf(e), r > -1 && f.splice(r, 1), e.collapsed.state) {
      i.classList.remove("collapsed"), i.classList.add("expanded"), s.rowsCnt !== c.length ? n = s.height * (s.rowsCnt / c.length) : s.rowsHeight !== this.rowsH ? n = s.height * (s.rowsHeight / this.rowsH) : n = s.height, o = (n - Hn) / f.length;
      for (let C of f)
      ...
      n = (e.element.clientHeight - Hn) / f.length;
      for (let C of f)
  ...
  chartPaneDividersSet() {
    ...
    let i = 0;
    for (let s of e)
      s.Divider instanceof Ee && i++ > 0 && (s.Divider.setWidth(), s.Divider.setPos(), s.Divider.show());
  }
  chartPaneDividersHide() {
    const { list: e } = this.chartPanesState();
    for (let i of e)
      i.Divider instanceof Ee && i.Divider.hide();
  }
  validateIndicators() {
    const e = (s) => v(s) && (s.type in this.core.indicatorClasses || Ig.includes(s.type)), i = (s) => M(s) ? (s.forEach((n, r) => {
  ...
  addIndicator(e, i = e, s = {}) {
    ...
    switch (this.log(`Adding the ${i} : ${e} indicator`), v(s) ? (M(s?.data) || (s.data = []), v(s?.settings) || (s.settings = {})) : s = { data: [], settings: [] }, o) {
      case !0:
      case !1:
        break;
      case void 0:
...
class Fe {
  ...
  #g = !1;
  constructor(e, i) {
    this.#a = e, this.#o = i, this.#r = i.core, this.#s = ++Fe.#i, this.symbolsAdd(e?.symbols), this.sourceSet(e?.source), this.symbolSet(e?.symbol), this.#n = ne(`${ut}_dataSource_${this.#h}`), this.timeFramesAdd(e?.timeFrames, Fe), this.timeFrameUse(e?.timeFrameInit), this.#c = this.buildRange(i), this.#u = new St(i.core, i), this.historyAdd(e?.source);
  ...
  symbolSet(e) {
    ...
    (!T(e) || T(e) && !e.length) && !i.length ? yn(this.#r.ID, this.#o.key, "symbol invalid") : T(e) && e.length > 0 ? this.#h = e : this.#h = i;
  }
  timeFramesAdd(e, i) {
    let s;
    vi(e, "integer") ? s = po(e) : !v(e) || !Object.keys(e).length ? s = i.defaultTimeFrames : s = po(Object.values(e)), this.#d = { ...s };
  }
  timeFrameUse(e) {
    e = Hi(e), I(e) || yn(this.#r.ID, this.#o.key, "time frame invalid");
    let i = this.timeFrameExists(e);
    if (I(this.#m) || (e = mi(this.#o.data.chart.data)), i) {
      if (i == this.#m) return;
      e = i;
    } else if (Object.keys(this.#d).length)
      yn(this.#r.ID, this.#o.key, "time frame invalid");
    else {
      if (e == this.#m) return;
      let n = Te(e);
      this.#d[n] = e;
    ...
    if (s instanceof A) this.#o.use(s.key);
      ...
      let n = {};
      n.dataSource = Z(this.#o.dataSource), this.#o.use(n);
    }
  }
  timeFrameExists(e) {
    if (e in this.#d) return this.#d[e];
    if (I(e) && Te(e) in this.#d)
      return e;
  }
  tickerAdd(e, i) {
    if (D(e?.start)) {
    ...
    D(e?.stop) ? this.#l.tickerStream.stop = e.stop : this.#l.tickerStream.stop = () => {
      this.#r.log(`TradeX-chart: ${this.#r.id} : DataSource : tickerStop() function is undefined`);
    };
  }
  tickerStart(e, i) {
    if (i = Hi(i), T(e) && e.length && I(i)) {
  ...
  historyAdd(e) {
    this.historyRemove();
    let i = 4;
    D(e?.rangeLimitPast) && (e.rangeLimitPast.length !== i ? Ze(this.#r, this.#o.key, `range_limitPast function requires ${i} parameters`) : (this.#l.rangeLimitPast = (s) => this.onRangeLimit(s, e.rangeLimitPast, s.startTS), this.#r.on("range_limitPast", this.#l.rangeLimitPast, this))), D(e?.rangeLimitFuture) && (e.rangeLimitFuture.length !== i ? Ze(this.#r, this.#o.key, `range_limitFuture function requires ${i} parameters`) : (this.#l.rangeLimitFuture = (s) => this.onRangeLimit(s, e.rangeLimitFuture, s.endTS), this.#r.on("range_limitFuture", this.#l.rangeLimitFuture, this)));
  }
  historyRemove() {
    D(this.#l.rangeLimitPast) && (this.#r.off("range_limitPast", this.#l.rangeLimitPast, this), this.#l.rangeLimitPast = null), D(this.#l.rangeLimitFuture) && (this.#r.off("range_limitFuture", this.#l.rangeLimitFuture, this), this.#l.rangeLimitFuture = null);
  }
  historyPause() {
    this.#r.off("range_limitPast", this.#l.rangeLimitPast, this), this.#r.off("range_limitFuture", this.#l.rangeLimitFuture, this);
  }
  historyRestart() {
    D(this.#l.rangeLimitPast) && this.#r.on("range_limitPast", this.#l.rangeLimitPast, this), D(this.#l.rangeLimitFuture) && this.#r.on("range_limitFuture", this.#l.rangeLimitFuture, this);
  }
  startTickerHistory(e) {
    this.#o.isEmpty || Ze(this.#r, this.#o.key, "startTickerHistory() cannot execute because chart is not empty"), D(e?.rangeLimitFuture) || (e.rangeLimitFuture = (s, n, r, o) => Promise.resolve({}));
    const i = {
    ...
    for (let s of Object.keys(i))
      if (s == "tf") {
        if (e.tf = Hi(e.tf), I(e.tf)) continue;
      } else {
        if (bi(i[s], e?.[s]))
          continue;
  ...
  buildRange(e) {
    ...
    !n.chart.isEmpty && n.chart.data.length > 1 && this.#m !== o && (this.#m = o), rr(this.#m) || (this.#m = i.timeFrameMS || rs);
    let l = {
      core: i,
      state: e,
...
function Hi(a) {
  return T(a) && !I(a * 1) && (a = it(a)), a * 1;
}
const Rg = "state", kg = "defaultState", yh = "Empty Chart", xt = {
  version: Lr,
  id: kg,
  key: "",
  status: "default",
...
class A {
  ...
  static chartList(e) {
    if (xn(e)) return A.#e.has(e.key) ? A.#e.get(e.key) : void 0;
  }
  ...
  static validate(e, i = A.default, s = !1, n = !1) {
    ...
    v(i.dataSource) || (i.dataSource = r.dataSource, i.dataSource.symbol = i.core.config?.symbol || "undefined"), (!T(i.dataSource.symbol) || !i.dataSource.symbol.length || i.dataSource.symbol == yh) && (i.dataSource.symbol = i.core.config?.symbol || "undefined"), v(i.chart) || (i.chart = r.chart, i.chart.data = M(i?.ohlcv) ? i.ohlcv : [], i.isEmpty = !0, i.status = "default", delete i?.ohlcv), o = Ve(r, i), s ? o.chart.data = jf(o.chart.data, n) ? o.chart.data : [] : o.chart.data = qf(o.chart.data, n) ? o.chart.data : [], o.chart.isEmpty = o.chart.data.length == 0, Object.defineProperty(
      o.allData,
      "data",
      {
        get: function() {
    ...
    ), v(o.chart.settings) || (o.chart.settings = r.chart.settings), M(o.inventory) || (o.inventory = r.inventory), M(o.primary) || (o.primary = r.primary), o.allData.primaryPane = o.primary, M(o.secondary) || (o.secondary = r.secondary), o.allData.secondaryPane = o.secondaryPane, M(o.datasets) || (o.datasets = []), o.allData.datasets = o.datasets, A.buildInventory(o, r), A.validateData("trades", o), o.trades = o.allData.trades, A.validateData("events", o), o.events = o.allData.events, A.validateData("annotations", o), o.annotations = o.allData.annotations, A.validateData("tools", o), o.tools = o.allData.tools;
    for (var l of o.datasets)
      this.#t || (this.#t = {}), this.#t[l.id] = new ag(this, l);
    return o;
  }
  static delete(e, i) {
    let s = A.chartList(e)?.states;
  ...
  static setTimeFrame(e, i, s) {
    let n = A.get(e, i), r;
    return n ? (n.isEmpty && M(s) && s.length > 1 && (r = mi(s), n.range.interval = r, n.range.intervalStr = Te(r), e?.stream instanceof St && e.stream.resetLastPos(), e.emit("range_timeframeSet", n.range.intervalStr)), r) : !1;
  }
  static ohlcv(e) {
    if (!M(e)) return !1;
    let i = {
  ...
  static export(e, i, s = {}) {
    ...
    for (let k in n.data)
      c.includes(k) || (l[k] = Z(n.data[k]));
    let p = l.chart.data;
    p.length > 0 && p[p.length - 1].length > 6 && (p.length = p.length - 1), l.inventory = M(l.inventory) ? Array.from(l.inventory) : [], l.version = Lr, l.key = n.key, l.range = n.range.export();
    let { indexed: f, timeFrame: C, timeFrameMS: E, timeZone: L, timeZoneOffset: N } = { ...n.data.timeData };
    switch (l.timeData = { indexed: f, timeFrame: C, timeFrameMS: E, timeZone: L, timeZoneOffset: N }, r) {
      case "json":
      default:
        const { replacer: k, space: Y } = { ...s };
        o = JSON.stringify(l, k, Y), s?.compress && (o = o.compress());
    }
    return o;
  }
  ...
  static validateData(e, i) {
    if (!T(e) || !(e in vn) || !v(i)) throw new Error(`ERROR: State: validateData: ${e} unexpected data`);
    if (v(i[e]) || (i[e] = Z(xt[e])), i[e].display = !!i[e]?.display, i[e].displayInfo = !!i[e]?.displayInfo, !v(i[e].data)) i[e].data = Z(xt[e].data);
    else {
  ...
  static buildInventory(e, i) {
    if (e.inventory.length == 0) {
      ...
      let o = M(e?.secondary) ? e.secondary : [];
      for (let l of o)
        (v(l) || vi(l, "object")) && e.inventory.push(["secondary", l]);
    }
    let s = e.inventory, n = s.length;
    for (; n--; )
      if (!M(s[n]) || s[n].length == 0)
        s.splice(n, 1);
      else {
  ...
  static importData(e, i, s, n) {
    ...
    for (let o in i)
      if (mt(o * 1) && M(i[o]))
        for (let l of i[o])
          l?.id && (l.id = `${l.id}`), A.isValidEntry(l, vn[e]) && (v(r?.[n]) || (r[n] = {}), M(r[n]?.[o]) || (r[n][o] = []), r[n][o].push(l));
      else
        r[o] = i[o];
    return !0;
  }
  ...
  constructor(e = A.default, i = !1, s = !1) {
    ...
    this.legacy(e), this.#c = e.core, this.#n = A.validate(this, e, i, s), this.#h = Fe.create(this.#n.dataSource, this), this.#n.timeData = new yl(this.#h.range), this.#n.chart.ohlcv = A.ohlcv(this.#n.chart.data), this.#r = new Yf(this), this.#s = fo(e);
  }
  get id() {
    return this.#i;
  }
  ...
  use(e) {
    ...
    if (D(this.#c.MainPane?.init) && (this.#c.stream instanceof St && this.#h?.historyPause(), this.#c.progress.start(), A.archiveInventory(this), this.#c.MainPane.destroy(!1)), A.isValidConfig(e)) {
  ...
  mergeData(e, i = !1, s = !1) {
    ...
    let r = M(e?.ohlcv) ? e.ohlcv.length - 1 : 0, o = mi(e?.ohlcv);
    if (r > 1 && n !== o)
      return go(this.#c, this.#s, `${this.symbol} merge data time frame ${o} does not match existing time frame ${n}!`), !1;
    (this.isEmpty || !P(n)) && (!v(i) || !I(i.start) || !I(i.end)) && r > 1 && (i = { start: r - this.range.initialCnt, end: r }), v(i) ? (I(i?.startTS) ? i.start = i.startTS : i.start = I(i.start) ? this.range.value(i.start)[0] : this.range.timeMin, I(i?.endTS) ? i.end = i.endTS : i.end = I(i.end) ? this.range.value(i.end)[0] : this.range.timeMax) : (i = {}, i.start = this.range.timeMin, i.end = this.range.timeMax);
    let l, c, p = e?.ohlcv || !1;
    const f = this.allData.data, C = this.allData?.primaryPane, E = e?.primary || !1, L = this.allData?.secondaryPane, N = e?.secondary || !1, k = this.allData?.dataset?.data, Y = e?.dataset?.data || !1;
    this.allData?.trades;
    const le = e?.trades || !1;
    this.allData?.events, e?.events;
    const $ = M(p) && this.range.inRange(p[0][0]) ? 1 : 0, re = {};
    if (M(p) && p.length > 0) {
      if (l = p.length - 1, f.length - 1, re.mData = this.range.inRange(p[0][0]) && this.range.inRange(p[0][l]), !j(p[l][7]) && p[l].length !== 8 && p[l][6] !== null && p[l][7] !== !0 ? p = Xf(p) : i.end >= this.range.timeFinish && i.start <= this.range.timeFinish && (i.start += this.range.interval, i.end += this.range.interval), f.length == 0) {
        let _ = A.ohlcv(p);
        this.allData.data.push(...p), this.allData.ohlcv = { ..._ };
      } else {
        let _ = p[0][0], U = p[p.length - 1][0], ze = (p.length - 1) * n;
        U > _ + ze && (p = this.#r.findFillGaps(p)), this.data.chart.data = this.merge(f, p);
      }
      if (!s) {
        if (M(E) && E.length > 0) {
          for (let _ of E)
            if (M(_?.data) && _?.data.length > 0)
              for (let U of C)
      ...
      let Q = p[0][0], G = p[p.length - 1][0], he = this.#r.removeFilledGaps(Q, G);
      if (this.#c.calcAllIndicators(he), M(Y) && Y.length > 0) {
        for (let _ of Y)
          if (M(_?.data) && _?.data.length > 0)
            for (let U of k)
              U.name === _.name && U.type === _.type && ri(U.settings, _.settings) && (U.data = this.merge(U.data, _.data));
      }
      v(le) && A.importTrades(le, this.allData, this.time.timeFrame), i && (v(i) ? (c = I(i.start) ? this.range.getTimeIndex(i.start) : this.range.indexStart, r = I(i.end) ? this.range.getTimeIndex(i.end) : this.range.indexEnd) : (p[0][0] && (c = this.range.indexStart + $), r = this.range.indexEnd + $), this.#c.setRange(c, r));
      let pe, ye = !1;
      for (pe in re)
        ye = ye || pe;
  ...
  addEvent(e) {
    if (!A.isValidEntry(e, bh)) return !1;
...
class Be {
  ...
  static create(e, i) {
    if (!v(e)) return !1;
    e.id = T(e.name) ? ne(e.name) : ne(`${i.ID}_theme`);
    const s = new Be(e, i);
...
class Fg {
  ...
  onmessage(e) {
    return this.#a = !0, D(this.#t) ? this.#t(e) : e;
  }
  onerror(e) {
    return this.#a = !0, D(this.#i) ? this.#i(e) : e;
  }
  postMessage(e) {
    return new Promise((i, s) => {
      try {
        ...
        this.#n[n] = { resolve: i, reject: s }, this.#a = !1, this.#r.postMessage({ r: n, data: e }), this.#r.onmessage = (r) => {
          ...
          if (o in this.#n) {
            const { resolve: p, reject: f } = this.#n[o];
            delete this.#n[o], l ? p(this.onmessage(c)) : f(this.onerror({ r: o, result: c }));
          } else if (l == "resolved")
            this.onmessage(c);
          else
...
class wh extends Lt {
  ...
  #c = [];
  constructor(e, i) {
    super(e, i), this.#i = e.elTools, this.#r = Wg || e.config.tools, this.#s = e.WidgetsG, this.init();
  }
  get name() {
    return this.#e;
  }
  ...
  start() {
    this.initAllTools(), this.addAllTools(), this.eventsListen(), bn.id = this.id, bn.context = this, this.stateMachine = bn, this.stateMachine.start(), this.log(`Tool Bar ${this.#e} instantiated and running`);
  }
  destroy() {
...
const bo = 20, Gg = 20, qg = new pt(z.COLOUR_BORDER), qn = document.createElement("template");
qn.innerHTML = `
<style>
  .scrollBarWidget {
    display: flex;
  ...
  .handle {
    background-color: var(--txc-time-handle-color, ${qg.hex}44); 
    width: 2px;
    height: 18px;
    margin: 1px;
...
<div class="scrollBarWidget">
  <span id="rwdStart" class="icon rwdStart">${Gd}</span>
  ...
  <span id="fwdEnd" class="icon fwdEnd">${Wd}</span>
</div>
`;
class jg extends ee {
  #e;
...
customElements.get("tradex-overview") || window.customElements.define("tradex-overview", jg);
...
customElements.get("tradex-time") || window.customElements.define("tradex-time", Xg);
...
customElements.get("tradex-viewport") || window.customElements.define("tradex-viewport", Yg);
...
customElements.get("tradex-grid") || window.customElements.define("tradex-grid", Kg);
...
<div class="legends">
  ...
  <div class="controls collapse restored">
    <span id="hideLegends" class="control" data-icon="hide" style="display:none">${Rd}</span>
    <span id="showLegends" class="control" data-icon="show" style="display:none">${kd}</span>
  </div>
</div>
`;
class Zg extends ee {
  ...
  buildControls(e) {
    let i = "", s = e.id;
    return i += `<span id="${s}_up" class="control up" data-icon="up">${$d}</span>`, i += `<span id="${s}_down" class="control down" data-icon="down">${Hd}</span>`, e?.type === "indicator" && (i += `<span id="${s}_visible" class="control visible" data-icon="visible">${Vd}</span>`, i += `<span id="${s}_notVisible" class="control notvisible" data-icon="notVisible">${zd}</span>`), e?.type !== "indicator" && (i += `<span id="${s}_collapse" class="control collapse" data-icon="collapse">${Bd}</span>`, i += `<span id="${s}_expand" class="control expand" data-icon="expand">${Ud}</span>`, i += `<span id="${s}_maximize" class="control maximize" data-icon="maximize">${Fd}</span>`, i += `<span id="${s}_restore" class="control restore" data-icon="restore">${_d}</span>`), i += e?.type !== "chart" ? `<span id="${s}_remove" class="control remove" data-icon="remove">${Nd}</span>` : "", i += e?.type !== "secondary" ? `<span id="${s}_config" class="control config" data-icon="config">${bl}</span>` : "", i;
  }
}
customElements.get("tradex-legends") || window.customElements.define("tradex-legends", Zg);
...
customElements.get("tradex-chartpane") || window.customElements.define("tradex-chartpane", Qg);
...
customElements.get("tradex-rows") || window.customElements.define("tradex-rows", Jg);
...
class e1 extends ee {
  ...
  setMain() {
    let e = P(this.#s?.time?.height) ? this.#s.time.height : rm;
    this.style.gridTemplateRows = `1fr ${e}px`;
  }
}
customElements.get("tradex-main") || window.customElements.define("tradex-main", e1);
...
customElements.get("tradex-scale") || window.customElements.define("tradex-scale", i1);
const Oh = document.createElement("template"), s1 = `
<style>
  :host {
    display: grid;
    grid-column-gap: 0;
    grid-template-columns: 0 0 1fr ${_n}px 0;
...
class n1 extends ee {
  ...
  get scaleW() {
    return this.#s.width || this.#e?.scale?.width || _n;
  }
  get scale2W() {
    return this.#s.width || this.#e?.scale?.width || _n;
  }
...
customElements.get("tradex-body") || window.customElements.define("tradex-body", n1);
...
customElements.get("tradex-utils") || window.customElements.define("tradex-utils", r1);
...
customElements.get("tradex-widgets") || window.customElements.define("tradex-widgets", a1);
const o1 = `
  <style title="core">
    :host {
      position: relative;
      ...
      display: grid;
      grid-row-gap: 0;
      grid-template-rows: ${Tl}px 1fr 0;
    }
    tradex-utils {
      grid-row: 1/2;
      width: 100%; 
...
class l1 extends ee {
  ...
  connectedCallback() {
    if (this.doInit) {
      this.doInit = !1, this.shadowRoot.appendChild(jn.content.cloneNode(!0)), this.init(), this.#r = this.parentElement.clientHeight || lt, this.#n = this.parentElement.clientWidth || li;
      let e = this.getAttribute("height") || "100%", i = this.getAttribute("width") || "100%";
      this.setDimensions(i, e), this.resizeObserver = new ResizeObserver(Oe(this.onResized, 100, this)), this.resizeObserver.observe(this), this.start(Ml);
    }
  }
  disconnectedCallback() {
    this.resizeObserver.disconnect();
  ...
  init() {
    this.style.display = "grid", this.style.minHeight = wl, this.#i = this.shadowRoot.querySelector("tradex-widgets"), this.#t = this.shadowRoot.querySelector("tradex-utils"), this.#e = this.shadowRoot.querySelector("tradex-body");
  }
  get disabled() {
  ...
  onResized(e) {
    ...
    this.#n = i, this.#r = s, this.#u = e[0], this.ToolsBar instanceof wh && this.ToolsBar.onResized(), this.log(`onResize w: ${i}, h: ${s}`), this.emit("global_resize", { w: i, h: s });
  }
  setWidth(e) {
  ...
  setUtilsLocation(e = this.#c?.utils?.location) {
    ...
    const i = P(this.#c.uitils?.height) && this.#c.utils.height > 0 ? this.#c.uitils.height : Tl;
    switch (e) {
      case "top":
      case !0:
...
class c1 extends Lt {
  ...
  #o = {};
  constructor(e, i) {
    super(e, i), this.#i = e.elUtils, this.#s = e.config?.utilsBar || h1, this.#r = e.WidgetsG, this.#a = e.indicatorsPublic || Mr, this.#n = e.config.theme?.utils?.location || "none", (this.#n || this.#n == "none" || !Td.includes(this.#n)) && (this.core.style.gridTemplateRows = "0 1fr"), this.#i.innerHTML = this.#i.defaultNode(this.#s);
  }
  get name() {
    return this.#e;
  }
  ...
  destroy() {
    const e = this.core, i = Oo(`#${e.id} .${yc} .icon-wrapper`);
    for (let s of i) {
  ...
  onIconClick(e) {
    const i = er(e.target, "icon-wrapper");
    if (!v(i)) return !1;
    const s = Date.now();
...
class Pe {
  ...
  static create(e, i) {
    const s = `menu_${++Pe.menuCnt}`;
    return i.id = s, Pe.menuList[s] = new Pe(e, i), Pe.menuList[s];
  }
  static destroy(e) {
    Pe.menuList[e].end(), delete Pe.menuList[e];
  }
  constructor(e, i) {
    this.#t = e, this.#i = i.core, this.#s = i, this.#e = i.id, this.#r = e.elements[Pe.type], this.#n = this.#i.elWidgetsG, this.mount(this.#r);
  }
  get el() {
    return this.#a;
  }
  ...
  onOutsideClickListener(e) {
    if (!this.#a.contains(e.target) && !this.#s.primary.contains(e.target) && Pt(this.#a)) {
      let i = {
        target: e.currentTarget.id,
        menu: this.#e
      };
  ...
  menuNode() {
    const e = this.#s, i = `position: absolute; z-index: 1000; display: none; border: 1px solid ${Vs.COLOUR_BORDER}; background: ${Vs.COLOUR_BG}; color: ${Vs.COLOUR_TXT}; box-shadow: rgba(0, 0, 0, 0.3) 0px 19px 38px, rgba(0, 0, 0, 0.22) 0px 15px 12px;`;
    let s = this.content(e);
    return `
      <div id="${e.id}" class="${vc}" style="${i}">
        ${s}
      </div>
    `;
  }
  content(e) {
    const i = `list-style: none; text-align: left; margin:1em 1em 1em -2.5em; min-width: ${u1}px`, s = "padding: .25em 1em .25em 1em; white-space: nowrap;", n = "display: inline-block; width: 4em;", r = "cursor: pointer;", o = `onmouseover="this.style.background ='#222'"`, l = `onmouseout="this.style.background ='none'"`;
    let c = `<ul style="${i}">`;
    if (e?.content)
  ...
  open() {
    if (Pe.currentActive === this) return !0;
    Pe.currentActive = this, this.#a.style.display = "block", this.position(), setTimeout(() => {
      this.#o[this.id].outside = this.onOutsideClickListener.bind(this), document.addEventListener("click", this.#o[this.id].outside);
    }, 250);
  }
  close() {
    Pe.currentActive = null, this.#a.style.display = "none", this.emit("menuClosed", this.id);
  }
}
class yi extends ve {
  ...
  `;
  static create(e, i) {
    return i.dragBar = j(i?.dragBar) ? i.dragBar : !0, i.close = j(i?.close) ? i.close : !0, i.type = i?.type || yi.type, i.class = i?.class || "dialogue", i.id = i?.id || ne("dialogue"), super.create(e, i);
  }
  static defaultNode() {
    return `
...
`, Rh = document.createElement("template");
Rh.innerHTML = `
<style>
  ${Nh}
}
...
function m1(a = {}, e) {
  ...
  if (n < 1)
    i += Qi(1, "Question", "Why did the chicken cross the road?", !0), i += Qi(2, "Answer", "To get to the other side.");
  else {
    let r = [];
    for (--n; n >= 0; n--) {
      let o = n == 0, l = D(e) ? e(a[s[n]]) : a[s[n]];
      r.push(Qi(n, s[n], l, o));
    }
    i = r.reverse().join("&nbsp;");
  }
...
customElements.get("tradex-tabs") || window.customElements.define("tradex-tabs", d1);
class ds extends yi {
  ...
  `;
  static create(e, i) {
    return i.dragBar = !0, i.close = !0, i.type = ds.type, i.class = "config", i.id = ne("config"), new ds(e, i);
  }
  static defaultNode() {
    return `
  ...
  provideInputColor(e, i) {
    ...
    s.type = "text", s.pattern = Rm, n.setTarget(s), n.style.display = "inline-block";
  }
}
class Re {
  static progressList = {};
  ...
  mount(e) {
    ...
    e.lastElementChild == null ? e.innerHTML = this.progressNode(s) : e.lastElementChild.insertAdjacentHTML("afterend", this.progressNode(s)), this.#a = this.#r.querySelector(`#${this.#s.id}`), this.#l = this.#a.querySelector("svg"), this.#l.style.fill = `${om.COLOUR_ICONHOVER};`;
  }
}
const wn = {
  id: "widgets",
...
class p1 extends Lt {
  ...
  #t = "widgets";
  #i;
  #s = { Divider: Ee, Progress: Re, Menu: Pe, Window: ve, Dialogue: yi, ConfigDialogue: ds };
  #n = {};
  #r = {};
  #a;
  #l;
  ...
  start() {
    this.eventsListen(), wn.id = this.id, wn.context = this, this.stateMachine = wn, this.stateMachine.start();
  }
  destroy() {
...
function wo(a, e, i, s, n, r) {
  const o = a.theme, l = document.createElement("template"), c = a.Timeline.graph.viewport.scene, p = a.MainPane, f = p.graph.viewport.scene, C = p.width, E = p.height, L = new X.Viewport({
    width: C,
    height: E,
    container: l
  }), N = L.scene.context;
  let k = 0, Y = 0, le = C - a.Chart.scale.width;
  o?.yAxis?.location == "left" && (Y = a.Chart.scale.width, le = 0);
  let $;
  N.save(), Ss(N, 0, 0, C, E, { fill: o.chart.Background }), N.drawImage(f.canvas, Y, 0, f.width, f.height);
  for (const [Q, G] of a.ChartPanes) {
    let he = G.graph.viewport.scene, { width: pe, height: ye } = he, _ = G.scale.graph.viewport.scene, { width: U, height: ze } = _;
    k > 0 && ($ = { stroke: o.divider.line }, Et(N, k, 0, p.width, $)), N.drawImage(he.canvas, Y, k, pe, ye), N.drawImage(_.canvas, le, k - 1, U, ze), k += ye;
  }
  N.drawImage(c.canvas, 0, k, c.width, c.height), $ = {
    text: a.config.title,
  ...
  const re = (Q) => {
    if (Q) {
      const he = r?.x || 0, pe = r?.y || 0, ye = r?.width || C * 0.25, _ = r?.height || E * 0.25;
      N.drawImage(Q, he, pe, ye, _);
    }
    N.restore();
    const G = () => {
      L.destroy(), l.remove();
...
class H extends l1 {
  ...
  static create(e = H.default) {
    ...
    }), !H.#r && H.#l === null && D(i?.talib?.init) && (H.#n = i.talib.init(i.wasm), H.#n.then(
      () => {
        H.#r = !0;
        for (let s of H.#a)
          D(s) && s();
  ...
  constructor() {
    super(), this.#g = this, this.#f = H.cnt(), this.logs = !1, this.infos = !1, this.warnings = !1, this.errors = !1, this.timers = !1, this.setID(null), this.#v = A, this.warn(`!WARNING!: ${Qt} changes to config format, for details please refer to https://github.com/tradex-app/TradeX-chart/blob/master/docs/notices.md`), this.log(`${ut} instance count: ${this.inCnt}`), this.oncontextmenu = window.oncontextmenu, this.#F = Gn;
    const e = this.#C;
    e.primaryPane = { ...e.primaryPane, ...fh.primaryPane }, this.#P = { ...Wn };
  }
  log(...e) {
  ...
  get rangeLimit() {
    return P(this.range.initialCnt) ? this.range.initialCnt : wc;
  }
  get range() {
  ...
  start(e = H.default) {
    ...
    if (s.state instanceof A || (o = this.configureState(s)), this.#w) {
      ...
      this.#v.use(this, l.key), delete s.state, this.log(`${this.name} id: ${this.ID} : created with a ${this.state.status} state`), this.#$ = new p1(this, { widgets: s?.widgets }), this.#R = new c1(this, s), this.#k = new wh(this, s), this.#M = new mo(this, s), this.eventsListen(), this.elStart(this.theme), this.elBody.start(this.theme), this.UtilsBar.start(), this.ToolsBar.start(), this.MainPane.start(), this.WidgetsG.start(), this.#_ = this.WidgetsG.insert("Progress", {});
    }
  ...
  configureState(e) {
    ...
    if (r = r - r % n, !v(e?.range))
      ...
      let o = e?.range;
      I(o.startTS) || (o.startTS = r), I(o.timeFrameMS) || (o.timeFrameMS = n), it(o.timeFrame) != o.timeFrameMS && (o.timeFrame = Te(n));
    }
  ...
  setID(e) {
    T(e) ? this.ID = e : this.ID = `${ne(ut)}_${this.#f}`;
  }
  setTitle(e) {
  ...
  updateRange(e) {
    if (!M(e) || !P(e[4]) || e[4] == 0 || e[4] < 0 && this.range.isPastLimit() || e[4] > 0 && this.range.isFutureLimit()) return;
    let i, s;
  ...
  setRange(e = 0, i = this.rangeLimit) {
    ...
    if (l.length) if (o.startTS = l[0], o.endTS = l[l.length - 1], o.start = this.range.getTimeIndex(l[0]), o.end = this.range.getTimeIndex(l[l.length - 1]), D(this.state.dataSource.source.rangeLimitPast))
      this.emit("range_limitPast", o);
    else if (D(this.state.dataSource.source.rangeLimitFuture))
  ...
  isOverlay(e) {
    return ui(e) && D(e.prototype?.draw) && !this.isIndicator(e) && Object.getPrototypeOf(e.prototype).constructor.isOverlay;
  }
  hasOverlay(e) {
  ...
  isIndicator(e) {
    return ui(e) && D(e.prototype?.draw) && "primaryPane" in e.prototype && !!e?.isIndicator;
  }
  setIndicators(e, i = !1) {
    if (!v(e)) return !1;
    ...
    for (const [n, r] of Object.entries(e))
      T(r?.id) && T(r?.name) && T(r?.event) && this.isIndicator(r?.ind) ? (r?.public && (this.#T[n] = r), this.#E[n] = r.ind, s[n] = !0, this.log(`Custom Indicator: ${n} - Registered`)) : (s[n] = !1, this.warn(`Custom Indicator: ${n} - Rejected: Not a valid indicator`));
    return s;
  }
  addIndicator(e, i = e, s = {}) {
...
window.customElements.get("tradex-chart") || (document.head.insertAdjacentHTML("beforeend", dm), document.head.insertAdjacentHTML("beforeend", mm), customElements.get("tradex-chart") || customElements.define("tradex-chart", H));
function xn(a) {
...
class Xn {
  static add(e, i) {
    return e instanceof Xn ? (ui(i), new Proxy(i, {
      get: (n, r) => typeof n[r] == "function" ? Xn.intercept(e, n, r) : n[r]
    })) : !1;
  }
  ...
  #e(e, i, s, n = !0, r = []) {
    return typeof e != "string" || typeof i != "function" || !Array.isArray(r) || f1.includes(e) ? !1 : (this.advice[e] = this.advice[e] || [], this.advice[e].push({ type: s, func: i, args: r, transfer: n }), !0);
  }
}
export {
  Xn as Aspect,
